...
def build_jsr308_langtools_release(version, checker_framework_interm_dir, jsr308_interm_dir):
    ...
    #zip up jsr308-langtools project and place it in checker_framework_interm_dir
    ant_props = "-Dlangtools=%s -Ddest.dir=%s -Dfile.name%s" % (JSR308_LANGTOOLS, checker_framework_interm_dir, "jsr308-langtools.zip")
