...
signatures, not class signatures, fields, or method bodies, as a \code{.jaif}
file does. Further, stub files are only used by the Checker Framework at run
time; they cannot be used to insert annotations into a source or classfile.
