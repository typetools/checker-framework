...
A version of each of these methods is also provided that takes
...
methods return a \<String> error message and a \<Pattern\-Syntax\-Exception>,
...
\sunjavadoc{java.base/java/util/regex/PatternSyntaxException.html}{Pattern\-Syntax\-Exception}
except that it is checked to guarantee that the error will be handled up the
