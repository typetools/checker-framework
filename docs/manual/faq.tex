...
increase in heap size). However, note that if desired a project can use the 
checker-qual-android dependency instead of checker-qual and this uses <CLASS>
retention. That is, the checker-qual-android artifact is identical to the 
checker-qual artifact, except that in checker-qual-android annotations have 
classfile retention.
