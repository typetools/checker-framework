...
A method in an anonymous class has a receiver, but Java does not permit
writing the receiver in the formal parameter list because there is no name
for the type of \<this>.
Therefore, there is another syntax for writing annotations on the receiver
formal parameter.  The following two forms behave identically:
...
\noindent
\refqualclass{framework/qual}{ReceiverQualifier} can always be written,
even on a method in an anonymous class.
