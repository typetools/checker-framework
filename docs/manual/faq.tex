...
\item
  ...
  memory, pass an argument like \<-Xmx6g> or set an environment variable
  like \<export \_JAVA\_OPTIONS=-Xmx6g>.  Also consider upgrading to a more
...
% LocalWords:  checkers'' covariance'' contravariance'' Xmx6g lookups
