...
To improve performance, the most important thing you can do is
\emph{incremental compilation}.  When compiling just a few source files
(the size of a typical edit or commit), you won't notice the slowdown.  If
you compile all files in a large project, you will definitely notice a
