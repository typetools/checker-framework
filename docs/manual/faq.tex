...
\item
  ...
  memory, pass an argument like \<-Xmx7g> or set an environment variable
  like \<export \_JAVA\_OPTIONS=-Xmx7g>.  Also consider upgrading to a more
...
% LocalWords:  checkers'' covariance'' contravariance'' Xmx7g lookups
