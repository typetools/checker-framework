...
\\ \ref{faq-type-annotation-formatting}: How should type annotations be formatted in source code?
...
\subsectionAndLabel{How should type annotations be formatted in source code?}{faq-type-annotation-formatting}
