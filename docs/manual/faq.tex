...
\subsectionAndLabel{Should I use pluggable types (type qualifiers) or Java subtypes?}{faq-typequals-vs-subtypes}
...
\subsectionAndLabel{Why not just use a bug detector (like FindBugs)?}{faq-type-checking-vs-bug-detectors}
