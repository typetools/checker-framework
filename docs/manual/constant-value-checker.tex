...
non-null by default. The \code{-AnullStringsConcatenation} command-line option
makes the checker more sound by assuming that all objects can be null. Only
String literals, primitive types, and compile-time constants are considered
non-null. Figure~\ref{fig-null-strings-concat} gives an example of behavior
