...
compile-time constant strings) may be null.  (This is
conservative, but it is sound.)
Without the command-line argument, the estimate for \<x + "c"> is
\<@StringVal}("ac", "bc") String>.
With the command-line argument, the estimate for \<x + "c"> is
