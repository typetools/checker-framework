...
An \<@MatchesRegex> annotation is only a subtype of another \<@MatchesRegex> annotation
if the arguments of both annotations are identical. An \<@StringVal> annotation is
a subtype of an \<@MatchesRegex> annotation if all the strings match the regular
expression.
