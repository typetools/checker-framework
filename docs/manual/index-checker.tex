...
program variables, and this manual discusses each one in a different
section:
\begin{itemize}
\item
...
\item[\refqualclasswithparams{checker/index/qual}{IndexFor}{String[] names}]
  ...
  express this as
  \<\refqualclass{checker/lowerbound/qual}{NonNegative}
  \refqualclasswithparams{checker/upperbound/qual}{LTLengthOf}{"someArray"}
  int i>,
 ...
 \item[\refqualclasswithparams{checker/index/qual}{IndexOrHigh}{String[] names}]
  ...
  \refqualclass{checker/lowerbound/qual}{NonNegative} and
  \refqualclass{checker/upperbound/qual}{LTEqLengthOf}.
\end{description}
...
\item[\refqualclasswithparams{checker/upperbound/qual}{LTLengthOf}{String[] names}]
  ...
  For example, an expression of type \code{@LTLengthOf("a") int} can be
...
should be written instead.
  ...
  (``\<LTOM>'' stands for ``Less Than One Minus''.)
...
annotated as
\refqualclasswithparams{checker/upperbound/qual}{LTLengthOf}{"arr"}.
...
\begin{Verbatim}
  boolean lessThan(double[] arr1, double @SameLen("arr1") [] arr2) {
