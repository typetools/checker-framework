...
The MinLen type system is implemented in practice by the Constant Value Checker
(see \chapterpageref{constant-value-checker}), running in "ignore range overflow" mode.
...
\item[\refqualclass{common/value/qual}{BottomVal}]
  ...
  \code{null} has this type. This type is borrowed from
  the Constant Value Checker, which implements the MinLen
