...
\section{Special handling for binary search\label{index-searchindex}}

The JDK's implementation of
\sunjavadoc{java/util/Arrays.html\#binarySearch-java.lang.Object:A-int-int-java.lang.Object-}{binary search}
uses a contract that is otherwise not
...
from a call to binary search. This type system should never be user-visible (i.e.
none of its annotations should ever need to be written by users of the Index Checker), but for
completeness, we explain its qualifiers here.

The binary search tracking type system has four qualifiers:
\begin{description}
\item[\refqualclasswithparams{checker/index/qual}{SearchIndex}{String[] names}]
  An expression with this type represents an integer produced by
  calling \sunjavadoc{java/util/Arrays.html\#binarySearch-java.lang.Object:A-int-int-java.lang.Object-}{Arrays.binarySearch}.
  The argument represents the array(s) on which binary search was called.
  This type is a subtype of [\refqualclass{checker/index/qual}{SearchIndexUnknown}].
\item[\refqualclasswithparams{checker/index/qual}{NegativeIndexFor}{String[] names}]
  ...
  complement operator (~) to this type produces an [\refqualclass{checker/index/qual}{IndexOrHigh}].
  This type can only be produced by comparing a [\refqualclass{checker/index/qual}{SearchIndex}]
  to zero. This type is a subtype of [\refqualclass{checker/index/qual}{SearchIndex}] if every array
  present in the argument of the [\refqualclass{checker/index/qual}{SearchIndex}] is present in this
  type's argument.
