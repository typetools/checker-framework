...
\item[\refqualclasswithparams{checker/index/qual}{NegativeIndexFor}{String[] names}]
  ...
  This type can only be produced by comparing a [\refqualclass{checker/index/qual}{SearchIndexFor}]
  to zero. This type is a subtype of [\refqualclass{checker/index/qual}{SearchIndexFor}] if every array
  present in the argument of the [\refqualclass{checker/index/qual}{SearchIndexFor}] is present in this
  type's argument.
