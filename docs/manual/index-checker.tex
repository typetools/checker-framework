...
to the index to get the rest of the string after the occurence we found.
...
The Upper Bound Checker can then infer
the corresponding \<@LTLengthOf> annotation for expressions that
...
\item[\refqualclasswithparams{checker/index/qual}{IndexOfIndexFor}{String[] value, String[] offset}]
  ...
  specified in the annotation, it is less than \<receiver.length-offset>.
