...
annotations can also be used to establish the minimum length of an array, if the
precise length (as opposed to just a lower bound on the length) is known. For example,
...
can establish the minimum length of an array:
...
\item[\refqualclass{common/value/qual}{BottomVal}]
  This is the bottom type for the MinLen, ArrayLenRange, and ArrayLen.
