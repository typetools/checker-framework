...
It's because the upper-bound annotations apply independently of the lower-bound annotations,
...
% The \<@IndexOfIndexFor(value="this", offset="\#1.length()-1")> annotation on the return value of
% \<String.indexOf> allows writing code such this without warnings from the Upper Bound Checker.
% \begin{Verbatim}
%   public static String remove(String l, String s) {
%     int i = l.indexOf(s);
%     if (i != -1) {
%       return l.substring(i + s.length());
%     }
%     return l;
%   }
% \end{Verbatim}
...
\<@IndexOfIndexFor>
%\<@IndexOfSubstring>
annotation is implemented in a separate IndexOf Checker which runs together with the Index Checker and has its own type hierarchy (Figure~\ref{fig-index-indexof}) with three type qualifiers:
\begin{description}
