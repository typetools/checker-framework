...
and the places where untrusted data is read, the Tainting Checker will
...
\begin{Verbatim}
  usb.append(ts); // undesirable invocation
\end{Verbatim}
...
side effects, and only returns a reference to the buffer as a convenience
