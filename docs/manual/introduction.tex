...
\item \<-AinferOutputDirectory>
  ...
  files).  It defaults to \<build/whole-program-inference>, but when using
  a build system (e.g., Gradle), the default may be relative to a build
  system directory rather than the project root directory.
