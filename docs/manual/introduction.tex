...
to ensure the method side-effects a subset of the
expressions specified as annotation arguments/elements to
\refqualclass{dataflow/qual}{SideEffectsOnly}. See
Section~\ref{type-refinement-purity}.
