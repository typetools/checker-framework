...
You must have \textbf{JDK 8, 11, or 16} installed.
(The Checker Framework should work with any JDK 8--16, but we only test with JDKs 8, 11, and 16.)
...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-3.17.0.zip}
