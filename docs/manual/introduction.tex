...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-2.3.2.zip}
...
\subsection{Annotated libraries\label{annotated-libraries-using}}
...
\<org.checkerframework.annotatedlib> be updated.
...
% annotated JDK
use the stub file \<javadoc.astub>, which contains annotations for the
Index and Nullness checkers.
