...
You must have \textbf{JDK 8}, \textbf{JDK 11}, or \textbf{JDK 17} installed.
% Possible replacement for the above.
% You must have a supported LTS JDK installed: \textbf{JDK 8}, \textbf{JDK
% 11}, or \textbf{JDK 17}.
The Checker Framework processes code written for any of those versions.
(For running the Checker Framework under other JDK versions, see
...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-3.21.2-eisop1.zip}
