...
\item The programmer writes annotations, such as \refqualclass{checker/nullness/qual}{NonNull} and
  ...
  annotations in his code:  see Section~\ref{type-inference-to-annotate}.)
...
The same argument applies to methods that guaranteed to throw an exception
if they are passed \code{null}
...
possible run-time exceptions, which is its purpose.
