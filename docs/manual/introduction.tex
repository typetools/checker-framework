...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-2.11.0.zip}
...
This feature does not apply to Javac \href{https://docs.oracle.com/javase/11/docs/technotes/tools/windows/javac.html#BHCJEIBB}{@argfiles}.
...
of \ahref{https://docs.oracle.com/en/java/javase/11/docs/api/java.base/java/util/Optional.html#orElseThrow()}{\<orElseThrow>} is annotated as
