...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-3.4.1.zip}
...
\item \<-AshowSuppressWarningStrings>
...
% LocalWords:  AshowSuppressWarningStrings AoutputArgsToFile RegexChecker
