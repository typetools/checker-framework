...
\textbf{Requirement:}
You must have \textbf{JDK 8 or later} installed.  You can get the JDK from
...
\item
  ...
  The \<.jar> files are only compatible with a Java 8 or later JVM, unless you
...
\item
  ...
  never suffers the error at run time.  In other words, this is a proof
