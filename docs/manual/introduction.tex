...
\item
  \ahrefloc{reflection-checker}{Reflection Checker} to determine
...
\item
  ...
  \\
  %END LATEX
  \url{https://checkerframework.org/checker-framework-2.8.0.zip}
...
\item \<-ArequirePrefixInWarningSuppressions>
  ...
  warning supression key.  Otherwise, the suppress warning annotation does not
...
% LocalWords:  DefaultQualifier SoyLatte GetStarted Formatter
...
%%  LocalWords:  AstubWarnIfNotFoundIgnoresClasses processOptions
%%  LocalWords:  EnsuresNonNull EnsuresNonNullIf
