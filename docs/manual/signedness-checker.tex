...
\item[\refqualclass{checker/signedness/qual}{SignednessGlb}]
    ...
    This primarily applies to values that are known at compile
    time to be in the positive signed range.
    It is also used for manifest literals, to prevent the programmer from
    having to annotate them all explicitly.
