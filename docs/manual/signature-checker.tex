...
Figure~\ref{fig-signature-hierarchy}
shows how they are related; examples appear in a table below.
...
Java defines one format for the string representation of a class
declaration, and two formats for the string representation of a method
signature.
(For details on classfile signature representations, see
\href{https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.7.9.1}.)
