...
Java defines six formats for the string representation of a type, and
many more for representing generic types. (See
\href{https://docs.oracle.com/javase/specs/jvms/se9/html/jvms-4.html#jvms-4.7.9.1}
for a detailed description of generic signatures)
