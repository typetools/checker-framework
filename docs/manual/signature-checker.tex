...
\item[\refqualclass{checker/signature/qual}{FullyQualifiedName}]
  A \emph{fully qualified name} (\href{https://docs.oracle.com/javase/specs/jls/se25/html/jls-6.html#jls-6.7}{JLS \S
    6.7}), such as
...
\item[\refqualclass{checker/signature/qual}{BinaryName}]
  A \emph{binary name} (\href{https://docs.oracle.com/javase/specs/jls/se25/html/jls-13.html#jls-13.1}{JLS \S 13.1}), such as
...
\item[\refqualclass{checker/signature/qual}{ClassGetSimpleName}]
  ...
  (\href{https://docs.oracle.com/javase/specs/jls/se25/html/jls-6.html#jls-6.2}{JLS
...
programmer should rarely or never use these qualifiers, and you can ignore
