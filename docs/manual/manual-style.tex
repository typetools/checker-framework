...
\newcommand{\sunjavadoc}[2]{\href{https://docs.oracle.com/javase/11/docs/api/#1}{\<#2>}}
% Like \sunjavadoc, but for annotations and prepends "@".
\newcommand{\sunjavadocanno}[2]{\href{https://docs.oracle.com/javase/11/docs/api/#1}{\<@#2>}}
...
\ifhevea
\newcommand{\selflink}[1]{\if@refs\ \ahrefloc{#1}{\small\@print@u{128279}}\fi}
