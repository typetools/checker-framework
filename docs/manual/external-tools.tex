...
\item
  ...
  ``Project Structure'' menu via (File > Project Structure), navigate to ``Project" sub-menu( under ``Project Settings"),
...
\item
  ...
  Go to the ``Preferences'' menu via (IntelliJ>Settings) and
...
\item
  ...
  Processors'' sub-menu. Navigate here and click on the ``+'' to create
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=$CHECKERFRAMEWORK/checker-framework-2.5.0
