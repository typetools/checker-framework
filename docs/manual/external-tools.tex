...
dependencies {
    ...
    ext.checkerFrameworkVersion = '3.48.3'
...
prebuilt_jar(
    ...
    binary_jar = 'checker-3.48.3.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-3.48.3.jar',
    visibility = [ 'PUBLIC' ]
)
...
other than \<\${HOME}/checker-framework-3.48.3/>.
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-3.48.3/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-3.48.3
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-3.48.3\
...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-qual/3.48.3/checker-qual-3.48.3.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-util/3.48.3/checker-util-3.48.3.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker/3.48.3/checker-3.48.3-all.jar}
\end{itemize}
