...
\item To use a locally-modified version of the Checker Framework, first run:
...
\noindent
Use the instructions above, but modify the version number for the Checker Framework artifacts.
Use the version number that is output when you run \<./gradlew version>.
