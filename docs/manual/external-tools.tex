...
\item
  ...
  marks to escape special characters and spaces, like in the command above.
...
\item
  ...
  choosing, such as AnnotationProcessor, which avoids using special characters and spaces.
