...
Project Lombok (\url{https://projectlombok.org/}) dramatically improved support
for type use annotations starting with version 1.18.3 (2018-09-17 23:23:31 UTC).
%
Many standard Nullable/NonNull annotations are automatically transferred for
...
This is necessary for all \<org.checkerframework> annotations.
