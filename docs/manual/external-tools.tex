...
dependencies {
    ...
    ext.checkerFrameworkVersion = '3.22.1-eisop1'
...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-qual/3.22.1-eisop1/checker-qual-3.22.1-eisop1.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-util/3.22.1-eisop1/checker-util-3.22.1-eisop1.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker/3.22.1-eisop1/checker-3.22.1-eisop1-all.jar}
\end{itemize}
