...
These instructions should work on JDK 21 or later, but we only test with supported
versions of Java: JDK 21 and JDK 25.
...
\item Change the project SDK to 21 or later, as explained at
