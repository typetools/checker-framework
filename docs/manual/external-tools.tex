...
dependencies {
    ...
    ext.checkerFrameworkVersion = '3.23.0-eisop2'
...
prebuilt_jar(
    ...
    binary_jar = 'checker-3.23.0-eisop2.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-3.23.0-eisop2.jar',
    visibility = [ 'PUBLIC' ]
)
...
other than \<\${HOME}/checker-framework-3.23.0-eisop2/>.
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-3.23.0-eisop2/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-3.23.0-eisop2
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-3.23.0-eisop2\
...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-qual/3.23.0-eisop2/checker-qual-3.23.0-eisop2.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker-util/3.23.0-eisop2/checker-util-3.23.0-eisop2.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/io/github/eisop/checker/3.23.0-eisop2/checker-3.23.0-eisop2-all.jar}
\end{itemize}
