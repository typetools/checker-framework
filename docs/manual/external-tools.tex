...
diagnostics wrapper} project makes it easy to post-process the javac
diagnostics output to produce output in different formats, in
particular in the LSP JSON style.
