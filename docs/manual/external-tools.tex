...
dependencies {
    ...
    ext.checkerFrameworkVersion = "4.2.0"
...
prebuilt_jar(
    ...
    binary_jar = 'checker-4.2.0.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-4.2.0.jar',
    visibility = [ 'PUBLIC' ]
)
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-4.2.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-4.2.0\
...
\begin{itemize}
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-qual/4.2.0/checker-qual-4.2.0.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-util/4.2.0/checker-util-4.2.0.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker/4.2.0/checker-4.2.0-all.jar}
\end{itemize}
