...
\noindent
Then, in addition to the instructions above, use the release version output by running \<./gradlew version>
as the version number for the Checker Framework artifacts.
