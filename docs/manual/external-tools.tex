...
prebuilt_jar(
    ...
    binary_jar = 'checker-2.8.0.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-2.8.0.jar',
    visibility = [ 'PUBLIC' ]
)
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-2.8.0/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-2.8.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-2.8.0\
