...
checker on every compile for Java projects and/or modules.  If your project
uses a build tool such as Gradle, follow the instructions
for that build tool.
...
On \ahref{https://www.jetbrains.com/help/idea/java-compiler.html}{the Java
  compiler settings page}, in the
...
\item
\ahref{https://www.jetbrains.com/help/idea/configuring-annotation-processing.html#associate}{Associate} any desired modules with that profile.
\item
