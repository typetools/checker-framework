...
Starting with version 1.18.3 it is easy to combine Lombok and the Checker
Framework. When Lombok generates code, selected type annotations are copied, for
example, from fields to generated setter/getter/builder methods.
