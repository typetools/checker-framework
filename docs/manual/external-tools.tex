...
\item
  ...
  Note: It is a good idea to enclose the address in quotation
  marks to escape special characters and spaces.
  E.g. \<-Xbootclasspath/p:"\$CHECKERFRAMEWORK/checker/dist/jdk8.jar">
...
\item
  ...
  choosing. Avoid using special characters or spaces. E.g. AnnotationProcessor.
  Select the modules you would like to use checkers with from under the
  ``Default'' profile and move them to your new profile via the button
  directly right of the ``-'' button.
