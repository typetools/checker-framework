...
dependencies {
    ...
    ext.checkerFrameworkVersion = '3.4.0'
...
prebuilt_jar(
    ...
    binary_jar = 'checker-3.4.0.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-3.4.0.jar',
    visibility = [ 'PUBLIC' ]
)
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-3.4.0/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-3.4.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-3.4.0\
...
\item \<checker-qual.jar>: \url{https://search.maven.org/artifact/org.checkerframework/checker-qual/3.4.0/jar}
\item \<checker.jar>: \url{https://search.maven.org/artifact/org.checkerframework/checker/3.4.0/jar}
\end{itemize}
