...
dependencies {
    ...
    ext.checkerFrameworkVersion = "3.53.0"
...
prebuilt_jar(
    ...
    binary_jar = 'checker-3.53.0.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-3.53.0.jar',
    visibility = [ 'PUBLIC' ]
)
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-3.53.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-3.53.0\
...
\begin{itemize}
\item \<javac.jar>: \url{https://central.sonatype.com/artifact/com.google.errorprone/javac/9%2B181-r4173-1/jar}
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-qual/3.53.0/checker-qual-3.53.0.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-util/3.53.0/checker-util-3.53.0.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker/3.53.0/checker-3.53.0-all.jar}
\end{itemize}
...
\begin{Verbatim}
  <target depends="-init-ap-cmdline-properties" if="ap.supported.internal"
    ...
    <macrodef name="javac" uri="https://www.netbeans.org/ns/j2se-project/3">
