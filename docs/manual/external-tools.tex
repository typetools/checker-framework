...
\item Direct all tasks of type \<JavaCompile> used by the \<checkTypes> build variant to use the ErrorProne compiler:
\begin{mysmall}
\begin{Verbatim}
...
\item If using JDK 8, use a Maven property to hold the location of the
  ErrorProne javac.jar.  They were declared as Maven dependencies above.
