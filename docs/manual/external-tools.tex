...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-2.1.7/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-2.1.7
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-2.1.7\
...
dependencies {
    ...
    ext.checkerFrameworkVersion = '2.1.7'
...
Its website (\myurl{http://checker-framework.com/eclipse/}).
