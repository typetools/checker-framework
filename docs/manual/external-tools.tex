...
dependencies {
    ...
    ext.checkerFrameworkVersion = '3.30.0'
...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-qual/3.30.0/checker-qual-3.30.0.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-util/3.30.0/checker-util-3.30.0.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker/3.30.0/checker-3.30.0-all.jar}
\end{itemize}
