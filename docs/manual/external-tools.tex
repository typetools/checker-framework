...
\item \<checker-qual.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-qual/\ReleaseVersion/checker-qual-\ReleaseVersion.jar}
\item \<checker-util.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker-util/\ReleaseVersion/checker-util-\ReleaseVersion.jar}
\item \<checker.jar>: \url{https://repo1.maven.org/maven2/org/checkerframework/checker/\ReleaseVersion/checker-\ReleaseVersion-all.jar}
\end{itemize}
