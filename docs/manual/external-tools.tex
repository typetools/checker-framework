...
prebuilt_jar(
    ...
    binary_jar = 'checker-2.7.0.jar',
    visibility = [ 'PUBLIC' ]
)

prebuilt_jar(
    name = 'checker-qual',
    binary_jar = 'checker-qual-2.7.0.jar',
    visibility = [ 'PUBLIC' ]
)
...
checker on every compile.  If you want to run the checker from a terminal
within IntelliJ IDEA, follow the command-line instructions in
...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-2.7.0/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-2.7.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-2.7.0\
