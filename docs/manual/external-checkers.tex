...
The paper ``Verifying determinism in sequential programs'' (ICSE 2021,
...
``Continuous Compliance''~\cite{KelloggSTE2020} (ASE 2020,
...
For further case studies, also see~\cite{PapiACPE2008}.
...
The paper ``Loci: Simple thread-locality for Java''~\cite{WrigstadPMZV2009} (ECOOP 2009,
\myurl{http://janvitek.org/pubs/ecoop09.pdf}) describes the checker.
