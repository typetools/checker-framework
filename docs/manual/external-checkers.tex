...
Nullness Checker.  NullAway is described in the paper ``NullAway: Practical
type-based null safety for Java''~\cite{BanerjeeCS2019}.
...
\ahreforurl{http://mcoblenz.github.io/Glacier/}{Glacier}
...
The paper
\ahref{https://homes.cs.washington.edu/~mernst/pubs/tunable-typeinf-ecoop2011-abstract.html}{``Tunable
