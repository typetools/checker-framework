...
\url{https://checkerframework.org/gsoc-ideas.html}.
\end{sloppypar}
...
Please see the
\href{https://checkerframework.org/developer-manual.html}{Checker Framework Developer Manual}.
...
\ahref{https://checkerframework.org/developer-manual.html\#ci}{CI
...
Framework, and the
\href{https://checkerframework.org/developer-manual.html}{Checker
...
There is a list
  of potential projects for new contributors at \url{https://checkerframework.org/gsoc-ideas.html}.
...
Please see the
\ahref{https://checkerframework.org/developer-manual.html#pull-requests}{pull
