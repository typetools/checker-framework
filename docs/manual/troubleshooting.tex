...
\subsectionAndLabel{Configure Eclipse to edit the Checker Framework}{building-eclipse}
...
\subsectionAndLabel{Code style}{code-style}
...
\sectionAndLabel{Comparison to other tools}{other-tools}
