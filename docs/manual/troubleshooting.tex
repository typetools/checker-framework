...
documentation), choose a bug and fix it (start with those labeled \href{``good
first
issue''}{https://github.com/typetools/checker-framework/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22}),
or select a
