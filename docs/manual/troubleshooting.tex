...
\item[Ubuntu]
  ...
  is a JDK version such as 21, 25, etc.:
...
Note: Running \<brew install --cask temurin21> is only necessary if you do not
...
In the command, \emph{XX} is a JDK version such as 21, 24, etc.
