...
\begin{Verbatim}
git clone https://github.com/{user.name}/checker-framework
\end{Verbatim}
\item
Enter to the main directory of the local project.
\begin{Verbatim}
cd {place-where-repository-cloned}/checker-framework
\end{Verbatim}
\item
Create and checkout to the branch (e.g updating).
...
\item
Create pull requests to the typetools/stubparser and typetools/checker-framework with names "Updating the stubparser".
\end{enumerate}
