...
\url{https://checkerframework.org/manual/gsoc-ideas.html}.
\end{sloppypar}
...
\item
To publish the Checker Framework artifacts to a local Maven respository, run
\code{./gradlew publishToMavenLocal}
\begin{Verbatim}
  cd $CHECKERFRAMEWORK
  ./gradlew publishToMavenLocal
\end{Verbatim}
Then use the Maven instructions, but modify the version number for the Checker Framework artifacts.
...
There is a list
  of potential projects for new contributors at \url{https://checkerframework.org/manual/gsoc-ideas.html}.
