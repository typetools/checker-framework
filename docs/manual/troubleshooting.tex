...
The installation of prerequisites is a bit different on Mac OS, but still easy most of the time with \ahref{https://brew.sh}{Homebrew} through the following commands:
