...
\item
Versions of \ahref{https://github.com/uber/NullAway}{NullAway} 0.9.1 and
earlier incompatible with the Checker Framework.  (More precisely, each
version of NullAway version 0.9.1 and earlier is compatible with only one
specific version of the Checker Framework.)  Those versions of NullAway use
an outdated version of the Checker Framework's dataflow analysis library,
which conflicts with the Checker Framework itself.
