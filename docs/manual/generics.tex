...
A method whose signature has a polymorphic qualifier conceptually has multiple
...
They may not be used on a class declaration.
They may be used on a field declaration, but it has a different meaning;
see Section~\ref{class-qualifier-polymorphism}.
Also, if it is written on a method in a class with
