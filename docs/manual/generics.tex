...
class, as in \code{List<@Nullable String>}.
...
of tainting, see \chapterpageref{tainting-checker}.)
...
This means that the call \<myUntaintedBuffer.append(myTaintedString)> is
illegal, though \<myTaintedBuffer.append(myUntaintedString)> is permitted.
