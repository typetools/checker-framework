...
infer the Java type parameters and the type qualifiers.  By default these inferred
types are ignored is subtyping checks. If you supply the command-line option \<-AignoreRawTypeArguments=false>
you will see errors from raw types.
