...
see Section~\ref{class-qualifier-polymorphism}.)
...
In classes that have a qualifier parameter, using a polymorphic annotation in a method signature has
two different meanings. 1.) If the receiver type is annotated with a polymorphic qualifier, then the
polymorphic qualifiers mean class implicit qualifier polymorphism. That is the polymorphic
