...
You can write your checker in a fork of the Checker Framework
repository \url{https://github.com/typetools/checker-framework},
or you can write it in a stand-alone repository.  Here is a template for a
stand-alone repository: \url{https://github.com/typetools/templatefora-checker}.
...
\subsectionAndLabel{Tips for creating a checker}{creating-tips}
...
\subsectionAndLabel{Defining a default annotation}{creating-typesystem-defaults}
...
Implicit annotations are distinct from default annotations.
...
\sectionAndLabel{Type factory: Implicit annotations (type introduction rules)}{creating-type-introduction}
...
Default annotations are distinct from implicit annotations.
Section~\ref{creating-typesystem-defaults} describes how to specify
default annotations.


\subsectionAndLabel{Declaratively specifying implicit annotations}{creating-declarative-type-introduction}
...
\subsectionAndLabel{Procedurally specifying implicit annotations}{creating-procedurally-specifying-implicit-annotations}
...
also default and implicit annotations, and type
