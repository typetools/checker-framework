...
multiple processors to the \<-processor> command-line option, except the error message are interleaved
...
\begin{Verbatim}
  public class MyUnitCheckers extends AggregateChecker {
    protected Set<Class<? extends SourceChecker>> getImmediateSubcheckerClasses() {
      Set<Class<? extends SourceChecker>> checkers = new LinkedHashSet<>(CollectionsPlume.mapCapacity(3));
      checkers.add(DistanceUnitChecker.class);
      checkers.add(VelocityUnitChecker.class);
      checkers.add(MassUnitChecker.class);
      return checkers;
    }
  }
\end{Verbatim}
