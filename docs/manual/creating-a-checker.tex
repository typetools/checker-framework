...
the checker's main source directory.  You can also create \<jdkN.astub> files that contain methods
...
\item \code{-Aignorejdkastub}:
  ignore the \<jdk.astub> and \<jdkN.astub> files in the checker directory. Files passed
