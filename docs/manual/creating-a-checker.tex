...
\refclass{dataflow/expression}{Receiver} object by calling
...
Node)}.
Then, call \<toString()> on the \<Receiver> object.
...
\item \<-AatfCacheSize>:
  The size of the Checker Framework's internal caches.  Most users have no
  need to set this.
