...
other defaulting rules are autmatically added to every checker. Also, Section~\ref{defaults}
...
view-point-adapted for the call site.  The framework implements these rules so that all type systems
automatcally use them.  For other expressions, such as string literals, their (annotated) types depend
