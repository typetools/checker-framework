...
\emph{Type-checking}:
Do not use \code{instanceof} to determine the kind of a \<TypeMirror> or \<Element>,
because you cannot necessarily predict the run-time type of the object that
implements an interface. For example, \<type instanceof DeclaredType> and \<type instanceof UnionType>
