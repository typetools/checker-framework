...
\item
  ...
  typically as a private inner class of your \<AnnotatedTypeFactory>.  In
  your subclass of \<AnnotatedTypeFactory>, override \<createTreeAnnotator>
  to return a \<ListTreeAnnotator> containing that annotator, as in
...
\end{Verbatim}
  ...
  \noindent
  (or put your TreeAnnotator first).

\item
  Define a subclass of a
  \refclass{org/checkerframework/framework/type/treeannotator}{TypeAnnotator},
  typically as a private inner class of your \<AnnotatedTypeFactory>.  In
  your subclass of \<AnnotatedTypeFactory>, override \<createTypeAnnotator>
  to return a \<ListTypeAnnotator> containing that annotator, as in
