...
\newcommand{\TreeAPIBase}{https://docs.oracle.com/javase/11/docs/jdk/api/javac/tree/com/sun/source}
\newcommand{\refTreeclass}[2]{\href{\TreeAPIBase{}/#1/#2.html?is-external=true}{\<#2>}}
\newcommand{\ModelAPIBase}{https://docs.oracle.com/javase/11/docs/api/javax/lang/model}
...
\href{https://docs.oracle.com/javase/11/docs/jdk/api/javac/tree/}{Tree
API},
