...
\<qual> should be placed in the same directory as your checker's source
file (unless you are creating multiple distribution artifacts, one for your
...
\<com.sun.source.tree.CompilationUnitTree> has a LineMap lets you convert
