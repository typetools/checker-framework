...
\end{Verbatim}
%
\<MyPropChecker.java> is occasionally optional, such as if you are building
on the Subtyping Checker.  You may wish to put the \<qual/> directory in a
separate Maven/Gradle project, if you want to create an artifacts
containing just the qualifiers (similar to the Checker Framework's
\<checker-qual> artifact).
