...
\subsection{Annotations whose argument is a Java expression (``dependent type annotations'')\label{expression-annotations}}
...
to return a new \<DependentTypesHelper> that has been initialized with the
checker's dependent type annotations.
