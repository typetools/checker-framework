...
\item
  ...
  and calls to
  \sunjavadoc{java.base/java/lang/System.html\#clearProperty()}{System.clearProperty()}
  ...
  and
  \sunjavadoc{java.base/java/lang/System.html\#setProperty(java.lang.String)}{System.setProperty(String)}.
...
``initialization.''~(note the trailing period) warning suppression string.  You
...
string (without a period) has the same effect as the ``nullness'' string:  both
