...
\begin{itemize}
\item
  \label{nullness-lint-newarrayshavenullcomponents}%
  \label{nullness-lint-nonnullarraycomponents}% temporary, for backward compatibility
  If you supply the \code{-Alint=newarrayshavenullcomponents} command-line
...
\code{-Alint=newarrayshavenullcomponents}.  The option is currently disabled
because it makes the checker issue many false positive errors.
% TODO: flip the default after collecting more data.

When the \code{-Alint=newarrayshavenullcomponents} option is supplied,
...
% LocalWords:  newarrayshavenullcomponents lombok findbugs CurrentClass
