...
\item
The Java projects in the \href{plume-lib GitHub
organization}{https://github.com/plume-lib/}.
...
At the end of the constructor, the type is not fully initialized. Rather,
it is \<@UnderInitialization(\emph{supertype})>.
