...
\href{https://docs.oracle.com/javase/specs/jls/se10/html/jls-16.html}{JLS ch.16}),
...
\href{https://docs.oracle.com/javase/specs/jls/se10/html/jls-4.html#jls-4.12.4}{JLS \S 4.12.4}) because fields
...
% \urldef{\jlsconstructorbodyurl}{\url}{https://docs.oracle.com/javase/specs/jls/se10/html/jls-8.html#jls-8.8.7}
...
\paragraphAndLabel{Suppressing warnings}{initialization-checking-suppressing-warnings}
...
\subsectionAndLabel{Rawness Initialization Checker}{initialization-rawness-checker}
...
\subsubsectionAndLabel{Rawness qualifiers}{rawness-qualifiers}
...
\subsubsectionAndLabel{How an object becomes non-raw}{becoming-non-raw}
...
\subsubsectionAndLabel{Partial initialization}{rawness-partial-initialization}
...
\paragraphAndLabel{Example}{rawness-partial-initialization-example}
...
\subsubsectionAndLabel{More details about rawness checking}{rawness-checking}


\paragraphAndLabel{Suppressing warnings}{rawness-checking-suppressing-warnings}

% TODO: use @SuppressWarnings("initialization") instead of @SuppressWarnings("rawness")?
\begin{sloppypar}
You can suppress warnings related to partially-initialized objects with
...
\paragraphAndLabel{Use of method annotations}{rawness-checking-method-annotations}
...
\paragraphAndLabel{The terminology ``raw''}{rawness-checking-terminology-raw}
...
% LocalWords:  forbidnonnullarraycomponents lombok findbugs CurrentClass
