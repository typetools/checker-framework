...
\code{-Alint=forbidnonnullarraycomponents}.  The opiton is currently disabled
...
a constructor (with the exception of final classes; but this is currently not implemented),
