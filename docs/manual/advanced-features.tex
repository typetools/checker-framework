...
Defaulting does not apply to type declarations:  writing no type qualifier
is equivalent to writing the top qualifier and this behavior cannot be changed.
...
Class declaration locations are not defaulted.
...
If a programmer does not write a type qualifier, that is equivalent to writing the top type qualifier, not writing the default type qualifier.
