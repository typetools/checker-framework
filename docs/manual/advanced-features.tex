...
If it is not possible to annotate the class's definition,
...
\item
  ...
  explicitly written on the declaration of \<MyClass>, or specified via
  \refqualclass{framework/qual}{UpperBoundFor}. (Section~\ref{default-for-use})
\item
