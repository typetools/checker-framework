...
If the checker \emph{was run} during the compiler execution that created the
\<.class> file,
...
The rest of this section discusses the situation when
the checker \emph{was not run} during the compiler execution that created the
\<.class> file.  The \<.class> file contains only the type qualifiers
...
\noindent
for an appropriate value of \<@Top> and \<@Bottom>.
