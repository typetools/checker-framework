...
rules 6 and 7 apply.  This makes the type of a local variables top so they can be refined (although
for some type systems, the default qualifier in hierarchy is not necessary to be top).
