...
\iffalse TODO DELEGATION CHECKER
\item
  \ahrefloc{delegation-checker}{Delegation Checker} to ensure that a
  wrapper class delegates properly (see
  \chapterpageref{delegation-checker})
\fi
\item
