...
\item
  \ahrefloc{modifiability-checker}{Modifiability Checker} to
  warn about a possible \<UnsupportedOperationException> at run time when
  modifying a collection
  (see \chapterpageref{modifiability-checker})
\end{itemize}
