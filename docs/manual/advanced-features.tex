...
At a \<new> expression, the expressions that are reached through \<this> are
ignored, because the object being constructed did not exist before the call and therefore
no expression at the call site refers to it.  A constructor's \<@SideEffectsOnly>
