...
\item
  The qualifier with a meta-annotation \<@DefaultFor(variableNames = REGEX)>, where \<REGEX>
  matches the name of the variable being defined (if any). (Section~\ref{default-for-use})
\item
