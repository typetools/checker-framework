...
assignment relating them appears in the method body.  That approximation is
flow-insensitive and never splits alias sets, so a method that modifies a listed
expression through an alias created elsewhere is accepted:
