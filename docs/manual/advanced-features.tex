...
\begin{itemize}
\item \refqualclass{framework/qual}{DefaultQualifier}
...
\item
  ...
  (e.g org.checkerframework.checker.nullness.qual.NonNull.class) or simply
  named class (e.g Nullable.class) that should has appropriate import in
  the containing stub file.
