...
A predicate annotation allows you to write specifications with disjunctions (the accumulation annotation implicitly already permits
specifications with conjunctions). If you define such an annnotation, it must have a single argument named \<value> of type \<String>.
