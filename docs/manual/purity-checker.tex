...
That implies \<-AcheckPurityAnnotations>, so you do not need to supply that
option as well.
...
because of a high false positive rate.  In the future, after a new purity-checking analysis is
