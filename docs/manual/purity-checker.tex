...
\sectionAndLabel{Overriding methods inherit specifications from superclasses}{purity-override}

A purity annotation is inherited:  if a method in a superclass has a purity
annotation, then every overriding definition has that annotation too, even
if the annotation is not written on the overriding definition.  An
overriding definition may strengthen the specification by writing a
stronger annotation, but it cannot weaken it.
