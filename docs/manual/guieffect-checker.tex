...
arguments, even though the implicitly \code{@PolyUI} \emph{receiver} may be overridden with an
...
overridden, switching from a \code{@PolyUI} receiver to an \code{@AlwaysSafe} receiver.  That change is
...
The paper ``JavaUI: Effects for controlling UI object
