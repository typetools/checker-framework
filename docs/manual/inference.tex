...
\ahref{https://github.com/apache/zookeeper}{Apache Zookeeper's}
...
\<sh wpi.sh -b "-B --projects zookeeper-server --also-make" -c "install -DskipTests" -- resourceleak>.
...
\item[-b EXTRA\_BUILD\_ARGS]
  ...
  The main difference between this option and \<-t> is that the values
