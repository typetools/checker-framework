...
\<wpi2.sh> continues from them rather than starting over.  To start inference
from scratch, remove \<whole-program-inference-output> before running
\<wpi2.sh>.
...
\<WPI2\_MAX\_ITERATIONS> environment variable to change the bound.
