...
\item
If an annotation is inferred for a \emph{use} of a type variable,
it might be more appropriate for you to move the annotation
...
\ahrefforurl{https://checkerframework.org/annotation-file-utilities/}{Annotation File Utilities}.
