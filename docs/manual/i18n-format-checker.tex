...
The Internationalization Checker or I18n Checker (\sectionpageref{i18n-checker})
...
\<time>, or \<choice>. These four format types correspond to different
...
categories for the format, \code{\{0, number\} \{2, number\}}, are
...
of \sunjavadoc{java.base/java/util/Date.html}{Date} or
\sunjavadoc{java.base/java/lang/Number.html}{Number} type or a subclass of them,
including \sunjavadoc{java.sql/java/sql/Time.html}{Time},
\sunjavadoc{java.sql/java/sql/Timestamp.html}{Timestamp}, and the classes
