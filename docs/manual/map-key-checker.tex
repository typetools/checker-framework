...
This reduces false
positives when \code{null} is assigned to a variable whose type is a type variable,
but it does require you to take action if a
type variable will be instantiated with \code{@KeyFor} for a particular map.
In that case,
