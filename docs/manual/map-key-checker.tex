...
\begin{description}
\item[\refqualclasswithparams{checker/index/qual}{EnsuresKeyFor}{String[] value, String[] map}]
  ...
  of this annotation.
\item[\refqualclasswithparams{checker/index/qual}{EnsuresKeyForIf}{String[] expression, boolean result, String[] map}]
