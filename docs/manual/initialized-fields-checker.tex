...
Without the Initialized Fields Checker, every type system (except the
Nullness Checker, \chapterpageref{nullness-checker}) is unsound with respect
to fields that are never set.  Consider the following code:
