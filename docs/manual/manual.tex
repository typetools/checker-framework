...
\newcommand{\ReleaseVersion}{3.43.0}
\newcommand{\ReleaseInfo}{3.43.0 (1 May 2024)}
...
% TODO: Uncomment when the Non-Empty Checker is mature enough to be used as a
% standalone checker (e.g., not always run as a subchecker).
