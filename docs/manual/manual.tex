...
\author{\url{http://checker-framework.com/}}
\newcommand{\ReleaseVersion}{2.1.7}
\newcommand{\ReleaseInfo}{2.1.7 (3 Jan 2017)}
...
%HEVEA This manual is also available in \href{http://checker-framework.com/manual/checker-framework-manual.pdf}{PDF}.
