...
\item[\refqualclass{checker/determinism/qual}{OrderNonDet}] applies only
...
\begin{description}
\item[\refqualclass{checker/determinism/qual}{Ond2D}]
  Applied to \<@PolyDet>,
  changes an \<@OrderNonDet> instantiation into \<@Det>.
\item[\refqualclass{checker/determinism/qual}{Ond2Nd}]
  Applied to \<@PolyDet>,
...
\refqualclass{checker/determinism/qual}{Ond2D} annotation, it is
...
There is also an \refqualclass{checker/determinism/qual}{Ond2Nd}.
...
\begin{description}
\item[\refqualclass{checker/determinism/qual}{UsePolyDet}]
