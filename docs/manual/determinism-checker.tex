...
% TODO: "Set equals" is not the Java way to describe a method.  Use
% "Set.equals" or "Set.equals()" instead.
% TODO: Per
% https://checkerframework.org/manual/#creating-documenting-a-checker, the
% label should start with the checker name.
\subsubsection{Special handling of Set equals\label{improved-precision-set-equals}}
