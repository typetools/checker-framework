...
If the ordering of elements in a collection is unknown, sorting it should put
them in a deterministic order. Thus, the Determinism Checker automatically
...
aren't strictly determistic. For example, the following code type checks:
