...
% TODO: This section is poorly named.  It doesn't tell a user how to handle
% imprecision.  It just says how one particular method is handled, so that
% would be a better way to title it, if you retain it in the manual.
