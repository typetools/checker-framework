...
\item{\textbf{Enum declarations:}}
  Enum declarations should contain at least one enum constant.

\item{\textbf{Nested/inner classes/interfaces/enums declarations:}}
  Nested/inner types declarations are allowed to be declared as in a regular
  java file inside an outer class/interface/enum declaration.
...
\item
  Annotations can only use string, boolean, or integer literals; other
