...
typecheck clients of the library.
...
know what parts you have annotated and what parts you have not.  Also,
ensure that every file is fully annotated or not annotated at all --- it's
very confusing when a file has partial annotations.
