...
libraries in
directory \<checker-framework/checker/annotated-libraries/>.
See its
\href{https://github.com/typetools/annotated-libraries/tree/master/}{\<README.md>
...
\begin{enumerate}
\item Read file \<checker-framework/checker/annotated-libraries/README.md>
...
\item
  ...
  \item
    ...
    \<checker-framework/checker/annotated-libraries/> of the Checker
    Framework release.
