...
necessary, documentation of those annotations.

Do not change the library's code or documentation, or make changes to
formatting or whitespace.  Doing so will increase the size of the diffs
