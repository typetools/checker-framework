...
The command-line option \<-AmergeStubsWithSource> tells the checker to
take the greatest lower bound of the type in the stub file and the type in
the source code if both are available. Note that for type systems with defaults
other than top (e.g. the Nullness Checker), this option should not be used.
