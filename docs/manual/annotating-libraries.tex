...
To override the default behavior, use command-line option
\<-AmergeStubsWithSource>, and the Checker Framework will use
stronger types from stub files even if the corresponding source file is available:
