...
type or typedef, but retains backward-compatibility with interfaces that
...
Java's
\href{https://docs.oracle.com/javase/specs/jls/se25/html/jls-8.html#jls-8.9}{\code{enum}}
...
\item[the typesafe enum pattern]  a class with a private constructor.
% This requires
