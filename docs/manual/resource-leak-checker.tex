...
% -Ainfer flag is enabled. To utilize [[TODO: is this \emph{instead} or
% \emph{in addition}?]] the whole-program inference mechanism outlined in
% section \ref{whole-program-inference}, you should provide the
% \<-AenableWpiForRlc> flag.
%
