...
\sectionAndLabel{Creating obligations}{resource-leak-createsmustcallfor}
...
Sections~\cref{resource-leak-createsmustcallfor-callsite,resource-leak-createsmustcallfor-decallsite}
explain how the Resource Leak Checker verifies uses and declarations of
methods annotated with \<@CreatesMustCallFor>.


\subsectionAndLabel{Requirements at a call site}{resource-leak-createsmustcallfor-callsite}
...
\subsectionAndLabel{Requirements at a declaration (how to re-assign non-final owning fields}{resource-leak-createsmustcallfor-declaration}
