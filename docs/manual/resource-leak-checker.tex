...
obligations satisfied on all paths in (only) the destructor, and will issue a \<required.method.not.called>
annotation if they are not satisfied, as it would for an \<@Owning> formal parameter to the destructor.
