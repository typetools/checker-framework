...
fail at run time), then you should either write specifications in the codebase
based on uses of the assertion or suppress
warnings related to uses of the assertion method; see below for an
explanation of each approach.

The method
\refmethod{checker/nullness/util}{NullnessUtil}{castNonNull}{-T-} is not an
assertion method.  It is a specification or warning suppression method.
...
\noindent
You should annotated the appropriate parameter type of \<myGet> as \<@NonNull> (which is the
