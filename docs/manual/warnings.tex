...
With the \code{-ArequireCheckerPrefixInWarningSuppressions} command-line
option, a warning is only suppressed if the key in the suppress warnings
annotation begins with the checker name.
...
% LocalWords:  AuseDefaultsForUncheckedCode checkerframework
