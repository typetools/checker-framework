...
If the value in parentheses refers to a checker with
subcheckers, then its subcheckers will also assume that the
assertion is true (e.g. the KeyFor Checker will assume that
...
\refmethod{checker/nullness/util}{NullnessUtil}{castNonNull}{-T-} are used
