...
the \code{-AshowSuppressWarningStrings} command-line option to see them.
...
The value in parentheses is a Suppresswarnings checkername,
...
%%  LocalWords:  AshowSuppressWarningStrings NullableType NonNullType JUnit's
