...
Java 5/6/7 does not support type annotations.

Sometimes, your code uses declaration annotations, but you wish to use them
in pluggable typechecking; see Section~\ref{declaration-annotations-moved}.
...
\noindent
because Android's \<@NonNull> annotation is a declaration annotation that
is specified to apply to the top-level return type of the annotated method.
