...
option, a warning is only suppressed if the key is in the \code{"\emph{checkername}:\emph{messagekey}"}
format, as in
...
issue has been fixen (though the \<-AwarnUnneededSuppressions> command-line
...
%%  LocalWords:  assumeassertion askipdefs alint compat
