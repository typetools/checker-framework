...
a version of Guava with corrected annotations by replacing
``com.google.guava'' by ``org.checkerframework.annotatedlib'' in your build
file.  (The code is identical; the only difference is annotations.)
