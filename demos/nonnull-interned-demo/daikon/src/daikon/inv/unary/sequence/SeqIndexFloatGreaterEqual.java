...
public class SeqIndexFloatGreaterEqual extends SingleFloatSequence {
  ...
  private SeqIndexFloatGreaterEqual () {
    super (null);
  }
  ...
  public static SeqIndexFloatGreaterEqual find(PptSlice ppt) {
