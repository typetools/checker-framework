...
public class SeqIndexIntGreaterThan extends SingleScalarSequence {
  ...
  private SeqIndexIntGreaterThan () {
    super (null);
  }
  ...
  public static SeqIndexIntGreaterThan find(PptSlice ppt) {
