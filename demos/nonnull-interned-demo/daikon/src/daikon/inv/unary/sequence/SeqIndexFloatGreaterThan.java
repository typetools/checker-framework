...
public class SeqIndexFloatGreaterThan extends SingleFloatSequence {
  ...
  private SeqIndexFloatGreaterThan () {
    super (null);
  }
  ...
  public static SeqIndexFloatGreaterThan find(PptSlice ppt) {
