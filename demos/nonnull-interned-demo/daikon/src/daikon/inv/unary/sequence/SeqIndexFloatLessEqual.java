...
public class SeqIndexFloatLessEqual extends SingleFloatSequence {
  ...
  private SeqIndexFloatLessEqual () {
    super (null);
  }
  ...
  public static SeqIndexFloatLessEqual find(PptSlice ppt) {
