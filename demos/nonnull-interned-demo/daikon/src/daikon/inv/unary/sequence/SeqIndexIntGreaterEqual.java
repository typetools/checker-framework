...
public class SeqIndexIntGreaterEqual extends SingleScalarSequence {
  ...
  private SeqIndexIntGreaterEqual () {
    super (null);
  }
  ...
  public static SeqIndexIntGreaterEqual find(PptSlice ppt) {
