  ...
  extends TwoSequence
{
  ...
  protected Invariant instantiate_dyn (PptSlice slice) {
    return (new PairwiseIntLessEqual(slice));
  }
  ...
  public static PairwiseIntLessEqual find(PptSlice ppt) {
