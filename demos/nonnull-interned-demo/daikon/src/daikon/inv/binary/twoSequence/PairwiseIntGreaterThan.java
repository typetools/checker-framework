  ...
  extends TwoSequence
{
  ...
  protected Invariant instantiate_dyn (PptSlice slice) {
    return (new PairwiseIntGreaterThan(slice));
  }
  ...
  public static PairwiseIntGreaterThan find(PptSlice ppt) {
