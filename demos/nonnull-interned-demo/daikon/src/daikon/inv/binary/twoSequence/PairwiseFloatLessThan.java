  ...
  extends TwoSequenceFloat
{
  ...
  protected Invariant instantiate_dyn (PptSlice slice) {
    return (new PairwiseFloatLessThan(slice));
  }
  ...
  public static PairwiseFloatLessThan find(PptSlice ppt) {
