  ...
  extends TwoSequenceFloat
{
  ...
  protected Invariant instantiate_dyn (PptSlice slice) {
    return (new PairwiseFloatLessEqual(slice));
  }
  ...
  public static PairwiseFloatLessEqual find(PptSlice ppt) {
