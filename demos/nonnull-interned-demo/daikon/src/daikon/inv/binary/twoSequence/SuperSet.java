  ...
  extends TwoSequence
{
  ...
  public DiscardInfo isObviousStatically(VarInfo[] vis) {
    ...
    Object[] obvDeriv1 = SuperSet.isObviousSubSet(var1, var2);
    Object[] obvDeriv2 = SuperSet.isObviousSubSet(var2, var1);
    if (obvDeriv1[1]!=null) {
  ...
  public static SuperSet find(PptSlice ppt) {
  ...
  public boolean isSameFormula(Invariant other) {
    Assert.assertTrue(other instanceof SuperSet);
    return true;
  }
