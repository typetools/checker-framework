...
/**
 * Base class for two variable String[] invariants.  Provides a simpler
 ...
 **/
public abstract class TwoSequenceString extends BinaryInvariant {
  ...
  /** Pass-through. */
  protected TwoSequenceString (PptSlice ppt) {
    super(ppt);
  }
  ...
  final public boolean valid_types (VarInfo[] vis) {
    ...
    return (dim_ok && vis[0].file_rep_type.baseIsString()
  ...
  public abstract InvariantStatus check_modified(String[] v1,
                                                 String[] v2, int count);

  public InvariantStatus check_unmodified(String[] v1,
                                          String[] v2, int count) {
  ...
  public boolean isSameFormula(Invariant other) {
    TwoSequenceString inv = (TwoSequenceString) other;
