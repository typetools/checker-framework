  ...
  implements Comparison
{
    ...
    Assert.assertTrue (ppt != null);
      ...
      if ((arr1 != v1) || (arr2 != v2)) {
        ...
        if (slice != null) {
          ...
          found.add (SeqSeqIntEqual.find(slice));
          found.add (SeqSeqIntLessThan.find(slice));
          found.add (SeqSeqIntGreaterThan.find(slice));
          found.add (SeqSeqIntLessEqual.find(slice));
          found.add (SeqSeqIntGreaterEqual.find(slice));
  ...
  public static SeqSeqIntGreaterEqual find(PptSlice ppt) {
