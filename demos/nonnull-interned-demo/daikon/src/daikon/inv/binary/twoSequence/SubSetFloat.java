  ...
  extends TwoSequenceFloat
{
  ...
  public DiscardInfo isObviousStatically(VarInfo[] vis) {
    ...
    Object[] obvDeriv1 = SubSetFloat.isObviousSubSet(var1, var2);
    Object[] obvDeriv2 = SubSetFloat.isObviousSubSet(var2, var1);
    if (obvDeriv1[1]!=null) {
