...
public final class IntGreaterEqual
  ...
  private static IntGreaterEqual proto;

  /** Returns the prototype invariant for IntGreaterEqual **/
  public static IntGreaterEqual get_proto() {
    if (proto == null)
      proto = new IntGreaterEqual (null);
    return (proto);
  }
  ...
  public static IntGreaterEqual find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      IntGreaterEqual inv = (IntGreaterEqual) proto.instantiate_dyn (ppt);
