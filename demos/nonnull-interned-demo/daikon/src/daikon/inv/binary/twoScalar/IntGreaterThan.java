...
public final class IntGreaterThan
  ...
  private static IntGreaterThan proto;

  /** Returns the prototype invariant for IntGreaterThan **/
  public static IntGreaterThan get_proto() {
    if (proto == null)
      proto = new IntGreaterThan (null);
    return (proto);
  }
  ...
  public static IntGreaterThan find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      IntGreaterThan inv = (IntGreaterThan) proto.instantiate_dyn (ppt);
