...
public final class FloatGreaterThan
  ...
  private static FloatGreaterThan proto;

  /** Returns the prototype invariant for FloatGreaterThan **/
  public static FloatGreaterThan get_proto() {
    if (proto == null)
      proto = new FloatGreaterThan (null);
    return (proto);
  }
  ...
  public static FloatGreaterThan find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      FloatGreaterThan inv = (FloatGreaterThan) proto.instantiate_dyn (ppt);
