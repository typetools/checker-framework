...
public final class IntLessEqual
  ...
  private static IntLessEqual proto;

  /** Returns the prototype invariant for IntLessEqual **/
  public static IntLessEqual get_proto() {
    if (proto == null)
      proto = new IntLessEqual (null);
    return (proto);
  }
  ...
  public static IntLessEqual find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      IntLessEqual inv = (IntLessEqual) proto.instantiate_dyn (ppt);
