...
public final class FloatNonEqual
  ...
  private static FloatNonEqual proto;

  /** Returns the prototype invariant for FloatNonEqual **/
  public static FloatNonEqual get_proto() {
    if (proto == null)
      proto = new FloatNonEqual (null);
    return (proto);
  }
  ...
  public static FloatNonEqual find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      FloatNonEqual inv = (FloatNonEqual) proto.instantiate_dyn (ppt);
