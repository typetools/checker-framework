...
public final class StringLessThan
  ...
  private static StringLessThan proto;

  /** Returns the prototype invariant for StringLessThan **/
  public static StringLessThan get_proto() {
    if (proto == null)
      proto = new StringLessThan (null);
    return (proto);
  }
  ...
  public static StringLessThan find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      StringLessThan inv = (StringLessThan) proto.instantiate_dyn (ppt);
