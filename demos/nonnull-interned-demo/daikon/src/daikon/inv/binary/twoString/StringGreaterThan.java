...
public final class StringGreaterThan
  ...
  private static StringGreaterThan proto;

  /** Returns the prototype invariant for StringGreaterThan **/
  public static StringGreaterThan get_proto() {
    if (proto == null)
      proto = new StringGreaterThan (null);
    return (proto);
  }
  ...
  public static StringGreaterThan find(PptSlice ppt) {
    ...
    if ((suppressions != null) && suppressions.suppressed (ppt)) {
      StringGreaterThan inv = (StringGreaterThan) proto.instantiate_dyn (ppt);
