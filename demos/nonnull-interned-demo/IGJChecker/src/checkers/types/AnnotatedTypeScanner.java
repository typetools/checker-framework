 ...
 */
public class AnnotatedTypeScanner<R, P> implements AnnotatedTypeVisitor<R, P>, checkers.types.visitors.AnnotatedTypeVisitor<R,P> {

    // To Prevent infinite loop
    private Map<AnnotatedTypeMirror, R> visitedNodes = 
        new HashMap<AnnotatedTypeMirror, R>();
