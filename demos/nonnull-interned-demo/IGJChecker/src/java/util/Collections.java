...
public class Collections {
  ...
  public static <T extends Comparable<? super T>> T min(@ReadOnly Collection<? extends T> a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T extends Comparable<? super T>> T max(@ReadOnly Collection<? extends T> a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> boolean addAll(@Mutable Collection<? super T> a1, @ReadOnly T[] a2) { throw new RuntimeException("skeleton method"); }
