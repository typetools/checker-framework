...
public class Collections{
  ...
  public static <T extends java.lang.Comparable<? super T>> T min(/*@ReadOnly*/ java.util.Collection<? extends T> a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T extends java.lang.Comparable<? super T>> T max(/*@ReadOnly*/ java.util.Collection<? extends T> a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> boolean addAll(@Mutable java.util.Collection<? super T> a1, /*@ReadOnly*/ T[] a2) { throw new RuntimeException("skeleton method"); }
