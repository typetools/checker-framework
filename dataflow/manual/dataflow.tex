...
\newcommand{\constantpropagation}[2]{
    \flowlst{Const#1}{{#2 Its CFG and intermediate analysis results is depicted in \autoref{fig:Const#1}.}}
    \flowimg{Const#1}{The control-flow graph (including intermediate analysis results) to \autoref{lst:Const#1}.}
}
...
\title{A Dataflow Framework for Java and the Checker Framework}
\author{
              Stefan Heule\\\url{stheule@cs.washington.edu}
              \and
