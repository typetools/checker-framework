...
whether dataflow analysis is still in progress or handle possible null values.
The factory should return conservative, flow-insensitive types if the analysis
