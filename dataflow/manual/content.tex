...
All classes are in package \code{org.checkerframework.dataflow.cfg.node}.
    ...
    \begin{longtable}{lp{0.4\linewidth}l}
        ...
        \code{ThisKeyword} & Base class of references to \code{this} & \\
        \code{ExplicitThisKeyword} & Explicit use of \code{this} in an expression & \\
        \code{ImplicitThisKeyword} & Implicit use of \code{this} in an expression & \\
...
%  LocalWords:  StringLiteral Accessor ArrayAccess FieldAccess ThisKeyword
%  LocalWords:  MethodAccess ExplicitThisKeyword ImplicitThisKeyword java
