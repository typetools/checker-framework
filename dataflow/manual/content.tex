...
\code{org.checkerframework.shaded.dataflow} and also the Checker Framework
qualifiers in their usual packages and the plume-util project
(\url{https://github.com/plume-lib/plume-util}) in its usual package.
...
%  LocalWords:  MethodAccess ExplicitThis ImplicitThis java
