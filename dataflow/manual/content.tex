...
\begin{enumerate}
    \item For every field access $o_2.f$ that is a key in $S$, remove its
      ...
      syntactically the same) and the case where $o_2$ and $o_1$ might be
      aliases.
