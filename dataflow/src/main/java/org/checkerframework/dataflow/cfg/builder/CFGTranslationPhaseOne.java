        ...
        if (finallyLabel != null) {
            ...
            { // Scan 'finallyBlock' for only 'finallyLabel' (a successful path)
                ...
                extendWithNode(
                        new MarkerNode(
                                tree,
                                "start of finally block #" + CFGBuilder.treeUids.get(tree),
                                env.getTypeUtils()));
                scan(finallyBlock, p);
                extendWithNode(
                        new MarkerNode(
                                tree,
                                "end of finally block #" + CFGBuilder.treeUids.get(tree),
                                env.getTypeUtils()));
            ...
            if (returnTargetL.wasAccessed()) {
                ...
                extendWithNode(
                        new MarkerNode(
                                tree,
                                "end of finally block for return #" + CFGBuilder.treeUids.get(tree),
                                env.getTypeUtils()));
            ...
            if (breakTargetL.wasAccessed()) {
                ...
                extendWithNode(
                        new MarkerNode(
                                tree,
                                "end of finally block for break #" + CFGBuilder.treeUids.get(tree),
                                env.getTypeUtils()));
                extendWithExtendedNode(new UnconditionalJump(breakTargetL.accessLabel()));
            } else {
                breakTargetL = oldBreakTargetL;
