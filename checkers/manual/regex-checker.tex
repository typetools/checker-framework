...
\item[\<@\refclass{checkers/regex/quals}{Regex}>]
...
\item[\<@\refclass{checkers/regex/quals}{PolyRegex}>]
  indicates qualifier polymorphism. For a description of
  \<@\refclass{checkers/regex/quals}{PolyRegex}>,
...
\item[\refmethod{checkers/regex}{RegexUtil}{isRegex}{(java.lang.String)}]
  returns \<true> if its argument is a valid regular expression.

\item[\refmethod{checkers/regex}{RegexUtil}{regexError}{(java.lang.String)}]
...
\item[\refmethod{checkers/regex}{RegexUtil}{regexException}{(java.lang.String)}]
  returns the
...
\refmethod{checkers/regex}{RegexUtil}{isRegex}{(java.lang.String, int)} method
verifies that the argument has at least the given number of groups. The
\refmethod{checkers/regex}{RegexUtil}{regexError}{(java.lang.String, int)} and
\refmethod{checkers/regex}{RegexUtil}{regexException}{(java.lang.String, int)}
...
\refclass{checkers/regex}{RegexUtil.CheckedPatternSyntaxException}. This exception is
...
\refclass{checkers/regex}{RegexUtil.CheckedPatternSyntaxException}.
...
\refmethod{checkers/regex}{RegexUtil}{asRegex}{(java.lang.String)} method to suppress the
warning.
...
There is an additional \refmethod{checkers/regex}{RegexUtil}{asRegex}{(java.lang.String, int)}
