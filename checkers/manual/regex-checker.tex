...
example of use of the \code{RegexUtil} methods.
...
// The following line is only necessary until the Regex Checker supports
// flow-sensitivity, after which time it can be removed from the code.
regex = RegexUtil.asRegex(regex);
