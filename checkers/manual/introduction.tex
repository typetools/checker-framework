...
\item \<-sourcepath> Indicates where to find the skeleton classes; skeleton
  files are being phased out; see Section~\ref{skeleton-using}
...
anywhere appropriate.  Do not read nor annotate the method bodies yet ---
first, get the signatures and fields annotated.  If you are only annotating
