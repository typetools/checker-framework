...
\ahref{http://developer.apple.com/java/}{Apple's implementation},
...
\item
  ...
  \code{\$CHECKERS/binary} to your path, then whenever
...
\item \<-Afilenames>, \<-Anomsgtext>, \<-Ashowchecks>, \<-AprintErrorStack> Aids for testing or debugging a checker; see Section~\ref{debugging-options}
\end{itemize}
