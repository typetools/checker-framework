...
\item \<-Afilenames>, \<-Anomsgtext>, \<-Ashowchecks>, \<-AprintErrorStack>, \<-AprintAllQualifiers> Aids for testing or debugging a checker; see Section~\ref{debugging-options}
\end{itemize}
