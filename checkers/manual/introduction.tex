...
\item
  ...
  OpenJDK javac compiler.  Two ways to do this are:
  \begin{itemize}
  \item
    Add directory
...
such as \code{-processor} and file names.  You might want to create an
alias, as in (for Unix):
\begin{Verbatim}
  alias javacheck='java -Xbootclasspath/p:$CHECKERS/binary/jsr308-all.jar -jar $CHECKERS/binary/jsr308-all.jar -version'
\end{Verbatim}
