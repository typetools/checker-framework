...
Plugin webpage: \ahrefurl{http://types.cs.washington.edu/checker-framework/current/checkers.zip}.
...
(\ahrefurl{http://types.cs.washington.edu/checker-framework/tutorial/})
...
from the command line.  There is also a tutorial
(\ahrefurl{http://types.cs.washington.edu/checker-framework/tutorial/})
