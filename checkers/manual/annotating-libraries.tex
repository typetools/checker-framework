...
\item
  When you run \code{javac}, add a \code{-Xbootclasspath/p:} argument to indicate
  where to find the annotated JDK classes.
  Supply \code{-Xbootclasspath/p} in addition to whatever other arguments you
  usually use, including \code{-classpath}.

  The \code{-Xbootclasspath/p:} argument causes the compiler to read annotations
