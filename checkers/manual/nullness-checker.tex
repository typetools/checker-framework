...
\item[\code{@\refclass{nullness/quals}{AssertNonNullIfFalse}}]
  ...
  expressions are non-null after the method returns; this is useful for
  methods that initialize a field, for example.  With
  ...
  expressions are non-null.  See the Javadoc for examples of their use.
