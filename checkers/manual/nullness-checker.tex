...
\item
  ...
  the reference is guaranteed to be nonnull, as in \code{("m" == null)}.
...
on a method declares that some expressions are nonnull, if the method
returns true.
...
% LocalWords:  Nullability typeargs
