...
\section{Initialization Checker\label{initialization-checker}}
 ...
 object is partially initialized from the time that its constructor starts until its constructor
...
is initalized (all its \<@NonNull> fields have been assigned), under
...
``Freedom Before Committment''~\cite{SummersM2011}.  Our implementation
