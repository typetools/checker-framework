...
The Nullness Checker supports a rawness annotation that indicates whether
an object is fully initialized --- that is, whether its fields have all
been assigned.  Use of this annotation can help you to type-check more
...
One usage pattern is for a user-managed collection that is a subset of the
key set:

\begin{Verbatim}
Map<String, Object> m;
Set<@KeyOf("m") String> matchingKeys; // keys that match some criterion
for (String k : matchingKeys) {    // checker infers type to be @KeyOf("m") String>
