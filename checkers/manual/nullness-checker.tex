...
non-null if \sunjavadoc{java/util/Queue.html#isEmpty()}{Queue.isEmpty}
returns false.
...
\code{@\refclass{nullness/quals}{NonNullOnEntry}} and
\code{@\refclass{nullness/quals}{AssertNonNullAfter}} method annotations;
