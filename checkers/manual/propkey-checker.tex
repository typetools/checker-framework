...
The annotation \code{@\refclass{checkers/propkey/quals}{PropertyKey}}
...
\begin{enumerate}
\item \code{@\refclass{checkers/i18n/quals}{Localized}}: indicates that the qualified
\code{String} is a message that has been localized and/or formatted with
respect to the used locale.

\item \code{@\refclass{checkers/i18n/quals}{LocalizableKey}}: indicates that the
...
\code{@\refclass{checkers/compilermsgs/quals}{CompilerMessageKey}}.
