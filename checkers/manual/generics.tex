...
type to be \emph{covariant} in the type parameter.  Use the \<@\refclass{checkers/nullness/quals}{Covariant}> annotation to indicate
this.
...
\<@\refclass{checkers/quals}{PolymorphicQualifier}>.  For example,
\<@\refclass{checkers/nullness/quals}{PolyNull}> is a polymorphic type
