...
\subsection{Why are the type parameters to \<List> and \<Map> annotated as \<@NonNull>?\label{list-map-nonnull-typeargs}}

If you try to write \code{List<@Nullable Object>}, or to use a nullable
type parameter to 
certain other collections (including \<AbstractCollection>, \<Collection>,
...
\subsection{How can I do run-time monitoring of properties that were not statically checked?}
