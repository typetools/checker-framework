...
The 
\ahrefloc{igj-checker}{IGJ Checker} (see \chapterpageref{igj-checker}) and
the 
and \ahrefloc{javari-checker}{Javari Checker} (see
\chapterpageref{javari-checker}) have known bugs that limit their
