...
\chapterpageref{javari-checker}), and 
\ahrefloc{typestate-checker}{typestate checkers} (see
...
The papers
\ahref{\url{http://homes.cs.washington.edu/~mernst/pubs/pluggable-checkers-issta2008-abstract.html}}{``Practical
  pluggable types for Java''}~\cite{PapiACPE2008}
and
\ahref{\url{http://homes.cs.washington.edu/~mernst/pubs/pluggable-checkers-icse2011-abstract.html}}{``Building
...
\section{How handle warnings and errors\label{faq-warnings-section}}
...
Oftentimes there is an explanation of it.


\subsection{Can a pluggable type-checker give an absolute guarantee of correctness?\label{faq-no-absolute-guarantee}}
...
\refmethod{checkers/nullness}{NullnessUtils}{castNonNull}{(T)} method (see
...
\begin{enumerate}
\item
Annotate the field type as \code{@\refclass{checkers/nullness/quals}{MonotonicNonNull}}.
\item
Annotate the method that sets the field as \code{@\refclass{checkers/nullness/quals}{EnsuresNonNull}("\emph{myFieldName}")}.
...
\code{@\refclass{checkers/nullness/quals}{RequiresNonNull}("\emph{myFieldName}")}.
...
\<Object> is treated consistenly with all other types in this location and
...
to look for more help, such as the \ahref{api/}{Checker Framework
...
A bug detector like \ahref{\url{http://findbugs.sourceforge.net/}}{FindBugs}~\cite{HovemeyerP2004,HovemeyerSP2005},
\ahref{\url{http://jlint.sourceforge.net/}}{Jlint}~\cite{Artho2001}, or
\ahref{\url{http://pmd.sourceforge.net/}}{PMD}~\cite{Copeland2005} aims to find \emph{some}
...
\ahref{\url{http://homes.cs.washington.edu/~mernst/pubs/pluggable-checkers-issta2008.pdf}}{``Practical pluggable types for Java''}~\cite{PapiACPE2008}.


\subsection{How does pluggable type-checking compare with JML?\label{faq-jml}}

\ahref{\url{http://www.cs.ucf.edu/~leavens/JML/}}{JML}, the Java Modeling
...
\ahref{\url{http://types.cs.washington.edu/jsr308/current/jsr308-faq.html#pluggable-type-checking-in-java}}{Type
...
%  LocalWords:  m1 m2 RequiresNonNull AconcurrentSemantics 8's 8's
