...
\begin{enumerate}
\item
Annotate the field type as \code{@\refclass{nullness/quals}{MonotonicNonNull}}.
\item
Annotate the method that sets the field as \code{@\refclass{nullness/quals}{EnsuresNonNull}("\emph{myFieldName}")}.
...
\code{@\refclass{nullness/quals}{RequiresNonNull}("\emph{myFieldName}")}.
