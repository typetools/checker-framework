...
Java's 
\ahref{\url{http://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html#jls-8.9}}{\code{enum}}
...
\item[the \ahref{\url{http://www.oracle.com/technetwork/java/page1-139488.html}}{typesafe
enum pattern}]  a class with private constructor.
% This requires
% \ahref{\url{http://www.javaworld.com/javaworld/javatips/jw-javatip122.html}}{careful development}.
\end{description}
...
(\code{@FenumTop}, \code{@FenumUnqualified}, and \code{@Bottom})
...
\item Use the provided \code{@\refclass{checkers/fenum/quals}{Fenum}} annotation, which takes a
...
\item
If your code uses the \code{@\refclass{checkers/fenum/quals}{Fenum}} annotation, you do
...
\item Java Language Specification on enums:\\
  \ahrefurl{http://docs.oracle.com/javase/specs/jls/se7/html/jls-8.html\#jls-8.9}
...
\item Typesafe enum pattern:\\
  \ahrefurl{http://www.oracle.com/technetwork/java/page1-139488.html}

\item Java Tip 122: Beware of Java typesafe enumerations:\\
  \ahrefurl{http://www.javaworld.com/article/2077487/core-java/java-tip-122--beware-of-java-typesafe-enumerations.html}
