...
There is a plugin for Eclipse to support type annotations and also a separate
one for supporting the use of checkers in development.

The Checker Plugin, an Eclipse plugin that enables the use of the Checker Framework,
is available at
...
The plugin has been substantially improved through a Google Summer of Code project
and supports running all checkers bundled in the Framework.
