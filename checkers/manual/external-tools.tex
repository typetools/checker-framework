...
\item
  ...
  checker can takes advantage of it at no extra effort.  However, it only
...
\item
  ...
  \item
    ...
    provide, which can aid programmer understanding.
  \item
...
signature (arguments and return values) must be explicitly annotated,
