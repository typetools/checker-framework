...
%END LATEX
\begin{Verbatim}
  <!-- Boilerplate! Is there a better way? -->
  <property environment="env"/>
  <property name="jsr308.jar" value="${env.CHECKERS}/binary/jsr308-all.jar"/>
  ...
  <presetdef name="jsr308.javac">
    <javac fork="yes">
      ...
      <compilerarg line="-J-Xbootclasspath/p:${env.CHECKERS}/binary/jsr308-all.jar"/>
...
\begin{Verbatim}
  <target name="check-nullness"
          ...
          depends="clean,...">
    <!-- replace javac with jsr308.javac -->
    <jsr308.javac ... >
