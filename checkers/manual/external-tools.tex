...
by default.  That is, if you are using the Checker Framework Maven plugin version 1.6.6 then it will run the
Checker Framework version 1.6.6 when checking source code.  However, you can specify an earlier
