...
\begin{Verbatim}
  ...
  <presetdef name="jsr308.javac">
    <javac fork="yes" executable="${checkers}/binary/javac" >
...
(Note: For any platform that needs to use "java -jar $CHECKERS/binary/checkers.jar" instead of
javac then a simple script that executes "java -jar $CHECKERS/binarycheckers.jar <parameters>
should replace the "{checkers}/binary/javac" part of \code{executable="\${checkers}/binary/javac"} above.)
...
If you fork the compilation task, \ahref{http://gradle.org/}{Gradle}
