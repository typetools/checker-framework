...
by default.  That is, if you are using the Checker Framework Maven plugin version 1.7.0 then it will run the
Checker Framework version 1.7.0 when checking source code.  However, you can specify an earlier
