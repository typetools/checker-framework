\section{Integration with external tools\label{external-tools}}

This section discusses how to run a checker from your favorite IDE\@.

Or, if \emph{your} favorite isn't here, then customize how it runs the
...
\subsection{Ant task\label{ant-task}}
...
\subsection{Maven plugin\label{maven-plugin}}
...
Sections~\ref{nullness-inference} lists several tools that infer
