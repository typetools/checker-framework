...
\item[\code{@\refclass{checkers/javari/quals}{ReadOnly}}]
...
\item[\code{@\refclass{checkers/javari/quals}{Mutable}}]
  indicates a mutable type.
  
\item[\code{@\refclass{checkers/javari/quals}{Assignable}}]
...
\item[\code{@\refclass{checkers/javari/quals}{QReadOnly}}]
...
\item[\code{@\refclass{checkers/javari/quals}{PolyRead}}]
  ...
  \code{@\refclass{checkers/javari/quals}{PolyRead}} Javadoc for more details.

\item[\code{@\refclass{checkers/javari/quals}{ThisMutable}}]
...
Javadoc for \refclass{checkers/javari}{JavariAnnotatedTypeFactory}.
...
marked with \code{@\refclass{checkers/javari/quals}{Assignable}} are reassigned, or
...
% \refclass{checkers/javari}{JavariVisitor}.
