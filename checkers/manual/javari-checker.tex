\htmlhr
\section{Javari (immutability) checker\label{javari-checker}}
...
Also consider the IGJ checker (Section~\ref{igj-checker}).  The IGJ type
...
\subsection{Javari annotations\label{javary-annotations}}
...
\subsection{Writing Javari annotations\label{writing-javari-annotations}}


\subsubsection{Implicit qualifiers\label{javari-implicit-qualifiers}}
...
\subsubsection{Inference of Javari annotations\label{javari-inference}}
...
\subsection{What the Javari checker checks\label{javari-checks}}
...
\subsection{Examples\label{javari-examples}}
