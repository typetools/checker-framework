...
\subsection{Basic checker example\label{basic-example}}
...
\item
  ...
  You should add the \code{Encrypted} classfile in the processor classpath:
...
% LocalWords:  CharSequence classpath nullness quals SuppressWarnings
% LocalWords:  uncapitalized
