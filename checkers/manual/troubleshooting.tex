...
\section{Installing the source release\label{install-source}}
...
\subsection{The short instructions (for Linux only)}
...
\subsection{The longer instructions}
...
\subsection{Building from source\label{building}}
