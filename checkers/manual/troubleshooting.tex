...
\noindent
means that the compiler is executing on a JDK that lacks the field
\<NATIVE\_HEADER\_OUTPUT>, which was added in JDK 8.
Most likely you are using the wrong bootclasspath.
