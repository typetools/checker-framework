...
\begin{smaller}
%END LATEX
\code{jsr308-bugs@lists.csail.mit.edu}%
%BEGIN LATEX
\end{smaller}%
%END LATEX
.  In addition
...
\begin{itemize}
\item
  Add \code{-verbose} to the javac options.  This causes the compiler to output
...
\item
  ...
  are using.  You can determine the compiler version by running \code{javac
    -version}.
\end{itemize}
...
%% This text is identically reproduced at ../../langtools/README-jsr308.html
...
% alternative: \urldef{\JsrInstallingUrl}\url{http://groups.csail.mit.edu/pag/jsr308/current/README-jsr308.html#installing}
{\codesize\url{http://groups.csail.mit.edu/pag/jsr308/current/README-jsr308.html#installing}}.
This creates a \code{langtools} directory.

\item Download the Checker Framework distribution zipfile from
\myurl{http://groups.csail.mit.edu/pag/jsr308/current/jsr308-checkers.zip},
and unzip it to create a \code{checkers} directory.  We recommend that the
\code{checkers} directory and the \code{langtools} directory be siblings.
Example commands:
...
\item Optionally edit property \code{compiler.lib} in file
  ...
  \code{checkers} directory and the \code{langtools} directory are
  siblings.

\item Add to your classpath:
  \code{\$JSR308/langtools/lib/tools.jar} and
...
\begin{Verbatim}
  ...
  export CLASSPATH=${CLASSPATH}:$JSR308/langtools/lib/tools.jar:$JSR308/checkers/checkers.jar
\end{Verbatim}
%BEGIN LATEX
\end{smaller}
%END LATEX
...
source, and you made the \code{checkers} and \code{langtools} directories
...
\myurl{http://groups.csail.mit.edu/pag/jsr308/current/changelog-checkers.txt}.
