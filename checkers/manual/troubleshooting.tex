...
\ahref{http://code.google.com/p/checker-framework/issues}.
...
% alternative: \urldef{\JsrInstallingUrl}\url{http://types.cs.washington.edu/checker-framework/README-jsr308.html#installing}
...
\myurl{http://types.cs.washington.edu/checker-framework/current/jsr308-checkers.zip},
