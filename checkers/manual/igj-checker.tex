\htmlhr
\section{IGJ checker\label{igj-checker}}
...
\begin{figure}
\begin{center}
\resizebox{!}{3.5cm}{\includegraphics{figures/igj}}
\end{center}
%BEGIN LATEX
...
\item  Immutability is specified through
  \ahref{http://groups.csail.mit.edu/pag/jsr308/}{type annotations}~\cite{jsr308} (Section~\ref{igj-annotations}),
