...
ESEC/FSE 2007 paper ``\ahref{\url{http://homes.cs.washington.edu/~mernst/pubs/immutability-generics-fse2007-abstract.html}}{Object and reference immutability using Java
...
\item[\code{@\refclass{checkers/igj/quals}{Immutable}}]
...
\item[\code{@\refclass{checkers/igj/quals}{I}}]
...
explicitly marked with \code{@\refclass{checkers/igj/quals}{Assignable}} are
...
% the checker, see the Javadoc for \refclass{checkers/igj}{IGJVisitor}.
...
Javadoc for \refclass{checkers/igj}{IGJAnnotatedTypeFactory}.
...
\item  Immutability is specified through
  \ahref{\url{http://types.cs.washington.edu/jsr308/}}{type annotations}~\cite{JSR308-2008-09-12} (Section~\ref{igj-annotations}),
...
\item Templating over Immutability: The annotation \code{@\refclass{checkers/igj/quals}{I}(\emph{id})} is used to template
...
\code{@\refclass{checkers/igj/quals}{I}} is a template annotation over IGJ Immutability annotations. It acts
similarly to type variables in Java's generic types, and the name
\code{@\refclass{checkers/igj/quals}{I}} mimics the standard \code{<I>} type variable name used in code
written in the original IGJ dialect.  The annotation value string is used
to distinguish between multiple instances of \code{@\refclass{checkers/igj/quals}{I}} --- in the
...
A class declaration annotated with \code{@\refclass{checkers/igj/quals}{I}} can then be
used with any IGJ Immutability annotation.  The actual immutability that
\code{@\refclass{checkers/igj/quals}{I}} is resolved to dictates the immutability type for all the non-static
appearances of \code{@\refclass{checkers/igj/quals}{I}} with the same value as the class declaration.
...
In the last example, \code{@\refclass{checkers/igj/quals}{I}} was resolved to \code{@\refclass{checkers/igj/quals}{Mutable}} for the instance file.
...
in immutability, otherwise \code{@\refclass{checkers/igj/quals}{I}} is resolved to \code{@\refclass{checkers/igj/quals}{ReadOnly}}:

\begin{Verbatim}
  static @I Point getMidpoint(@I Point p1, @I Point p2) { ... }
\end{Verbatim}

The \code{@\refclass{checkers/igj/quals}{I}} annotation value distinguishes between \code{@\refclass{checkers/igj/quals}{I}}
