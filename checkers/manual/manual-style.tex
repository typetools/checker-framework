...
\newcommand{\refclass}[2]{\ahref{api/#1/#2.html}{\<#2>}}
...
\newcommand{\sunjavadoc}[2]{\ahref{http://types.cs.washington.edu/checker-framework/jdk-api/jdk/#1}{\<#2>}}
