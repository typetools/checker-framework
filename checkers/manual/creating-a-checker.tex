...
Class
\refclass{checkers/types}{SubtypingAnnotatedTypeFactory}
...
\code{Utils} suffix instead (e.g., \refclass{checkers/util}{TypesUtils},
\refclass{checkers/util}{TreeUtils}, \refclass{checkers/util}{ElementUtils}), with one
