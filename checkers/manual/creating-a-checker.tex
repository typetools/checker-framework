...
\subsection{How Checker Processors Fit in Compiler}
...
Checkers use \code{TypeMirror}s extensively.  However, the Framework
provides a wrapper API \code{AnnotatedTypeMirror} that wraps the Java
type and represent type annotations as well.
