...
% Checkers use \code{TypeMirror}s extensively.
The Checker Framework
provides a wrapper API \code{AnnotatedTypeMirror} that wraps the Java
type and represents type annotations as well.
