...
\subsection{Relationship of the Checker Framework to other tools\label{tool-relationships}}
...
\noindent
(Strictly speaking, the specific checkers, such as the Nullness Checker, is
...
\subsubsection{Declaratively specifying implicit annotations\label{declarative-type-introduction}}
...
API},
and issues a warning whenever the type system is violated.
...
visitor for the Nullness type system of Section~\ref{nullness-checker}
