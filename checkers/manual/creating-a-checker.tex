...
\ahref{http://docs.oracle.com/javase/7/docs/jdk/api/javac/tree/index.html}{Tree
API},
...
\item \code{-Aignorestubs}: ignore stub files, i.e. the jdk.astub file in the checker
directory and files passed through the \code{-Astubs} option. This is useful when
compiling the source code that is described by the stub file.
