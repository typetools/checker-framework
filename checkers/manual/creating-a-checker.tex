...
type hierarchies can be expressed by overriding, in \refclass{checkers/basetype}{BaseTypeChecker},
...
\ahref{\url{http://types.cs.washington.edu/checker-framework/api/javac/tree//index.html}}{Tree
API},
...
\code{Utils} suffix instead (e.g., \refclass{javacutils/util}{TypesUtils},
\refclass{javacutils/util}{TreeUtils}, \refclass{javacutils/util}{ElementUtils}), with one
...
\refclass{checkers/source}{AbstractTypeProcessor}; these get run on each class
source file after the compiler confirms that the class is valid Java code.

The most important methods of \refclass{checkers/source}{AbstractTypeProcessor}
