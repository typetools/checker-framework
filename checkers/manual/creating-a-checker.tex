...
checker.  Specific checkers that are easy to extend (besides the Basic
...
\multicolumn{2}{c}{} 
\\ \hline
\multicolumn{5}{|p{6\bw}|}{\centering Basic Checker \par (enforces subtyping rules)} &
...
possible meaning:  both \<@\refclass{nullness/quals}{Nullable}> and
...
testing the distributed checkers.  For now, see the README files in the
