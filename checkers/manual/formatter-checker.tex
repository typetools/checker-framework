...
The \code{@\refclass{checkers/formatter/quals}{Format}} qualifier on a string type
...
The \code{@\refclass{checkers/formatter/quals}{Format}} qualifier is parameterized with
...
\code{@\refclass{checkers/formatter/quals}{InvalidFormat}} indicates an invalid format
string --- that is, a string that cannot be used as a format string.  For
example, the type of \code{"\%y"} is \<@InvalidFormat String>.
\code{@\refclass{checkers/formatter/quals}{FormatBottom}} is the type of the
\code{null} literal.
\code{@\refclass{checkers/quals}{Unqualified}} is the default that is
...
\code{\refclass{checkers/formatter/quals}{ConversionCategory}} enumeration:
...
\begin{enumerate} 
    \item The format method's first parameter (or second if a \sunjavadoc{java/util}{Locale} is provided) is a valid
...
%     second if a \sunjavadoc{java/util}{Locale} is provided) is not a
...
\refmethod{checkers/formatter}{FormatUtil}{asFormat}{-java.lang.String-checkers.formatter.quals.ConversionCategory...-}
