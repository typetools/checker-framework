...
\code{null} literal.
\code{@\refclass{checkers/formatter/quals}{Unqualified}} is the default that is
...
\refmethod{checkers/formatter}{FormatterUtil}{asFormat}{(String, ConversionCategory...)} 
...
%  LocalWords:  5cm varargs TODO Formattable formatTo FormatterUtil java
