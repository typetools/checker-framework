...
\begin{description}
\item[\code{@\refclass{checkers/units/quals}{Area}}]

\item[\code{@\refclass{checkers/units/quals}{Current}}]

\item[\code{@\refclass{checkers/units/quals}{Length}}]

\item[\code{@\refclass{checkers/units/quals}{Luminance}}]

\item[\code{@\refclass{checkers/units/quals}{Mass}}]

\item[\code{@\refclass{checkers/units/quals}{Speed}}]

\item[\code{@\refclass{checkers/units/quals}{Substance}}]

\item[\code{@\refclass{checkers/units/quals}{Temperature}}]

\item[\code{@\refclass{checkers/units/quals}{Time}}]
\end{description}
...
\item For \code{@Area}:
  the derived units
  square millimeters \code{@\refclass{checkers/units/quals}{mm2}},
  square meters \code{@\refclass{checkers/units/quals}{m2}}, and
  square kilometers \code{@\refclass{checkers/units/quals}{km2}}

\item For \code{@Current}:
  Ampere \code{@\refclass{checkers/units/quals}{A}}

\item For \code{@Length}:
  Meters \code{@\refclass{checkers/units/quals}{m}}
  and the derived units
  millimeters \code{@\refclass{checkers/units/quals}{mm}} and
  kilometers \code{@\refclass{checkers/units/quals}{km}}

\item For \code{@Luminance}:
  Candela \code{@\refclass{checkers/units/quals}{cd}}

\item For \code{@Mass}:
  kilograms \code{@\refclass{checkers/units/quals}{kg}}
  and the derived unit
  grams \code{@\refclass{checkers/units/quals}{g}}

\item For \code{@Speed}:
  meters per second \code{@\refclass{checkers/units/quals}{mPERs}} and
  kilometers per hour \code{@\refclass{checkers/units/quals}{kmPERh}}

\item For \code{@Substance}:
  Mole \code{@\refclass{checkers/units/quals}{mol}}

\item For \code{@Temperature}:
  Kelvin \code{@\refclass{checkers/units/quals}{K}}
  and the derived unit
  Celsius \code{@\refclass{checkers/units/quals}{C}}

\item For \code{@Time}:
  seconds \code{@\refclass{checkers/units/quals}{s}}
  and the derived units
  minutes \code{@\refclass{checkers/units/quals}{min}} and
  hours \code{@\refclass{checkers/units/quals}{h}}
\end{enumerate}


You may specify SI unit prefixes, using enumeration \code{\refclass{checkers/units/quals}{Prefix}}.
The basic SI units
