...
\newcommand{\ReleaseInfo}{1.2.4 (15 Dec 2011)}
...
% it necessary at all?
% \newcommand{\sunjavadoc}[2]{\ahref{http://download.oracle.com/javase/6/docs/api/#1?is-external=true}{\<#2>}}
\newcommand{\sunjavadoc}[2]{\ahref{http://download.oracle.com/javase/6/docs/api/#1}{\<#2>}}
