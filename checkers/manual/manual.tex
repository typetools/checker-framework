...
% it necessary at all?
% \newcommand{\sunjavadoc}[2]{\ahref{http://docs.oracle.com/javase/6/docs/api/#1?is-external=true}{\<#2>}}
\newcommand{\sunjavadoc}[2]{\ahref{http://docs.oracle.com/javase/6/docs/api/#1}{\<#2>}}
