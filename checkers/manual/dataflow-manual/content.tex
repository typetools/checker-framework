...
\begin{definition}[Extended Node]
    ...
    \begin{itemize}
        ...
        \begin{workinprogress}
          Are there restrictions on simple extended nodes?  Can they throw
          an exception?  How are they related to regular simple nodes?  Is
          it a wrapper only for regular simple nodes?
        \end{workinprogress}
