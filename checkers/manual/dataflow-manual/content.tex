...
and the \code{MethodTree} (not expected to be used often).

\begin{workinprogress}
When would the \code{MethodTree} be used?
\end{workinprogress}
...
\begin{workinprogress}
What is ``a null abstract value''?  Is it \code{null} or something else?
...
\begin{bnfgrammar}
    ...
    \altline{\nonterminal{FieldAccess}}
    \altline{\nonterminal{PureMethodCall} \qquad Java method call of a \textit{pure} method}
