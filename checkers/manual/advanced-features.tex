...
\code{null} could be extracted from an instance of \<MyList1>, whereas any
...
are initialized at the declaration site; so the type of \code{protocol} is
\code{@NonNull String} in the following declaration:
...
Here the call to \code{persistData()} invalidates the inferred nonnull type
of \code{updatedAt}.
...
% LocalWords:  QualifierDefaults nullable
