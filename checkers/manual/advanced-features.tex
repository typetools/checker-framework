...
which case it is signalled by use of a postcondition annotation such as
...
%  LocalWords:  regex myStrings myVar pouchSize myMammal getter
%  LocalWords:  getPouchSize
