...
\noindent
except that this is illegal syntax:  the \code{ArrayList<@PolyNull E>} in
the receiver position is not legal.
(This is a motivation for \ahref{http://types.cs.washington.edu/jsr308/specification/java-annotation-design.html#receiver-type-parameter-annotations} the Type Annotations syntax.)

The annotated libraries contain a less-precise annotation for
\code{toArray}, but the Checker Framework special-cases \code{toArray} so
