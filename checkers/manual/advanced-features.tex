...
If a type parameter declaration is annotated with \code{@A}, and bounds are
...
from other default qualifiers.  This is useful [TODO:  when?  get answer
from mailing list].

You can do so with an annotation such as
