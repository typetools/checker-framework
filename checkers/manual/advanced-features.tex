...
it.  The Checker Framework does not support this feature, for several
reasons.
...
\item
  ...
  from supertypes, then a user would have to examine all of them to
  understand the meaning of an unannotated type in a given file.

\item
  Conflicting annotations might be inherited from a supertype and an
  interface, or from two interfaces.  It is not clear what the semantics of
  this should be, and whatever is chosen is likely to be surprising.
