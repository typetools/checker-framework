...
public interface NavigableMap<K, V> extends SortedMap<K, V> {
  public abstract Map. @PolyRead Entry<K, V> lowerEntry(@PolyRead NavigableMap<K, V> this, K a1);
  public abstract K lowerKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @PolyRead Entry<K, V> floorEntry(@PolyRead NavigableMap<K, V> this, K a1);
  public abstract K floorKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @PolyRead Entry<K, V> ceilingEntry(@PolyRead NavigableMap<K, V> this, K a1);
  public abstract K ceilingKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @PolyRead Entry<K, V> higherEntry(@PolyRead NavigableMap<K, V> this, K a1);
  public abstract K higherKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @PolyRead Entry<K, V> firstEntry(@PolyRead NavigableMap<K, V> this);
  public abstract Map. @PolyRead Entry<K, V> lastEntry(@PolyRead NavigableMap<K, V> this);
