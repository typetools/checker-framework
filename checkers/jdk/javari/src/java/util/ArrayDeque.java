...
public class ArrayDeque<E> extends AbstractCollection<E> implements Deque<E>, Cloneable, java.io.Serializable {
  ...
  public ArrayDeque(@PolyRead ArrayDeque this, @PolyRead Collection<? extends E> a1) { throw new RuntimeException(("skeleton method")); }
  ...
  public E peekFirst(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public E peekLast(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  ...
  public E element(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public E peek(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public void push(E a1) { throw new RuntimeException(("skeleton method")); }
  public E pop() { throw new RuntimeException(("skeleton method")); }
  public int size(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public boolean isEmpty(@ReadOnly ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public @PolyRead Iterator<E> iterator(@PolyRead ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public @PolyRead Iterator<E> descendingIterator(@PolyRead ArrayDeque this) { throw new RuntimeException(("skeleton method")); }
  public boolean contains(@ReadOnly ArrayDeque this, @ReadOnly Object a1) { throw new RuntimeException(("skeleton method")); }
  public boolean remove(@ReadOnly ArrayDeque this, @ReadOnly Object a1) { throw new RuntimeException(("skeleton method")); }
