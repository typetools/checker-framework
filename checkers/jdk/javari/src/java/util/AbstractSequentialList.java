...
public abstract class AbstractSequentialList<E> extends AbstractList<E> {
  ...
  public @PolyRead Iterator<E> iterator(@PolyRead AbstractSequentialList this) { throw new RuntimeException(("skeleton method")); }
  public abstract @PolyRead ListIterator<E> listIterator(@PolyRead AbstractSequentialList this, int a1);
}
