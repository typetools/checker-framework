...
public abstract class AbstractCollection<E> implements Collection<E> {
    ...
    public abstract @PolyRead Iterator<E> iterator(@PolyRead AbstractCollection this);
    ...
    public boolean contains(@ReadOnly AbstractCollection this, @ReadOnly Object o) { throw new RuntimeException("skeleton method"); }
    public Object[] toArray(@ReadOnly AbstractCollection this) { throw new RuntimeException("skeleton method"); }
    public <T> T[] toArray(@ReadOnly AbstractCollection this, T[] a) { throw new RuntimeException("skeleton method"); }
    ...
    public boolean containsAll(@ReadOnly AbstractCollection this, @ReadOnly Collection<?> c) { throw new RuntimeException("skeleton method"); }
