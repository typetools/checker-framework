    ...
    implements Map<K,V>
{
    ...
    public boolean containsValue(@ReadOnly LinkedHashMap this, @ReadOnly Object value) { throw new RuntimeException("skeleton method"); }
    public V get(@ReadOnly LinkedHashMap this, @ReadOnly Object key) { throw new RuntimeException("skeleton method"); }
