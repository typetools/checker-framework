...
public class BitSet{
  ...
  public java.util.BitSet get(int a1, int a2) @ReadOnly { throw new RuntimeException(("skeleton method")); }
  ...
  public boolean intersects(java.util.BitSet a1) @ReadOnly { throw new RuntimeException(("skeleton method")); }
  public int cardinality() @ReadOnly { throw new RuntimeException(("skeleton method")); }
  public void and(@ReadOnly java.util.BitSet a1) { throw new RuntimeException(("skeleton method")); }
  public void or(@ReadOnly java.util.BitSet a1) { throw new RuntimeException(("skeleton method")); }
  public void xor(@ReadOnly java.util.BitSet a1) { throw new RuntimeException(("skeleton method")); }
  public void andNot(@ReadOnly java.util.BitSet a1) { throw new RuntimeException(("skeleton method")); }
