...
public class SimpleTimeZone extends java.util.TimeZone{
  ...
  public SimpleTimeZone(int a1, java.lang.String a2) { throw new RuntimeException("skeleton method"); }
  public SimpleTimeZone(int a1, java.lang.String a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10) { throw new RuntimeException("skeleton method"); }
  public SimpleTimeZone(int a1, java.lang.String a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11) { throw new RuntimeException("skeleton method"); }
  public SimpleTimeZone(int a1, java.lang.String a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12, int a13) { throw new RuntimeException("skeleton method"); }
  ...
  public boolean inDaylightTime(java.util.Date a1) { throw new RuntimeException("skeleton method"); }
