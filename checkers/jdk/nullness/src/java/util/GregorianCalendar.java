...
public class GregorianCalendar extends java.util.Calendar {
  ...
  public GregorianCalendar(java.util.TimeZone a1) { throw new RuntimeException("skeleton method"); }
  public GregorianCalendar(java.util.Locale a1) { throw new RuntimeException("skeleton method"); }
  public GregorianCalendar(java.util.TimeZone a1, java.util.Locale a2) { throw new RuntimeException("skeleton method"); }
  ...
  public void setGregorianChange(java.util.Date a1) { throw new RuntimeException("skeleton method"); }
  public final java.util.Date getGregorianChange() { throw new RuntimeException("skeleton method"); }
