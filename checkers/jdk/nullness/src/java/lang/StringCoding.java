...
class StringCoding {
    ...
    private static <T> @Nullable T deref(ThreadLocal<SoftReference<T>> tl) {
    ...
    private static @Nullable Charset lookupCharset(String csn) {
    ...
    static char[] decode(@Nullable String charsetName, byte[] ba, int off, int len)
