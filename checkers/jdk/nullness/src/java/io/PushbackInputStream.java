...
public class PushbackInputStream extends FilterInputStream {
  public PushbackInputStream(InputStream a1, int a2) { throw new RuntimeException("skeleton method"); }
  public PushbackInputStream(InputStream a1) { throw new RuntimeException("skeleton method"); }
