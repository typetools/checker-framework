 ...
 */
@GwtCompatible
    @SuppressWarnings({"serial","nullness:generic.argument"}) // we're overriding default serialization
    public final class TreeMultiset<E extends /*@Nullable*/ Object> extends AbstractMapBasedMultiset<E> {
  ...
  @SuppressWarnings("nullness")
      //Supressed, as SortedMapBasedElementSet doesn't have a generic type
