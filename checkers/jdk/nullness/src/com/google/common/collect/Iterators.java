...
public final class Iterators {
   ...
   */
  //**in line 366, removeFrom guarenteed not null
   ...
   */
    ...
    // Suppressed for Rawness
      public static <T extends /*@Nullable*/ Object> Iterator<T> concat(Iterator<? extends T> a,
   ...
   */
  @SuppressWarnings("nullness")
  // Suppressed due to the type of predicate
   ...
   */
  static <T extends /*@Nullable*/ Object> UnmodifiableIterator<T> forArray(
