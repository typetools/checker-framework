...
final class Serialization {
  ...
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> void writeMap(Map<K, V> map, ObjectOutputStream stream)
      throws IOException {
   ...
   */
  @SuppressWarnings("nullness")
  // Warnings Suppressed to override populateMultimap
  @GwtIncompatible("java.io.ObjectInputStream")
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> void populateMap(Map<K, V> map, ObjectInputStream stream)
   ...
   */
    @SuppressWarnings("nullness")
  @GwtIncompatible("java.io.ObjectOutputStream")
  public static <E extends /*@Nullable*/ Object> void writeMultiset(
   ...
   */
  @SuppressWarnings("nullness")
  // Warnings Suppressed to overright populateMultimap
  @GwtIncompatible("java.io.ObjectInputStream")
  public static <E extends /*@Nullable*/ Object> void populateMultiset(
   ...
   */
    @SuppressWarnings("nullness")
  @GwtIncompatible("java.io.ObjectOutputStream")
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> void writeMultimap(
  ...
  // Warnings Suppressed to overright populateMultimap
  @GwtIncompatible("java.io.ObjectInputStream")
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> void populateMultimap(
  ...
  static <T extends /*@Nullable*/ Object> FieldSetter<T> getFieldSetter(
  ...
  // Secret sauce for setting final fields; don't make it public.
  @GwtCompatible(emulated = true) // Accessible but not supported in GWT.
  static final class FieldSetter<T extends /*@Nullable*/ Object> {
    ...
    @SuppressWarnings("nullness")
	//Suppressed due to annotations on Field
    @GwtIncompatible("java.lang.reflect.Field")
