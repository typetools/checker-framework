...
final class CustomConcurrentHashMap {
  ...
  public interface Strategy<K, V, E> {
     ...
     */
    boolean equalKeys(K a, /*@Nullable*/ Object b);
     ...
     * @see Object#equals the same contractual obligations apply here
     */
    boolean equalValues(V a, /*@Nullable*/ Object b);
     ...
     */
    /*@Nullable*/ E getNext(/*@Nullable*/ E entry);
...
//    Set<E> entrySet();
  ...
  static class Impl<K, V, E> extends AbstractMap<K, V>
	...
	volatile AtomicReferenceArray<E> table;
      ...
      public /*@Nullable*/ E getEntry(/*@Nullable*/ Object key, int hash) {
	    ...
	    for (/*@Nullable*/ E e = getFirst(hash); e != null; e = s.getNext(e)) {
            ...
            /*@Nullable*/ K entryKey = s.getKey(e);
            if (entryKey == null) {
              continue;
            }
	...
	/*@Nullable*/ V put(K key, int hash, V value, boolean onlyIfAbsent) {
        ...
        try {
          ...
          for (/*@Nullable*/ E e = first; e != null; e = s.getNext(e)) {
            /*@Nullable*/ K entryKey = s.getKey(e);
            if (s.getHash(e) == hash && entryKey != null
                && s.equalKeys(key, entryKey)) {
      ...
      void expand() {
        ...
        for (int oldIndex = 0; oldIndex < oldCapacity; oldIndex++) {
          ...
          if (head != null) {
            /*@Nullable*/ E next = s.getNext(head);
            ...
            if (next == null) {
              ...
              for (/*@Nullable*/ E last = next; last != null; last = s.getNext(last)) {
              ...
              for (/*@Nullable*/ E e = head; e != tail; e = s.getNext(e)) {
                /*@Nullable*/ K key = s.getKey(e);
                if (key != null) {
	...
	/*@Nullable*/ V remove(/*@Nullable*/ Object key, int hash) {
        ...
        try {
          ...
          for (/*@Nullable*/ E e = first; e != null; e = s.getNext(e)) {
            ...
            if (s.getHash(e) == hash && entryKey != null
              ...
              /*@Nullable*/ V entryValue = strategy.getValue(e);
              // All entries following removed node can stay
              // in list, but all preceding ones need to be
              // cloned.
              ++modCount;
              /*@Nullable*/ E newFirst = s.getNext(e);
      ...
      @SuppressWarnings("nullness")
      // Suppressed, as there will not be a null dereference on line 1196.
      // Also, to override annotations on AtomicReferenceArray
	...
	/*@Nullable*/ WriteThroughEntry lastReturned;
      ...
      boolean advanceTo(E entry) {
        Strategy<K, V, E> s = Impl.this.strategy;
        /*@Nullable*/ K key = s.getKey(entry);
        /*@Nullable*/ V value = s.getValue(entry);
      ...
      @SuppressWarnings("nullness")
      // Suppressed as lastReturned cannot be null
  ...
  static class ComputingImpl<K, V, E> extends Impl<K, V, E> {
    ...
    @SuppressWarnings("nullness")
    // Suppressed due to getEntry
    @Override public V get(/*@Nullable*/ Object k) {
      /*
