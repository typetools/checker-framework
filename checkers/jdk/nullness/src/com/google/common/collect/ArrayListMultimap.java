...
@GwtCompatible(serializable = true)
    ...
    public final class ArrayListMultimap<K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> extends StandardListMultimap<K,V> {
  ...
  // Suppressed to override the default on writeMultimap.
  ...
  @SuppressWarnings("nullness")
  // Suppressed to override the default on populateMultimap.
