...
public final class MapMaker {
  ...
  private enum Strength {
    WEAK {
      @Override boolean equal(Object a, /*@Nullable*/ Object b) {
        return a == b;
      }
     ...
     * strength strategy.
     */
    abstract boolean equal(Object a, /*@Nullable*/ Object b);
  ...
  private static class StrategyImpl<K, V> implements Serializable,
     ...
     */
    public /*@Nullable*/ V getValue(ReferenceEntry<K, V> entry) {
      ValueReference<K, V> valueReference = entry.getValueReference();
      return valueReference.get();
    }

    @SuppressWarnings("nullness")
    // Suppressed to override annotations on ComputationExceptionReference
    ...
    private class FutureValueReference implements ValueReference<K, V> {
      ...
      public /*@Nullable*/ V get() {
        ...
        try {
	    /*@Nullable*/ V value = original.getValueReference().get();
          success = true;
          return value;
        } finally {
          if (!success) {
    ...
    public /*@Nullable*/ ReferenceEntry<K, V> getNext(
	   /*@Nullable*/ ReferenceEntry<K, V> entry) {
	return (entry != null) ? entry.getNext() : null;
    }
