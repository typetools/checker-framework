...
public final class Suppliers {
  ...
  @VisibleForTesting static class MemoizingSupplier<T extends /*@Nullable*/ Object>
      implements Supplier<T>, Serializable {
   ...
   */
    public static <T extends /*@Nullable*/ Object> Supplier<T> ofInstance(@Nullable T instance) {
