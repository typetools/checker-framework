...
public class Arrays{
  ...
  public static void sort(Object[] a1) { throw new RuntimeException("skeleton method"); }
  public static void sort(Object[] a1, int a2, int a3) { throw new RuntimeException("skeleton method"); }
  public static <T> void sort(T[] a1, @Nullable Comparator<? super T> a2) { throw new RuntimeException("skeleton method"); }
  public static <T> void sort(T[] a1, int a2, int a3, @Nullable Comparator<? super T> a4) { throw new RuntimeException("skeleton method"); }
  ...
  public static boolean equals(char @Nullable [] a1, char @Nullable [] a2) { throw new RuntimeException("skeleton method"); }
  public static boolean equals(byte @Nullable [] a1, byte @Nullable [] a2) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> @Nullable T [] copyOf(@Nullable T [] a1, int a2) { throw new RuntimeException("skeleton method"); }
  public static <T, U> @Nullable T [] copyOf(@Nullable U [] a1, int a2, Class<? extends T[]> a3) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> @Nullable T[] copyOfRange(@Nullable T[] a1, int a2, int a3) { throw new RuntimeException("skeleton method"); }
  ...
  public static int hashCode(short @Nullable [] a1) { throw new RuntimeException("skeleton method"); }
  public static int hashCode(char @Nullable [] a1) { throw new RuntimeException("skeleton method"); }
  public static int hashCode(byte @Nullable [] a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static String toString(char @Nullable [] a1) { throw new RuntimeException("skeleton method"); }
  public static String toString(byte @Nullable [] a1) { throw new RuntimeException("skeleton method"); }
