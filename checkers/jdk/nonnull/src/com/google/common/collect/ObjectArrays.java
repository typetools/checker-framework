...
public final class ObjectArrays {
  ...
  @SuppressWarnings("unchecked")
      public static <T extends /*@Nullable*/ Object> T[] newArray(Class<T> type, int length) {
   ...
   */
  @GwtIncompatible("Array.newInstance(Class, int)")
  public static <T extends /*@Nullable*/ Object> T[] concat(T[] first, T[] second, Class<T> type) {
  ...
  private static <T extends /*@Nullable*/ Object> T[] arraysCopyOf(T[] original, int newLength) {
   ...
   */
    ...
    //Annotation here is not techincally correct, see not on toArray
    static <T extends /*@Nullable*/ Object> T[] toArrayImpl(Collection<?> c, /*@Nullable*/ T[] array) {
    int size = c.size();
   ...
   */
    @SuppressWarnings("nullness")
    //Not technically correct, see annotation on toArray
    static /*@Nullable*/ Object[] toArrayImpl(Collection<? extends /*@Nullable*/ Object> c) {
