...
@GwtCompatible
  ...
  private class MultisetView extends AbstractMultiset<K> {
      ...
      @SuppressWarnings("nullness")
      //Suppressed due to annotations on Java.util.Map
      @Override public int remove(/*@Nullable*/ Object key, int occurrences) {
      if (occurrences == 0) {
        return count(key);
      }
    ...
    @SuppressWarnings("nullness")
    //Suppressed due to annotations on Java.util.Map
    @Override public int count(/*@Nullable*/ Object key) {
      try {
        Collection<V> collection = map.get(key);
  ...
  @SuppressWarnings("nullness")
  //Suppressed due to annotations on Java.util.Map
  private int removeValuesForKey(/*@Nullable*/ Object key) {
    Collection<V> collection;
    try {
