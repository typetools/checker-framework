...
public class PriorityQueue<E> extends @I AbstractQueue<E> implements java.io. @I Serializable {
  ...
  public PriorityQueue(@AssignsFields PriorityQueue<E> this, int a1, @ReadOnly Comparator<? super E> a2) { throw new RuntimeException("skeleton method"); }
  public PriorityQueue(@AssignsFields PriorityQueue<E> this, @ReadOnly Collection<? extends E> a1) { throw new RuntimeException("skeleton method"); }
  public PriorityQueue(@AssignsFields PriorityQueue<E> this, @ReadOnly PriorityQueue<? extends E> a1) { throw new RuntimeException("skeleton method"); }
  public PriorityQueue(@AssignsFields PriorityQueue<E> this, @ReadOnly SortedSet<? extends E> a1) { throw new RuntimeException("skeleton method"); }
