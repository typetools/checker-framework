...
@I
public class LinkedHashSet<E> extends @I java.util.HashSet<E> implements @I java.util.Set<E>, @I java.lang.Cloneable, @I java.io.Serializable {
  ...
  public LinkedHashSet(@ReadOnly java.util.Collection<? extends E> a1) @AssignsFields { throw new RuntimeException("skeleton method"); }
}
