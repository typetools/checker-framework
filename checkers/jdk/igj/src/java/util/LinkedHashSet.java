...
public class LinkedHashSet<E> extends @I HashSet<E> implements @I Set<E>, @I Cloneable, java.io. @I Serializable {
  ...
  public LinkedHashSet(@AssignsFields LinkedHashSet<E> this) { throw new RuntimeException("skeleton method"); }
  public LinkedHashSet(@AssignsFields LinkedHashSet<E> this, @ReadOnly Collection<? extends E> a1) { throw new RuntimeException("skeleton method"); }
}
