...
@I
public class WeakHashMap<K, V> extends @I java.util.AbstractMap<K, V> implements @I java.util.Map<K, V> {
  ...
  public WeakHashMap(java.util.Map<? extends K, ? extends V> a1) @AssignsFields { throw new RuntimeException("skeleton method"); }
  ...
  public boolean containsKey(java.lang.Object a1) @ReadOnly { throw new RuntimeException("skeleton method"); }
  ...
  public boolean containsValue(java.lang.Object a1) @ReadOnly { throw new RuntimeException("skeleton method"); }
