...
// Note that I added "-processor checkers.nullness.NullnessChecker"
...
public class Driver {
    ...
    protected File compileTestFile(File f, String testClass) {
        int rc = com.sun.tools.javac.Main.compile(new String[] { "-source", "1.8", "-g", "-processor", "checkers.nullness.NullnessChecker", f.getPath() });
        if (rc != 0) {
    ...
    private String wrap(String compact) {
        ...
        sb.append("import checkers.quals.DefaultQualifier;");
        sb.append("import checkers.nullness.quals.*;");
