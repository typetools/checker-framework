...
public class BaseTypeVisitor<Checker extends BaseTypeChecker> extends
    ...
    public Void visitMethodInvocation(MethodInvocationTree tree, Void p) {
        ...
        checkTypeArguments(tree, invokedMethod.getTypeVariables(), typeargs,
                tree.getTypeArguments());

        List<AnnotatedTypeMirror> params = annoTypes.expandVarArgs(
                invokedMethod, tree.getArguments());
        checkArguments(params, tree.getArguments());
        ...
        AnnotationMirror requiresAnnotation = atypeFactory
                .getDeclAnnotation(invokedMethodElement, RequiresAnnotation.class);
