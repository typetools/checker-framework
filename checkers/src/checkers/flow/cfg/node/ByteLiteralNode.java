 ...
 * </pre>
 * 
 * Java source and the AST representation do not have "byte" literals. They have
 * integer literals that may be narrowed to bytes depending on context. If we
 * use explicit NarrowingConversionNodes, do we need ByteLiteralNodes too? TODO:
