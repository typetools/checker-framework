...
/**
 * A node for the widening primitive conversion operation.  See JLS
 * 5.1.2 for the definition of widening primitive conversion.
 *
 * A {@link WideningConversionNode} does not correspond to any tree node
