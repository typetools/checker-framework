...
public class DefaultAnnotation {
    ...
    @DefaultQualifiers(@DefaultQualifier(value="checkers.nonnull.quals.NonNull", locations={DefaultLocation.ALL}))
    ...
    @DefaultQualifier(value="checkers.nonnull.quals.NonNull", locations={DefaultLocation.ALL})
    ...
    @DefaultQualifier(value="checkers.nonnull.quals.NonNull")
