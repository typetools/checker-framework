...
if [[ "${GROUP}" == "framework-tests" || "${GROUP}" == "all" ]]; then
  # These are tests that should pass without an annotated jdk. The are also run by all-tests.
  # Once we have an annotataed jdk for 11 to test this, this set of test can be removed.
