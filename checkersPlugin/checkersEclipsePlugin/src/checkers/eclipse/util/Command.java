...
public class Command {
    ...
    public static class StreamGobbler extends Thread {
        ...
        StreamGobbler(InputStream is, String type, PrintStream out,
                CountDownLatch doneSignal, boolean gobbleChars) {
        ...
        StreamGobbler(InputStream is, String type, OutputStream redirect,
                PrintStream out, CountDownLatch done, boolean gobbleChars) {
            this.is = is;
            this.type = type;
            this.os = redirect;
            this.out = out;
    ...
    public static int exec(String[] cmd, PrintStream out, Reader stdin) {
        ...
        try {
            ...
            StreamGobbler errorGobbler = new StreamGobbler(
                    proc.getErrorStream(), "", out, doneSignal, false);

            // any output?
            StreamGobbler outputGobbler = new StreamGobbler(
                    proc.getInputStream(), "", out, doneSignal, false);
    ...
    public static int exec(String[] cmd, PrintStream out, String prompt,
        ...
        try {
            ...
            // any error message?
            StreamGobbler errorGobbler = new StreamGobbler(
                    proc.getErrorStream(), prompt, out, doneSignal, gobbleChars);

            // any output?
            StreamGobbler outputGobbler = new StreamGobbler(
                    proc.getInputStream(), prompt, out, doneSignal, gobbleChars);
