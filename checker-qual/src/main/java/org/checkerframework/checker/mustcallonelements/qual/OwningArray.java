 ...
 * {@link @Owning} to arrays. The Must Call obligations of the annotated array mean that the listed
 * methods must be called on each element of the array. When assigning to a This is a declaration
