 ...
 * contain an even number of ' characters, escaped or otherwise.) SqlEvenQuotes Strings are
 * syntactical to be passed to query execution methods and are guaranteed to have no impact on
 * whether subsequent concatenations are interpreted as SQL command code or as SQL query values.
 *
