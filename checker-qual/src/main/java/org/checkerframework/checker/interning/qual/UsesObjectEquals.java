...
/**
 * Class declaration annotation to indicate that the class does not override {@code equals(Object)},
 * and therefore {@code a.equals(b)} and {@code a == b} behave identically.
 *
