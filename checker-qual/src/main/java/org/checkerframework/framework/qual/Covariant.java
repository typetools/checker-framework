 ...
 * {@code MyClass<B>} is a subtype of {@code MyClass<A>}.
 *
 * <p>Ordinarily, Java treats type parameters invariantly: {@code MyClass<B>} is unrelated to
 * (neither a subtype nor a supertype of) {@code MyClass<A>}.
 *
