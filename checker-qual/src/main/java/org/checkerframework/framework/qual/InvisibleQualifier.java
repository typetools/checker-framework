 ...
 * write. For example, a Compiler Message Key Checker warning message might contain
 ...
 * Compiler Message Key Checker prints "{@code Map<@CompilerMessageKey String, String>}".
 *
