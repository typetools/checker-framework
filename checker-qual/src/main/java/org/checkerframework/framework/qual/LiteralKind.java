 ...
 * that enum is in tools.jar, which is not on the user's classpath by default. This enum is used by
 * meta-annotations, such as {@link QualifierForLiterals}, instead.
 */
