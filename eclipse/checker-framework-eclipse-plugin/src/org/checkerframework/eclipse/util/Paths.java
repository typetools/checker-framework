...
public class Paths
{
    ...
    /**
     * I am having a heck of a time trying to get the drive letter to appear on the filepath
     * for jars added via Eclipse classpath entries.  For now, use the potentially error prone
     * technique of listing all drive letters and testing to see if the path exists on that drive,
     * prefer C:.  This is error prone because a path can exist on multiple drives.  In the case of
     * mirroring it could potentially use an archived version rather than the latest version of the jar.
     * This is not a huge risk but still a kludge.
