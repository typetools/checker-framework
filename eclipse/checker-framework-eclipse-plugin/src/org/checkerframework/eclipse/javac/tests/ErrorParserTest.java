...
public class ErrorParserTest
{
    ...
    private static final String SIMPLE_ERROR_1 = new StringBuilder()
            ...
            .append("       @NonNull Integer bar = null;").append(Util.NL)
            .append("  found   : null").append(Util.NL)
    ...
    private static final String SIMPLE_ERROR_2 = new StringBuilder()
            ...
            .append(Util.NL).append("       else if (s1 == obj)")
            .append(Util.NL).append("  found: Object").toString();
    private static final String OTHER_TEST_INPUT = new StringBuilder()
            ...
            .append(Util.NL).append("import sun.java2d.pipe.Region;")
            .append(Util.NL).append("                      ^").append(Util.NL)
    ...
    private static final String OTHER_ERROR_1 = new StringBuilder()
            ...
            .append(Util.NL).append("import sun.java2d.Disposer;").toString();
    ...
    private static final String W_TEST_INPUT = new StringBuilder()
            ...
            .append(Util.NL).append("import sun.java2d.cmm.CMSManager")
            .append(Util.NL).append("3 warnings").toString();
