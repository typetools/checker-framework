 ...
 *
 * <p>Every method in this class is optional: each is permitted to do nothing (or always return
 * false). The work that each method must do is particular to the builder framework being supported.
 */
public interface BuilderFrameworkSupport {

    /**
     * Hook for supporting a framework's {@code toBuilder} routine. Typically, the returned Builder
     * has had all of its required setters invoked. So, implementations of this method should add a
     ...
     * org.checkerframework.checker.calledmethods.qual.CalledMethods} annotation to the receiver of
     * the argument.
     *
