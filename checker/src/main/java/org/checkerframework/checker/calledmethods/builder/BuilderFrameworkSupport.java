...
public interface BuilderFrameworkSupport {
     ...
     * receiver parameter.
     *
     * @param t the type of a method that is the {@code build} method (as determined by {@link
     *     #isBuilderBuildMethod(ExecutableElement)}) for a builder
     */
    void handleBuilderBuildMethod(AnnotatedExecutableType t);
     ...
     *
     * @param e a method
     * @return {@code true} if {@code e} is a {@code toBuilder} method on a type generated by the
     *     builder framework
     */
    boolean isToBuilderMethod(ExecutableElement e);
}
