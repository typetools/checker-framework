...
public class RLCCalledMethodsAnnotatedTypeFactory extends CalledMethodsAnnotatedTypeFactory
  ...
  //  /**
  //   * Per-method loop state for collection-obligation loops that have been matched syntactically
  // by
  ...
  // */
  //    final Set<EnhancedForLoopTree> potentiallyFulfillingEnhancedForLoops = new
  // LinkedHashSet<>();
  //
  //    /**
  ...
  //
  //    /**
  //     * Returns CFG facts for resolving potentially fulfilling while loops in this method,
  // creating
  ...
  //  /**
  //   * Returns the resolved potentially fulfilling collection loops for the method represented by
  // the
  //   * given underlying AST.
  //   *
  //   * @param underlyingAST the current underlying AST
  //   * @return the resolved potentially fulfilling collection loops for the method represented by
  // the
  //   *     given underlying AST
  //   */
  //  Set<ResolvedPotentiallyFulfillingCollectionLoop>
  // getResolvedPotentiallyFulfillingCollectionLoops(
  //      UnderlyingAST underlyingAST) {
  //    MethodCollectionLoopState loopState = getMethodCollectionLoopState(underlyingAST);
  //    if (loopState == null) {
  //      return Collections.emptySet();
  ...
  //  /**
  //   * Returns the enclosing method for the given underlying AST, or {@code null} if the
  // underlying
  //   * AST is not a method.
  //   *
  //   * @param underlyingAST the current underlying AST
  ...
  protected void postCFGConstruction(ControlFlowGraph cfg, UnderlyingAST ast) {
    if (ast.getKind() == UnderlyingAST.Kind.METHOD) {
      ResourceLeakUtils.getCollectionOwnershipAnnotatedTypeFactory(this).prepareDisposalLoops(cfg);
    }
  }

  //  /**
  //   * Records a while-like collection loop that matched syntactically and still needs CFG
  // resolution.
  //   *
  ...
  //    /**
  //     * Returns methods that are guaranteed to be invoked on every element of the collection the
  // loop
  //     * iterates over.
  //     *
  ...
  //   * Returns blocks reachable from {@code entryBlock}.
  //   *
  //   * <p>This remains a utility on the outer type because the resource leak consistency analyzer
  // also
  //   * uses it.
  //   *
  //   * @param entryBlock the CFG entry block
  ...
  //  @SuppressWarnings({"UnusedNestedClass", "UnusedMethod"})
  ...
  //     * @return set of pairs (b, t), where b is a successor block, and t is the type of exception
  // for
  ...
  //    /**
  //     * Records a resolved collection loop if the given node is desugared from an
  // enhanced-for-loop
  //     * over a collection.
  //     *
  ...
  //
  //      // Find the desugared loop condition by traversing the CFG backwards until
  // iterator.hasNext()
  //      // is found.
  ...
  //
  //    /**
  //     * Resolves all potentially fulfilling while loops in the given method state that can be
  // tied to
  ...
  //
  //    /**
  //     * Resolves one potentially fulfilling while loop if a suitable loop update block can be
  // found.
  //     *
  ...
  //
  //    /**
  //     * Chooses the best loop update block for a potentially fulfilling while loop by matching it
  // to
