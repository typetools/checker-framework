...
public class CollectionToArrayHeuristics {
    ...
    /**
     * Returns true if the argument is a "length" field access expression applied to an array which
     * has declared type {@code @ArrayLen(0)}.
     *
     * @param argument the expression tree
     * @return true if the argument is a "length" field access expression applied to an array which
     *     has declared type {@code @ArrayLen(0)}
     */
