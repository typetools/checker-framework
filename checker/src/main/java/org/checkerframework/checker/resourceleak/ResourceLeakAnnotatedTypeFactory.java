...
public class ResourceLeakAnnotatedTypeFactory extends CalledMethodsAnnotatedTypeFactory
     ...
     * inferred, type of the tree. Use {@link #getMustCallValue(ImmutableSet, CFStore)} (and check
     * for emptiness) if you are trying to determine whether a local variable has must-call
     * obligations.
     *
     * @param tree a tree
