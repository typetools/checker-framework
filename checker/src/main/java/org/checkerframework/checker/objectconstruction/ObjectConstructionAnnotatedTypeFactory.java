...
public class ObjectConstructionAnnotatedTypeFactory extends AccumulationAnnotatedTypeFactory {
     ...
     */
    public ObjectConstructionAnnotatedTypeFactory(BaseTypeChecker checker) {
        super(
                checker,
                CalledMethods.class,
    ...
    private class ObjectConstructionTreeAnnotator extends AccumulationTreeAnnotator {
        /**
         * Creates an instance of this tree annotator for the given type factory.
         *
         * @param factory the type factory
         */
        public ObjectConstructionTreeAnnotator(AccumulationAnnotatedTypeFactory factory) {
            super(factory);
        }
