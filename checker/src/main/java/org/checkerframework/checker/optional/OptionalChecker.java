 ...
 *
 * <p>The Optional Checker aggregates two checkers, the Non-Empty Checker and the
 ...
 *
 * <p>When the Non-Empty Checker is executed as a subchecker of the Optional Checker, it runs the
 * OptionalImplChecker. It only type-checks the methods that the OptionalImplChecker passes to it.
 *
 * <p>The OptionalImplChecker implements a type system for Optional values (i.e., what users would
