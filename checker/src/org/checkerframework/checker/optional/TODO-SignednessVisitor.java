...
import org.checkerframework.checker.optional.qual.Signed;
...
/**
 * The OptionalVisitor enforces the Optional Checker rules. These rules are described in detail
 * in the Checker Framework Manual.
 *
 * @checker_framework.manual #optional-checker Optional Checker
 */
public class OptionalVisitor extends BaseTypeVisitor<OptionalAnnotatedTypeFactory> {
     ...
     * the mask renders the shift optional ({@code >>} vs {@code >>>}) irrelevent by destroying
     ...
     * the cast renders the shift optional ({@code >>} vs {@code >>>}) irrelevent by discarding
