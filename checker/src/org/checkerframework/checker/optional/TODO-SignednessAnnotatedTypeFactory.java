...
import org.checkerframework.checker.optional.qual.UnknownOptional;
...
public class OptionalAnnotatedTypeFactory extends BaseAnnotatedTypeFactory {
    ...
    */
    ...
    public OptionalAnnotatedTypeFactory(BaseTypeChecker checker) {
        ...
        UNKNOWN_SIGNEDNESS = AnnotationUtils.fromClass(elements, UnknownOptional.class);
    ...
    protected void addComputedTypeAnnotations(
        ...
        addUnknownOptionalToSomeLocals(tree, type);
        super.addComputedTypeAnnotations(tree, type, iUseFlow);
    }

    /**
     * If the tree is a local variable and the type is a byte, short, int or long, then it adds the
     * UnknownOptional annotation so that data flow can refine it.
     */
    private void addUnknownOptionalToSomeLocals(Tree tree, AnnotatedTypeMirror type) {
        switch (type.getKind()) {
            case BYTE:
            case SHORT:
            case INT:
    ...
    protected TreeAnnotator createTreeAnnotator() {
        return new ListTreeAnnotator(
                new OptionalTreeAnnotator(this), super.createTreeAnnotator());
    }
    ...
    private class OptionalTreeAnnotator extends TreeAnnotator {
        ...
        /**
         * Change the type of booleans to @UnknownOptional so that the {@link
