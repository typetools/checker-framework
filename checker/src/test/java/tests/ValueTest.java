 ...
 *
 * <p>NOTE: $CHECKERFRAMEWORK/checker/tests/value/ needs to be on the classpath. Otherwise
...
public class ValueTest extends CheckerFrameworkPerDirectoryTest {
    ...
    public ValueTest(List<File> testFiles) {
        super(
                ...
                "value",
                "-Anomsgtext",
                "-Astubs=statically-executable.astub:tests/value/minints-stub.astub:tests/value/lowercase.astub",
