...
public interface List<E> extends Collection<E> {
     ...
     * @see #equals(Object)
     */
    @Ond2Vnd @PolyDet int hashCode(@PolyDet List<E> this);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
    @Ond2Vnd @PolyDet E get(@PolyDet List<E> this, @PolyDet int index);
     ...
     *         (<tt>index &lt; 0 || index &gt;= size()</tt>)
     */
    @Ond2Vnd @PolyDet E set(@PolyDet List<E> this, int index, E element);
     ...
     *         (<a href="Collection.html#optional-restrictions">optional</a>)
     */
    @Ond2Vnd @PolyDet int indexOf(@PolyDet List<E> this, Object o);
