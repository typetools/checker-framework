...
public class EnumMap<K extends Enum<K>, V> extends AbstractMap<K, V> implements java.io.Serializable, Cloneable {
  ...
  public @PolyRead EnumMap(@PolyRead EnumMap<K, ? extends V> a1) { throw new RuntimeException(("skeleton method")); }
  public @PolyRead EnumMap(@PolyRead Map<K, ? extends V> a1) { throw new RuntimeException(("skeleton method")); }
