...
public class Arrays {
    ...
    public static void sort(Object[] a) { throw new RuntimeException("skeleton method"); }
    public static void sort(Object[] a, int fromIndex, int toIndex) { throw new RuntimeException("skeleton method"); }
    public static <T> void sort(T[] a, Comparator<? super T> c) { throw new RuntimeException("skeleton method"); }
    public static <T> void sort(T[] a, int fromIndex, int toIndex, Comparator<? super T> c) { throw new RuntimeException("skeleton method"); }
