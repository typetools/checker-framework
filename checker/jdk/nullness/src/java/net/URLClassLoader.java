...
public class URLClassLoader extends SecureClassLoader implements Closeable {
  ...
  public URLClassLoader(URL[] urls, ClassLoader parent,
    ...
    // Currently does not compile with Oracle-Jdk, missing URLClassPath constructor with AccessControlContext
      ...
      private boolean next() {
        ...
        do {
          URL u = AccessController.doPrivileged(
              new PrivilegedAction<@Nullable URL>() {
                public @Nullable URL run() {
  ...
  static {
// Currently does not compile with Oracle-Jdk
