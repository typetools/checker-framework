    ...
    implements java.io.Serializable
{
     ...
     */
    private void init(@UnknownInitialization(BasicPermission.class) BasicPermission this, String name) {
        if (name == null)
     ...
     */
    @SuppressWarnings("initialization")    // field path gets initialized after execution of init method.
    ...
    implements java.io.Serializable
{
     ...
     * @see #serialPersistentFields
     */
    private @Nullable Class<?> permClass;
         ...
         throws IOException, ClassNotFoundException
    {
        ...
        @SuppressWarnings("cast.unsafe")    // pfields.put in writeObject method corresponding to "permissions" stores non-null type permissions values
        Hashtable<String, Permission> permissions =
                (@NonNull Hashtable<String, Permission>)gfields.get("permissions", null);
