...
public class PropertyDescriptor extends FeatureDescriptor {
     ...
     *              introspection.
     */
    @SideEffectFree public PropertyDescriptor(String propertyName, Class<?> beanClass)
     ...
     *              introspection.
     */
    @SideEffectFree public PropertyDescriptor(String propertyName, @Nullable Method readMethod, @Nullable Method writeMethod)
                throws IntrospectionException {
        if (propertyName == null || propertyName.length() == 0) {
            throw new IntrospectionException("bad property name");
        }
     ...
     * @since 1.7
     */
    PropertyDescriptor(Class<?> bean, String base, @Nullable Method read, @Nullable Method write) throws IntrospectionException {
        if (bean == null) {
            throw new IntrospectionException("Target Bean class is null");
        }
        setClass0(bean);
     ...
     */
    @Pure public synchronized @Nullable Class<?> getPropertyType() {
     ...
     */
    @Pure public synchronized @Nullable Method getReadMethod() {
     ...
     */
    @Pure public synchronized @Nullable Method getWriteMethod() {
     ...
     */
    @Pure public boolean isConstrained() {
        return constrained;
    }
     ...
     */
    @Pure public @Nullable Class<?> getPropertyEditorClass() {
     ...
     * @since 1.5
     */
    @SideEffectFree public @Nullable PropertyEditor createPropertyEditor(@Nullable Object bean) {
        Object editor = null;
    ...
    private boolean isAssignable(@Nullable Method m1, @Nullable Method m2) {
        if (m1 == null) {
