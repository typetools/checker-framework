...
public class ConcurrentHashMap<K extends @NonNull Object, V extends @NonNull Object> extends AbstractMap<K, V>
    ...
    private static final long serialVersionUID = 0;
     ...
     public @Nullable V put(@NonNull K key,@NonNull V value) {throw new RuntimeException("skeleton method");}
     public @Nullable V putIfAbsent(@NonNull K key, @NonNull V value) {throw new RuntimeException("skeleton method");}
     public void putAll(Map<? extends K, ? extends V> m) {throw new RuntimeException("skeleton method");}
     public @Nullable V remove(@NonNull Object key) {throw new RuntimeException("skeleton method");}
     public boolean remove(@NonNull Object key, @NonNull Object value) {throw new RuntimeException("skeleton method");}
     public boolean replace(@NonNull K key, @NonNull V oldValue,@NonNull V newValue) {throw new RuntimeException("skeleton method");}
     public @Nullable V replace(@NonNull K key, @NonNull V value) {throw new RuntimeException("skeleton method");}
