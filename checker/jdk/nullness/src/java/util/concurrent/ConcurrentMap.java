 ...
 * published by the Free Software Foundation. However, the following notice accompanied the original
...
/**
 * A {@link java.util.Map} providing additional atomic <tt>putIfAbsent</tt>, <tt>remove</tt>, and
 * <tt>replace</tt> methods.
 *
 * <p>
 * Memory consistency effects: As with other concurrent collections, actions in a thread prior to
 * placing an object into a {@code ConcurrentMap} as a key or value
 * <a href="package-summary.html#MemoryVisibility"><i>happen-before</i></a> actions subsequent to
 * the access or removal of that object from the {@code ConcurrentMap} in another thread.
 *
 * <p>
...
public interface ConcurrentMap<K, V> extends Map<K, V> {
   ...
   *         stored in this map
   * @throws NullPointerException if a specified key or value is null, and this map does not permit
   *         null keys or values
