...
class Properties extends Hashtable<Object,Object> {
    ...
    private static void writeComments(BufferedWriter bw, @Nullable String comments)
        throws IOException {
        bw.write("#");
    ...
    private void store0(BufferedWriter bw, @Nullable String comments, boolean escUnicode)
        throws IOException
    {
        if (comments != null) {
     ...
     * @see     #defaults
     */
    @Pure public @Nullable String getProperty(String key) {
    ...
    private static class XmlSupport {
        ...
        static void save(Properties props, OutputStream os, @Nullable String comment,
                         String encoding)
            throws IOException
        {
