...
public class Level implements java.io.Serializable {
  ...
  @SuppressWarnings("argument.type.incompatible") // All the fields required by KnownLevel.add method
  // are already initialized before passing it as an argument
  ...
  @SuppressWarnings("contracts.precondition.not.satisfied") // This method assigns 'name' to
  // 'localizedLevelName' in case a NullPointerException is thrown by computeLocalizedLevelName
  ...
  //
  @SuppressWarnings("dereference.of.nullable") // level is always ensured to be non-null every time
  // it is dereferenced
   ...
   */
  @Override
  @SuppressWarnings("dereference.of.nullable") // It returns false in case a NullPointerException
  // is thrown
  ...
  static final class KnownLevel {
    ...
    static synchronized @Nullable KnownLevel findByName(String name) {
    ...
    static synchronized @Nullable KnownLevel findByValue(int value) {
    ...
    static synchronized @Nullable KnownLevel findByLocalizedLevelName(String name) {
    ...
    static synchronized @Nullable KnownLevel matches(Level l) {
      List<KnownLevel> list = nameToLevels.get(l.name);
      if (list != null) {
