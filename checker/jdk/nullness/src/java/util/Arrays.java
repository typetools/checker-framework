...
public class Arrays {
  ...
  @Pure
     ...
     */
  @Pure
    public static boolean equals(@PolyNull Object @Nullable [] a, @PolyNull Object @Nullable [] a2) {
        if (a==a2)
            return true;
        if (a==null || a2==null)
            return false;
     ...
     *         runtime type that can be stored in the specified array
     */
    public static void fill(@PolyNull Object[] a, int fromIndex, int toIndex, @PolyNull Object val) {
        rangeCheck(a.length, fromIndex, toIndex);
        for (int i = fromIndex; i < toIndex; i++)
            a[i] = val;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> @Nullable T[] copyOf(T[] original, int newLength) {
     ...
     * @since 1.6
     */
    public static <T,U> @Nullable T[] copyOf(U[] original, int newLength, Class<? extends T[]> newType) {
        @SuppressWarnings("unchecked")
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T> @Nullable T[] copyOfRange(T[] original, int from, int to) {
     ...
     * @since 1.6
     */
    public static <T,U> @Nullable T[] copyOfRange(U[] original, int from, int to, Class<? extends T[]> newType) {
  ...
  @Pure
     ...
     */
  @Pure
    public static int hashCode(@PolyNull Object @Nullable [] a) {
        if (a == null)
            return 0;
     ...
     */
  @Pure
    public static int deepHashCode(@PolyNull Object @Nullable [] a) {
        if (a == null)
            return 0;
     ...
     */
  @Pure
    public static boolean deepEquals(@PolyNull Object @Nullable [] a1, @PolyNull Object @Nullable [] a2) {
        if (a1 == a2)
            return true;
        if (a1 == null || a2==null)
            return false;
