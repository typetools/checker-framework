...
public abstract class AbstractProcessor implements Processor {
     ...
     */
    @SuppressWarnings("nullness") // interface's objects can't be initialized but can only be assigned a reference as done by init(ProcessingEnvironment processingEnv) method
     ...
     */
    public Iterable<? extends Completion> getCompletions(@Nullable Element element,
                                                         @Nullable AnnotationMirror annotation,
                                                         @Nullable ExecutableElement member,
