...
public interface Attributes extends Cloneable, java.io.Serializable {
    ...
    /**
      ...
      * @see #remove
      */
    @Pure @Nullable Attribute get(String attrID);
    ...
    /**
      ...
      *         is returned.
      */
    @Pure NamingEnumeration<? extends Attribute> getAll();
    ...
    /**
      ...
      *         is returned.
      */
    @Pure NamingEnumeration<String> getIDs();
