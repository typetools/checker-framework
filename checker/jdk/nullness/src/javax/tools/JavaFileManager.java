...
public interface JavaFileManager extends Closeable, Flushable, OptionChecker {
     ...
     */
    @Nullable ClassLoader getClassLoader(Location location);
     ...
     * and this file manager cannot be reopened
     */
    @Nullable String inferBinaryName(Location location, JavaFileObject file);
     ...
     * and this file manager cannot be reopened
     */
    @Nullable JavaFileObject getJavaFileForInput(Location location,
                                       String className,
                                       Kind kind)
        throws IOException;
     ...
     * and this file manager cannot be reopened
     */
    @Nullable FileObject getFileForInput(Location location,
                               String packageName,
                               String relativeName)
        throws IOException;
