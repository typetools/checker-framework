...
public class ToolProvider {
     ...
     */
    public static @Nullable JavaCompiler getSystemJavaCompiler() {
     ...
     */
    public static @Nullable DocumentationTool getSystemDocumentationTool() {
     ...
     */
    public static @Nullable ClassLoader getSystemToolClassLoader() {
        try {
