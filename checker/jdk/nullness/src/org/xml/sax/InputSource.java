...
public class InputSource {
     ...
     * @see #setEncoding
     */
    @SideEffectFree public InputSource ()
    {
    }
     ...
     * @see #setCharacterStream
     */
    @SideEffectFree public InputSource (String systemId)
    {
     ...
     * @see #setCharacterStream
     */
    @SideEffectFree public InputSource (InputStream byteStream)
    {
     ...
     * @see #setCharacterStream
     */
    @SideEffectFree public InputSource (Reader characterStream)
    {
     ...
     * @see #setPublicId
     */
    @Pure public @Nullable String getPublicId ()
    {
        return publicId;
    }
     ...
     * @see #getEncoding
     */
    @Pure public @Nullable String getSystemId ()
    {
        return systemId;
    }
     ...
     * @see #setByteStream
     */
    @Pure public @Nullable InputStream getByteStream ()
    {
        return byteStream;
    }
     ...
     * @see #getByteStream
     */
    @Pure public @Nullable String getEncoding ()
    {
        return encoding;
    }
     ...
     * @see #setCharacterStream
     */
    @Pure public @Nullable Reader getCharacterStream ()
    {
