...
public interface Node {
     ...
     */
    @Pure public String getNodeName();
     ...
     *   platform.
     */
    @Pure public @Nullable String getNodeValue()
                              throws DOMException;
    /**
     * The value of this node, depending on its type; see the table above.
     * When it is defined to be <code>null</code>, setting it has no effect,
     ...
     * <code>null</code>.
     */
    @Pure public @Nullable Node getParentNode();
     ...
     * nodes.
     */
    @Pure public NodeList getChildNodes();

    /**
     * The first child of this node. If there is no such node, this returns
     * <code>null</code>.
     */
    @Pure public @Nullable Node getFirstChild();

    /**
     * The last child of this node. If there is no such node, this returns
     * <code>null</code>.
     */
    @Pure public @Nullable Node getLastChild();

    /**
     * The node immediately preceding this node. If there is no such node,
     * this returns <code>null</code>.
     */
    @Pure public @Nullable Node getPreviousSibling();

    /**
     * The node immediately following this node. If there is no such node,
     * this returns <code>null</code>.
     */
    @Pure public @Nullable Node getNextSibling();

    /**
     * A <code>NamedNodeMap</code> containing the attributes of this node (if
     * it is an <code>Element</code>) or <code>null</code> otherwise.
     */
    @Pure public @Nullable NamedNodeMap getAttributes();
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable Document getOwnerDocument();
     ...
     */
    @Pure public boolean hasChildNodes();
     ...
     * @since DOM Level 2
     */
    @Pure public boolean isSupported(String feature,
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable String getNamespaceURI();
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable String getPrefix();
    /**
     * The namespace prefix of this node, or <code>null</code> if it is
     * unspecified. When it is defined to be <code>null</code>, setting it
     * has no effect, including if the node is read-only.
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable String getLocalName();
     ...
     * @since DOM Level 2
     */
    @Pure public boolean hasAttributes();
     ...
     * @since DOM Level 3
     */
    @Pure public short compareDocumentPosition(Node other)
                                         throws DOMException;
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String getTextContent()
                                         throws DOMException;
    /**
     * This attribute returns the text content of this node and its
     * descendants. When it is defined to be <code>null</code>, setting it
     ...
     * @since DOM Level 3
     */
    @Pure public boolean isSameNode(Node other);
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String lookupPrefix(@Nullable String namespaceURI);
     ...
     * @since DOM Level 3
     */
    @Pure public boolean isDefaultNamespace(@Nullable String namespaceURI);
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String lookupNamespaceURI(@Nullable String prefix);
     ...
     * @since DOM Level 3
     */
    @Pure public boolean isEqualNode(Node arg);
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable Object getFeature(String feature,
                             @Nullable String version);
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable Object getUserData(String key);
