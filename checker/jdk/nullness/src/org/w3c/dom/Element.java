...
public interface Element extends Node {
     ...
     */
    @Pure public String getAttribute(String name);
     ...
     *   attribute.
     */
    @Pure public @Nullable Attr getAttributeNode(String name);
     ...
     */
    @Pure public NodeList getElementsByTagName(String name);
     ...
     * @since DOM Level 2
     */
    @Pure public String getAttributeNS(@Nullable String namespaceURI,
                                 String localName)
                                 throws DOMException;
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable Attr getAttributeNodeNS(@Nullable String namespaceURI,
                                   String localName)
                                   throws DOMException;
     ...
     * @since DOM Level 2
     */
    @Pure public boolean hasAttributeNS(@Nullable String namespaceURI,
                                  String localName)
                                  throws DOMException;
