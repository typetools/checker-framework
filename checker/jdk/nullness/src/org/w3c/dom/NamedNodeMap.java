...
public interface NamedNodeMap {
     ...
     */
    @Pure public @Nullable Node getNamedItem(String name);
     ...
     */
    @Pure public @Nullable Node item(int index);
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable Node getNamedItemNS(@Nullable String namespaceURI,
                               String localName)
                               throws DOMException;
