...
public interface Document extends Node {
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable DocumentType getDoctype();

    /**
     * The <code>DOMImplementation</code> object that handles this document. A
     * DOM application may use objects from multiple implementations.
     */
    @Pure public DOMImplementation getImplementation();

    /**
     * This is a convenience attribute that allows direct access to the child
     * node that is the document element of the document.
     */
    @Pure public Element getDocumentElement();
     ...
     *   <code>Elements</code>.
     */
    @Pure public NodeList getElementsByTagName(String tagname);
     ...
     * @since DOM Level 2
     */
    @Pure public NodeList getElementsByTagNameNS(@Nullable String namespaceURI,
                                           String localName);
     ...
     * @since DOM Level 2
     */
    @Pure public @Nullable Element getElementById(String elementId);
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String getInputEncoding();
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String getXmlEncoding();
     ...
     * @since DOM Level 3
     */
    @Pure public boolean getXmlStandalone();
    /**
     * An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, whether this document is standalone. This is <code>false</code> when
     * unspecified.
     * <p ><b>Note:</b>  No verification is done on the value when setting
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String getXmlVersion();
    /**
     *  An attribute specifying, as part of the <a href='http://www.w3.org/TR/2004/REC-xml-20040204#NT-XMLDecl'>XML declaration</a>, the version number of this document. If there is no declaration and if
     * this document supports the "XML" feature, the value is
     * <code>"1.0"</code>. If this document does not support the "XML"
     ...
     * @since DOM Level 3
     */
    // Default implementation packaged with JVM will throw NullPointerException if passed a null argument
     ...
     * @since DOM Level 3
     */
    @Pure public boolean getStrictErrorChecking();
    /**
     * An attribute specifying whether error checking is enforced or not. When
     * set to <code>false</code>, the implementation is free to not test
     * every possible error case normally defined on DOM operations, and not
     ...
     * @since DOM Level 3
     */
    @Pure public @Nullable String getDocumentURI();
    /**
     *  The location of the document or <code>null</code> if undefined or if
     * the <code>Document</code> was created using
     * <code>DOMImplementation.createDocument</code>. No lexical checking is
     ...
     * @since DOM Level 3
     */
    @Pure public DOMConfiguration getDomConfig();
