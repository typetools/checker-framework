...
abstract class AbstractMultimap<K, V> implements Multimap<K, V>, Serializable {
  ...
  public Collection<V> removeAll(@Nullable Object key) {
    /*@Nullable*/ Collection<V> collection = map.remove(key);
  ...
  @SideEffectFree private Set<K> createKeySet() {
  ...
  private class KeySet extends AbstractSet<K> {
    ...
    @SideEffectFree KeySet(final Map<K, Collection<V>> subMap) {
      this.subMap = subMap;
    }
    ...
    @Override public boolean remove(/*@Nullable*/ Object key) {
      int count = 0;
      /*@Nullable*/ Collection<V> collection = subMap.remove(key);
      if (collection != null) {
  ...
  private class MultisetView extends AbstractMultiset<K> {
    ...
    private class EntrySet extends AbstractSet<Multiset.Entry<K>> {
      ...
      @SuppressWarnings("nullness")
	  //This can only contain Map.Entry<?>, not anything null
      @Override public boolean remove(/*@Nullable*/ Object o) {
        return contains(o) &&
    ...
    @Override public int count(/*@Nullable*/ Object key) {
      try {
        @Nullable Collection<V> collection = map.get(key);
   ...
   */
  @SuppressWarnings("nullness")
      //Suppressed due to annotation on map
  ...
  private class AsMap extends AbstractMap<K, Collection<V>> {
	...
	/*@Nullable*/ Collection<V> collection = submap.get(key);
      if (collection == null) {
        return null;
      }
      @SuppressWarnings("unchecked")
    ...
    class AsMapEntries extends AbstractSet<Map.Entry<K, Collection<V>>> {
      ...
      @SuppressWarnings("nullness")
	  //Suppressed, as this only contains Entry<>
      @Override public boolean remove(/*@Nullable*/ Object o) {
        if (!contains(o)) {
          return false;
        }
