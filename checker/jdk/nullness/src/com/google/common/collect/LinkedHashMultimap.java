...
@GwtCompatible(serializable = true)
    public final class LinkedHashMultimap<K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object>  extends AbstractSetMultimap<K, V> {
  ...
  private class SetDecorator extends ForwardingSet<V> {
    ...
    // suppressed due to type of value
    ...
    @SuppressWarnings("nullness")
    @Override public boolean removeAll(Collection<? extends /*@Nullable*/ Object> values) {
    ...
    @SuppressWarnings("nullness")
    @Override public boolean retainAll(Collection<? extends /*@Nullable*/ Object> values) {
      /*
