...
public final class Maps {
   ...
   */
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> HashMap<K, V> newHashMapWithExpectedSize(
      int expectedSize) {
    /*
   ...
   */
    public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> TreeMap<K, V> newTreeMap(SortedMap<K, ? extends V> map) {
  ...
  // Suppressed to override annotations on TreeMap constructor
  public static <C extends /*@Nullable*/ Object, K extends C, V extends /*@Nullable*/ Object> TreeMap<K, V> newTreeMap(
   ...
   */
  public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> BiMap<K, V> synchronizedBiMap(BiMap<K, V> bimap) {
   ...
   */
  @SuppressWarnings("nullness")
  //Suppressed to override Java.util.Map.get and remove.
  ...
  // invoking the function.
    //** values should not be permitted to be null
   ...
   */
  static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> Set<Entry<K, V>> unmodifiableEntrySet(
  ...
  static class UnmodifiableEntries<K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object>
    ...
    @SuppressWarnings("nullness")
    // Suppressed to override the annotations on toArray
   ...
   */
    public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> BiMap<K, V> unmodifiableBiMap(
  ...
  /** @see Maps#unmodifiableBiMap(BiMap) */
    ...
    transient /*@Nullable*/ BiMap<V, K> inverse;
   ...
   */
    static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> boolean removeEntryImpl(Collection<Entry<K, V>> c, /*@Nullable*/ Object o) {
    if (!(o instanceof Entry)) {
      return false;
    }
   ...
   */
  public static <K extends /*@Nullable*/ Object, V1 extends /*@Nullable*/ Object, V2 extends /*@Nullable*/ Object> Map<K, V2> transformValues(
      Map<K, V1> fromMap, Function<? super V1, V2> function) {
    return new TransformedValuesMap<K, V1, V2>(fromMap, function);
  }

      private static class TransformedValuesMap<K extends /*@Nullable*/ Object, V1 extends /*@Nullable*/ Object, V2 extends /*@Nullable*/ Object>
    ...
    @Override public /*@Nullable*/ V2 get(/*@Nullable*/ Object key) {
      /*@Nullable*/ V1 value = fromMap.get(key);
      return (value != null || fromMap.containsKey(key))
          ? function.apply(value) : null;
    }

    @SuppressWarnings("nullness")
    // Suppressed to override Java.util.Map.containsKey
    @Override public /*@Nullable*/ V2 remove(/*@Nullable*/ Object key) {
      return fromMap.containsKey(key)
...
public static <K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> Map<K, V> filterKeys(
  ...
  private static abstract class AbstractFilteredMap<K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object>
    ...
    boolean apply(/*@Nullable*/ Object key, V value) {
      K k = (K) key;
  ...
  private static class FilteredKeyMap<K extends /*@Nullable*/ Object, V extends /*@Nullable*/ Object> extends AbstractFilteredMap<K, V> {
    ...
    private class KeySet extends AbstractSet<K> {
      ...
      @Override public boolean removeAll(Collection<? extends /*@Nullable*/ Object> collection) {
      ...
      @Override public boolean retainAll(Collection<? extends /*@Nullable*/ Object> collection) {
        checkNotNull(collection); // for GWT
        boolean changed = false;
        Iterator<Entry<K, V>> iterator = unfiltered.entrySet().iterator();
        while (iterator.hasNext()) {
