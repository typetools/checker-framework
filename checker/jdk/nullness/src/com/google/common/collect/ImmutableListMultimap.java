...
public class ImmutableListMultimap<K, V>
   ...
   * this multimap.
   */
  @Override public ImmutableList<V> get(K key) {
   ...
   */
  @Override public ImmutableList<V> removeAll(/*@Nullable*/ Object key) {
  ...
  // InvalidObjectException will get a non-null String
