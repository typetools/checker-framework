...
public final class Multisets {
   ...
   */
    ...
    private static class UnmodifiableMultiset<E extends /*@Nullable*/ Object>
   ...
   */
    static <E extends /*@Nullable*/ Object> Multiset<E> forSet(Set<E> set) {
    return new SetMultiset<E>(set);
  }

  /** @see Multisets#forSet */
    private static class SetMultiset<E extends /*@Nullable*/ Object> extends ForwardingCollection<E>
   ...
   * of 11 is returned.
   */
  static int inferDistinctElements(Iterable<? extends /*@Nullable*/ Object> elements) {
