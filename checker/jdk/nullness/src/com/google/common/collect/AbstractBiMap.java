...
public BiMap<V, K> inverse() {
  ...
  private class KeySet extends ForwardingSet<K> {
    ...
    @Override public boolean removeAll(Collection<? extends /*@Nullable*/ Object> keysToRemove) {
      return Iterators.removeAll(iterator(), keysToRemove);
    }

    @Override public boolean retainAll(Collection<? extends /*@Nullable*/ Object> keysToRetain) {
