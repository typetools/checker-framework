...
public final class MutableClassToInstanceMap<B extends /*@Nullable*/ Object>
  ...
  static <B, T extends B> T cast(Class<T> type, /*@Nullable*/ B value) {
  ...
  @SuppressWarnings("nullness")
      //Suppressed due to annotations on build()
  private static <T extends /*@Nullable*/ Object> Class<T> wrap(Class<T> c) {
