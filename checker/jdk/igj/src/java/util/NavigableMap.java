...
public interface NavigableMap<K, V> extends @I SortedMap<K, V> {
  public abstract Map. @I Entry<K, V> lowerEntry(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract K lowerKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @I Entry<K, V> floorEntry(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract K floorKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @I Entry<K, V> ceilingEntry(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract K ceilingKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @I Entry<K, V> higherEntry(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract K higherKey(@ReadOnly NavigableMap<K, V> this, K a1);
  public abstract Map. @I Entry<K, V> firstEntry(@ReadOnly NavigableMap<K, V> this);
  public abstract Map. @I Entry<K, V> lastEntry(@ReadOnly NavigableMap<K, V> this);
  public abstract Map. @I Entry<K, V> pollFirstEntry(@Mutable NavigableMap<K, V> this);
  public abstract Map. @I Entry<K, V> pollLastEntry(@Mutable NavigableMap<K, V> this);
