...
public class Package implements java.lang.reflect.AnnotatedElement{
  ...
  @Pure public boolean isSealed(@GuardSatisfied Package this) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isSealed(@GuardSatisfied Package this,@GuardSatisfied java.net.URL a1) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isCompatibleWith(@GuardSatisfied Package this,String a1) throws NumberFormatException { throw new RuntimeException("skeleton method"); }
  @Pure public static Package getPackage(String a1) { throw new RuntimeException("skeleton method"); }
  @Pure public static Package[] getPackages() { throw new RuntimeException("skeleton method"); }
  @Pure public int hashCode(@GuardSatisfied Package this) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public String toString(@GuardSatisfied Package this) { throw new RuntimeException("skeleton method"); }
  public <A extends java.lang.annotation.Annotation> A getAnnotation(Class<A> a1) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isAnnotationPresent(@GuardSatisfied Package this,@GuardSatisfied Class<? extends java.lang.annotation.Annotation> a1) { throw new RuntimeException("skeleton method"); }
