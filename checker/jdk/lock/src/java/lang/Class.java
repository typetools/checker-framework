...
public final class Class<T> extends Object implements java.io.Serializable, java.lang.reflect.GenericDeclaration, java.lang.reflect.Type, java.lang.reflect.AnnotatedElement {
  ...
  protected Class() {}
  @Override
@SideEffectFree public String toString(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public boolean isAnnotation(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  @Pure public native boolean isInstance(@GuardSatisfied Class<T> this,Object a1);
  @Pure public boolean isSynthetic(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
...
public java.lang.reflect.TypeVariable<Class<T>>[] getTypeParameters() { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public Package getPackage(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public native Class<? super T> getSuperclass(@GuardSatisfied Class<T> this);
  @Pure public native Class<?>[] getInterfaces(@GuardSatisfied Class<T> this);
  public String getCanonicalName() { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isAnonymousClass(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isLocalClass(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean isMemberClass(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public boolean isEnum(@GuardSatisfied Class<T> this) { throw new RuntimeException("skeleton method"); }
...
public <A extends java.lang.annotation.Annotation> A getAnnotation(Class<A> a1) { throw new RuntimeException("skeleton method"); }
  @Override
@Pure public boolean isAnnotationPresent(@GuardSatisfied Class<T> this,@GuardSatisfied Class<? extends java.lang.annotation.Annotation> a1) { throw new RuntimeException("skeleton method"); }
  @Override
...
public java.lang.annotation.Annotation[] getDeclaredAnnotations() { throw new RuntimeException("skeleton method"); }
  @Pure public native Class<?> getComponentType(@GuardSatisfied Class<T> this);
  public native Object [] getSigners();
  public native Class<?> getDeclaringClass();
  @Pure public native boolean isPrimitive(@GuardSatisfied Class<T> this);

  @Pure public native boolean isArray(@GuardSatisfied Class<T> this);
  @Pure public native boolean isAssignableFrom(@GuardSatisfied Class<T> this,Class<?> cls);
  @Pure public native boolean isInterface(@GuardSatisfied Class<T> this);
  @Pure public native int getModifiers(@GuardSatisfied Class<T> this);

  //@Pure public boolean isTypeAnnotationPresent(@GuardSatisfied Class<T> this,@GuardSatisfied Class<T><? extends java.lang.annotation.Annotation> annotationClass) { throw new RuntimeException("skeleton method"); }
