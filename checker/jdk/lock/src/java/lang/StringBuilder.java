...
public final class StringBuilder
  ...
  public StringBuilder append(Object a1) { throw new RuntimeException("skeleton method"); }
  public StringBuilder append(String a1) { throw new RuntimeException("skeleton method"); }
  public StringBuilder append(StringBuffer a1) { throw new RuntimeException("skeleton method"); }
  public StringBuilder append(CharSequence a1) { throw new RuntimeException("skeleton method"); }
  public StringBuilder append(CharSequence a1, int a2, int a3) { throw new RuntimeException("skeleton method"); }
  ...
  public StringBuilder insert(int a1, Object a2) { throw new RuntimeException("skeleton method"); }
  public StringBuilder insert(int a1, String a2) { throw new RuntimeException("skeleton method"); }
  public StringBuilder insert(int a1, char[] a2) { throw new RuntimeException("skeleton method"); }
  public StringBuilder insert(int a1, CharSequence a2) { throw new RuntimeException("skeleton method"); }
  public StringBuilder insert(int a1, CharSequence a2, int a3, int a4) { throw new RuntimeException("skeleton method"); }
