...
public final class Constructor<T> extends AccessibleObject implements GenericDeclaration, Member {
    ...
    @Pure public boolean equals(@GuardSatisfied Constructor<T> this,@GuardSatisfied Object arg0) { throw new RuntimeException("skeleton method"); }
    @Pure public int hashCode(@GuardSatisfied Constructor<T> this) { throw new RuntimeException("skeleton method"); }
    @SideEffectFree public String toString(@GuardSatisfied Constructor<T> this) { throw new RuntimeException("skeleton method"); }
    ...
    @Pure public boolean isVarArgs(@GuardSatisfied Constructor<T> this) { throw new RuntimeException("skeleton method"); }
    @Pure public boolean isSynthetic(@GuardSatisfied Constructor<T> this) { throw new RuntimeException("skeleton method"); }
