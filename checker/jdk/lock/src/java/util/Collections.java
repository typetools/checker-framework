...
public class Collections {
  ...
  public static <T extends Object> Set<T> singleton(T a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> Comparator<T> reverseOrder(Comparator<T> a1) { throw new RuntimeException("skeleton method"); }
  ...
  public static int frequency(Collection<?> a1, Object a2) { throw new RuntimeException("skeleton method"); }
