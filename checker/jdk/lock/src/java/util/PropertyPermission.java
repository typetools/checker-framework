...
public final class PropertyPermission extends java.security.BasicPermission {
  ...
  @Pure public boolean equals(@GuardSatisfied PropertyPermission this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public int hashCode(@GuardSatisfied PropertyPermission this) { throw new RuntimeException("skeleton method"); }
