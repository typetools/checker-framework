...
public class BitSet implements Cloneable, java.io.Serializable {
  ...
  public void flip(@GuardSatisfied BitSet this, int a1) { throw new RuntimeException("skeleton method"); }
  public void flip(@GuardSatisfied BitSet this, int a1, int a2) { throw new RuntimeException("skeleton method"); }
  public void set(@GuardSatisfied BitSet this, int a1) { throw new RuntimeException("skeleton method"); }
  public void set(@GuardSatisfied BitSet this, int a1, boolean a2) { throw new RuntimeException("skeleton method"); }
  public void set(@GuardSatisfied BitSet this, int a1, int a2) { throw new RuntimeException("skeleton method"); }
  public void set(@GuardSatisfied BitSet this, int a1, int a2, boolean a3) { throw new RuntimeException("skeleton method"); }
  public void clear(@GuardSatisfied BitSet this, int a1) { throw new RuntimeException("skeleton method"); }
  public void clear(@GuardSatisfied BitSet this, int a1, int a2) { throw new RuntimeException("skeleton method"); }
  public void clear(@GuardSatisfied BitSet this, ) { throw new RuntimeException("skeleton method"); }
  ...
  public void and(@GuardSatisfied BitSet this, BitSet a1) { throw new RuntimeException("skeleton method"); }
  public void or(@GuardSatisfied BitSet this, BitSet a1) { throw new RuntimeException("skeleton method"); }
  public void xor(@GuardSatisfied BitSet this, BitSet a1) { throw new RuntimeException("skeleton method"); }
  public void andNot(@GuardSatisfied BitSet this, BitSet a1) { throw new RuntimeException("skeleton method"); }
