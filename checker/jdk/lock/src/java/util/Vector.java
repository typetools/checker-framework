...
public class Vector<E extends Object> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
  ...
  @Pure public synchronized int size(@GuardSatisfied Vector<E> this) { throw new RuntimeException("skeleton method"); }
  @Pure public synchronized boolean isEmpty(@GuardSatisfied Vector<E> this) { throw new RuntimeException("skeleton method"); }
  public Enumeration<E> elements() { throw new RuntimeException("skeleton method"); }
  @Pure public boolean contains(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public int indexOf(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public synchronized int indexOf(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1, int a2) { throw new RuntimeException("skeleton method"); }
  @Pure public synchronized int lastIndexOf(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public synchronized int lastIndexOf(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1, int a2) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public synchronized E get(@GuardSatisfied Vector<E> this,int a1) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public synchronized boolean containsAll(@GuardSatisfied Vector<E> this,@GuardSatisfied Collection<?> a1) { throw new RuntimeException("skeleton method"); }
  ...
  @Pure public synchronized boolean equals(@GuardSatisfied Vector<E> this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public synchronized int hashCode(@GuardSatisfied Vector<E> this) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized String toString(@GuardSatisfied Vector<E> this) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized List<E> subList(@GuardSatisfied Vector<E> this,int a1, int a2) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized Object clone(@GuardSatisfied Vector<E> this) { throw new RuntimeException("skeleton method"); }
}
