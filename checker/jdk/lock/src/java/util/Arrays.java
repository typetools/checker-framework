...
public class Arrays {
  ...
  public static <T> void sort(T[] a1, Comparator<? super T> a2) { throw new RuntimeException("skeleton method"); }
  public static <T> void sort(T[] a1, int a2, int a3, Comparator<? super T> a4) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> int binarySearch(T[] a1, int a2, int a3, T a4, Comparator<? super T> a5) { throw new RuntimeException("skeleton method"); }
   ...
   public static boolean equals(Object @GuardSatisfied [] a1, Object @GuardSatisfied [] a2) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T, U> T[] copyOfRange(U[] a1, int a2, int a3, Class<? extends T[]> a4) { throw new RuntimeException("skeleton method"); }
  ...
  public static <T> List<T> asList(T... a1) { throw new RuntimeException("skeleton method"); }
   ...
   public static int hashCode(Object @GuardSatisfied [] a1) { throw new RuntimeException("skeleton method"); }
   public static int deepHashCode(Object @GuardSatisfied [] a1) { throw new RuntimeException("skeleton method"); }
   public static boolean deepEquals(Object @GuardSatisfied [] a1, Object @GuardSatisfied [] a2) { throw new RuntimeException("skeleton method"); }
