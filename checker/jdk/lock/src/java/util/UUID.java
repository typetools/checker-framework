...
public final class UUID implements java.io.Serializable, Comparable<UUID> {
  ...
  @SideEffectFree public String toString(@GuardSatisfied UUID this) { throw new RuntimeException("skeleton method"); }
  @Pure public int hashCode(@GuardSatisfied UUID this) { throw new RuntimeException("skeleton method"); }
  @Pure public boolean equals(@GuardSatisfied UUID this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public int compareTo(@GuardSatisfied UUID this,@GuardSatisfied UUID a1) { throw new RuntimeException("skeleton method"); }
}
