...
public class LineNumberReader extends BufferedReader {
     ...
     * @see #getLineNumber
     */
    public void setLineNumber(@GuardSatisfied LineNumberReader this, int lineNumber) {
     ...
     */
    @SuppressWarnings("fallthrough")
    public int read(@GuardSatisfied LineNumberReader this, char cbuf[], int off, int len) throws IOException {
        synchronized (lock) {
     ...
     */
    public long skip(@GuardSatisfied LineNumberReader this, long n) throws IOException {
        if (n < 0)
     ...
     *          If an I/O error occurs
     */
    public void mark(@GuardSatisfied LineNumberReader this, int readAheadLimit) throws IOException {
        synchronized (lock) {
