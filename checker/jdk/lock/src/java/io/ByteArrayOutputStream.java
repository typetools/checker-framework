...
public class ByteArrayOutputStream extends OutputStream {
  ...
  @Pure public synchronized int size(@GuardSatisfied ByteArrayOutputStream this) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized String toString(@GuardSatisfied ByteArrayOutputStream this) { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized String toString(@GuardSatisfied ByteArrayOutputStream this,String a1) throws UnsupportedEncodingException { throw new RuntimeException("skeleton method"); }
  @SideEffectFree public synchronized String toString(@GuardSatisfied ByteArrayOutputStream this,int a1) { throw new RuntimeException("skeleton method"); }
