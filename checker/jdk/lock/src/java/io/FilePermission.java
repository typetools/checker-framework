...
public final class FilePermission extends java.security.Permission implements Serializable {
  ...
  @Pure public boolean equals(@GuardSatisfied FilePermission this,@GuardSatisfied Object a1) { throw new RuntimeException("skeleton method"); }
  @Pure public int hashCode(@GuardSatisfied FilePermission this) { throw new RuntimeException("skeleton method"); }
