...
public class BufferedReader extends Reader {
     ...
     * @exception  IOException  If an I/O error occurs
     */
    public int read(@GuardSatisfied BufferedReader this, char cbuf[], int off, int len) throws IOException {
        synchronized (lock) {
            ensureOpen();
     ...
     * @exception  IOException  If an I/O error occurs
     */
    public long skip(@GuardSatisfied BufferedReader this, long n) throws IOException {
        if (n < 0L) {
     ...
     * @exception  IOException  If an I/O error occurs
     */
    public void mark(@GuardSatisfied BufferedReader this, int readAheadLimit) throws IOException {
        if (readAheadLimit < 0) {
