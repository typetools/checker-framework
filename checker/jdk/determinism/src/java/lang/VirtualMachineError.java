...
abstract public class VirtualMachineError extends Error {
     ...
     */
    @Det public VirtualMachineError() {
        super();
    }
     ...
     */
    @PolyDet public VirtualMachineError(@PolyDet String message) {
        super(message);
    }
     ...
     * @since  1.8
     */
    @PolyDet public VirtualMachineError(@PolyDet String message, @PolyDet Throwable cause) {
        super(message, cause);
    }
     ...
     * @since  1.8
     */
    @PolyDet public VirtualMachineError(@PolyDet Throwable cause) {
        super(cause);
    }
}
