...
public class ExceptionInInitializerError extends LinkageError {
     ...
     */
    @Det public ExceptionInInitializerError() {
     ...
     */
    @PolyDet public ExceptionInInitializerError(@PolyDet Throwable thrown) {
        initCause(null);  // Disallow subsequent initCause
     ...
     */
    @PolyDet public ExceptionInInitializerError(@PolyDet String s) {
        super(s);
        initCause(null);  // Disallow subsequent initCause
    }
