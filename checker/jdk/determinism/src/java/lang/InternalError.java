...
public class InternalError extends VirtualMachineError {
     ...
     */
    @PolyDet public InternalError(@PolyDet String message) {
        super(message);
    }
     ...
     * @since  1.8
     */
    @PolyDet public InternalError(@PolyDet String message, @PolyDet Throwable cause) {
        super(message, cause);
    }
     ...
     * @since  1.8
     */
    @PolyDet public InternalError(@PolyDet Throwable cause) {
        super(cause);
    }
