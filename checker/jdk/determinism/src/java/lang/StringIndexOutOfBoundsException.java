...
class StringIndexOutOfBoundsException extends IndexOutOfBoundsException {
     ...
     * @since   JDK1.0.
     */
    @Det public StringIndexOutOfBoundsException() {
        super();
    }
     ...
     */
    @PolyDet public StringIndexOutOfBoundsException(@PolyDet String s) {
        super(s);
    }
     ...
     */
    @PolyDet public StringIndexOutOfBoundsException(@PolyDet int index) {
