...
public class SecurityException extends RuntimeException {
     ...
     */
    @PolyDet public SecurityException(@PolyDet String s) {
        super(s);
    }
     ...
     * @since 1.5
     */
    @PolyDet public SecurityException(@PolyDet String message, @PolyDet Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.5
     */
    @PolyDet public SecurityException(@PolyDet Throwable cause) {
        super(cause);
    }
}
