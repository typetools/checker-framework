...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E> {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public @PolyDet("up") int indexOf(@PolyDet AbstractList<E> this, @PolyDet Object o) {
     ...
     * @throws NullPointerException {@inheritDoc}
     */
    public @PolyDet("up") int lastIndexOf(@PolyDet AbstractList<E> this, @PolyDet Object o) {
     ...
     */
    public @NonDet int hashCode(@PolyDet AbstractList<E> this) {
        int hashCode = 1;
        for (E e : this)
