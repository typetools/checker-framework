...
public abstract class Signature extends SignatureSpi {
     ...
     * @since 1.2
     */
    public final int sign(@PolySigned byte[] outbuf, int offset, int len)
     ...
     */
    public final boolean verify(@PolySigned byte[] signature) throws SignatureException {
        if (state == VERIFY) {
     ...
     * @since 1.4
     */
    public final boolean verify(@PolySigned byte[] signature, int offset, int length)
        throws SignatureException {
        if (state == VERIFY) {
            if (signature == null) {
     ...
     * initialized properly.
     */
    public final void update(@PolySigned byte[] data) throws SignatureException {
     ...
     * initialized properly.
     */
    public final void update(@PolySigned byte[] data, int off, int len)
            throws SignatureException {
    ...
    private static class Delegate extends Signature {
        ...
        protected void engineUpdate(@PolySigned byte[] b, int off, int len)
                throws SignatureException {
            chooseFirstProvider();
        ...
        protected int engineSign(@PolySigned byte[] outbuf, int offset, int len)
                throws SignatureException {
            chooseFirstProvider();
            return sigSpi.engineSign(outbuf, offset, len);
        }

        protected boolean engineVerify(@PolySigned byte[] sigBytes)
                throws SignatureException {
            chooseFirstProvider();
            return sigSpi.engineVerify(sigBytes);
        }

        protected boolean engineVerify(@PolySigned byte[] sigBytes, int offset, int length)
                throws SignatureException {
            chooseFirstProvider();
