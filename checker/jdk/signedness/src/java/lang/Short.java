...
public final class Short extends Number implements Comparable<Short> {
     ...
     * @since 1.5
     */
    public static @Constant short reverseBytes(@UnknownSignedness short i) {
     ...
     * @since 1.8
     */
    public static @Unsigned int toUnsignedInt(@UnknownSignedness short x) {
        return ((int) x) & 0xffff;
    }
     ...
     * @since 1.8
     */
    public static @Unsigned long toUnsignedLong(@UnknownSignedness short x) {
