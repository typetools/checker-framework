    ...
    implements Comparable<LongBuffer>
{
     ...
     */
    public static LongBuffer wrap(@PolySigned long[] array,
     ...
     *          parameters do not hold
     */
    public LongBuffer get(@PolySigned long[] dst, int offset, int length) {
     ...
     *          remaining in this buffer
     */
    public LongBuffer get(@PolySigned long[] dst) {
