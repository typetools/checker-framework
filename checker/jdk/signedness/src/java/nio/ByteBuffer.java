    ...
    implements Comparable<ByteBuffer>
{
     ...
     */
    public static ByteBuffer wrap(@PolySigned byte[] array,
     ...
     *          parameters do not hold
     */
    public ByteBuffer get(@PolySigned byte[] dst, int offset, int length) {
     ...
     *          remaining in this buffer
     */
    public ByteBuffer get(@PolySigned byte[] dst) {
     ...
     *          If this buffer is read-only
     */
    public final ByteBuffer put(@PolySigned byte[] src) {
