    ...
    implements Comparable<ShortBuffer>
{
     ...
     */
    public static ShortBuffer wrap(@PolySigned short[] array,
     ...
     *          parameters do not hold
     */
    public ShortBuffer get(@PolySigned short[] dst, int offset, int length) {
     ...
     *          remaining in this buffer
     */
    public ShortBuffer get(@PolySigned short[] dst) {
     ...
     *          If this buffer is read-only
     */
    public ShortBuffer put(@PolySigned short[] src, int offset, int length) {
     ...
     *          If this buffer is read-only
     */
    public final ShortBuffer put(@PolySigned short[] src) {
