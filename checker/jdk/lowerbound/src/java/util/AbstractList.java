...
public abstract class AbstractList<E> extends AbstractCollection<E> implements List<E> {
     ...
     */
    abstract public E get(@NonNegative int index);
...
class SubList<E> extends AbstractList<E> {
    ...
    SubList(AbstractList<E> list, @NonNegative int fromIndex, @NonNegative int toIndex) {
        if (fromIndex < 0)
...
class RandomAccessSubList<E> extends SubList<E> implements RandomAccess {
    RandomAccessSubList(AbstractList<E> list, @NonNegative int fromIndex, @NonNegative int toIndex) {
