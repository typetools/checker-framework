...
public class Phaser {
     ...
     */
    public Phaser(@NonNegative int parties) {
        this(null, parties);
    }
     ...
     * or greater than the maximum number of parties supported
     */
    public Phaser(Phaser parent, @NonNegative int parties) {
     ...
     */
    public int bulkRegister(@NonNegative int parties) {
        if (parties < 0)
     ...
     */
    public @NonNegative int getRegisteredParties() {
