...
{
    private static final @Positive long serialVersionUID = 8683452581122892189L;

    /**
     * Default initial capacity.
     */
    private static final @Positive int DEFAULT_CAPACITY = 10;
     ...
     */
    private static final @Positive int MAX_ARRAY_SIZE = Integer.MAX_VALUE - 8;
    ...
    private class SubList extends AbstractList<E> implements RandomAccess {
        ...
        SubList(AbstractList<E> parent,
        		@NonNegative int offset, @NonNegative int fromIndex, @NonNegative int toIndex) {
            this.parent = parent;
    ...
    static final class ArrayListSpliterator<E> implements Spliterator<E> {
        ...
        private @NonNegative int index; // current index, modified on advance/split
        private @GTENegativeOne int fence; // -1 until used; then one past last index
        private int expectedModCount; // initialized when fence set

        /** Create new spliterator covering the given  range */
        ArrayListSpliterator(ArrayList<E> list, @NonNegative int origin, @NonNegative int fence,
