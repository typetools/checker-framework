...
class MethodType implements java.io.Serializable {
     ...
     */
    public static
    MethodType genericMethodType(@NonNegative int objectArgCount, boolean finalArray) {
        MethodType mt;
     ...
     */
    public MethodType changeParameterType(@NonNegative int num, Class<?> nptype) {
     ...
     */
    public MethodType insertParameterTypes(@NonNegative int num, Class<?>... ptypesToInsert) {
     ...
     * @throws NullPointerException if {@code ptypesToInsert} or any of its elements is null
     */
    public MethodType insertParameterTypes(@NonNegative int num, List<Class<?>> ptypesToInsert) {
     ...
     *                                  or if {@code start} is greater than {@code end}
     */
    public MethodType dropParameterTypes(@NonNegative int start, @NonNegative int end) {
        int len = ptypes.length;
        if (!(0 <= start && start <= end && end <= len))
            throw newIndexOutOfBoundsException("start="+start+" end="+end);
     ...
     * @throws IndexOutOfBoundsException if {@code num} is not a valid index into {@code parameterArray()}
     */
    public Class<?> parameterType(@NonNegative int num) {
        return ptypes[num];
    }
    /**
     ...
     */
    public @NonNegative int parameterCount() {
