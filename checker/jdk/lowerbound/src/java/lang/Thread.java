...
class Thread implements Runnable {
   ...
   /**
     ...
     *          cleared when this exception is thrown.
     */
    public static void sleep(long millis, @NonNegative int nanos)
    throws InterruptedException {
        if (millis < 0) {
     ...
     */
    public static @NonNegative int activeCount() {
     ...
     */
    public static @NonNegative int enumerate(Thread tarray[]) {
     ...
     *          cleared when this exception is thrown.
     */
    public final synchronized void join(long millis, @NonNegative int nanos)
    throws InterruptedException {
