...
public class PrintWriter extends Writer {
     ...
     * @param len Number of characters to write
     */
    public void write(String s, @NonNegative int off, @NonNegative int len) {
        try {
            synchronized (lock) {
                ensureOpen();
                out.write(s, off, len);
     ...
     * @since  1.5
     */
    public PrintWriter append(CharSequence csq, @NonNegative int start, @NonNegative int end) {
