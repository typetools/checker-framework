...
//    }
     ...
     */
    public static @SearchIndex("#1") int binarySearch(long[] a, long key) {
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(long[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   long key) {
        rangeCheck(a.length, fromIndex, toIndex);
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(int[] a, int key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(int[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   int key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
    ...
    // Like public version, but without range checks.
    private static @SearchIndex("#1") int binarySearch0(int[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                     int key) {
        int low = fromIndex;
        int high = toIndex - 1;
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(short[] a, short key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(short[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   short key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(char[] a, char key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(char[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   char key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(byte[] a, byte key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(byte[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   byte key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(double[] a, double key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(double[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   double key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     *         and only if the key is found.
     */
    public static @SearchIndex("#1") int binarySearch(float[] a, float key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(float[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   float key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     */
    public static @SearchIndex("#1") int binarySearch(Object[] a, Object key) {
        return binarySearch0(a, 0, a.length, key);
    }
     ...
     * @since 1.6
     */
    public static @SearchIndex("#1") int binarySearch(Object[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
                                   Object key) {
        rangeCheck(a.length, fromIndex, toIndex);
        return binarySearch0(a, fromIndex, toIndex, key);
    }
     ...
     */
    public static <T> @SearchIndex("#1") int binarySearch(T[] a, T key, Comparator<? super T> c) {
     ...
     * @since 1.6
     */
    public static <T> @SearchIndex("#1") int binarySearch(T[] a,  @IndexFor("#1") int fromIndex, @IndexOrHigh("#1") int toIndex,
