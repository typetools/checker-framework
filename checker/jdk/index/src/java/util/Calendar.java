...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar> {
     ...
     */
    public final static @IntVal(0) int ERA = 0;

    /**
     * Field number for <code>get</code> and <code>set</code> indicating the
     * year. This is a calendar-specific value; see subclass documentation.
     */
    public final static @IntVal(1) int YEAR = 1;
     ...
     * @see #UNDECIMBER
     */
    public final static @IntVal(2) int MONTH = 2;
     ...
     */
    public final static @IntVal(3) int WEEK_OF_YEAR = 3;
     ...
     * @see #getMinimalDaysInFirstWeek
     */
    public final static @IntVal(4) int WEEK_OF_MONTH = 4;
     ...
     * @see #DAY_OF_MONTH
     */
    public final static @IntVal(5) int DATE = 5;
     ...
     * @see #DATE
     */
    public final static @IntVal(5) int DAY_OF_MONTH = 5;

    /**
     * Field number for <code>get</code> and <code>set</code> indicating the day
     * number within the current year.  The first day of the year has value 1.
     */
    public final static @IntVal(6) int DAY_OF_YEAR = 6;
     ...
     * @see #SATURDAY
     */
    public final static @IntVal(7) int DAY_OF_WEEK = 7;
     ...
     * @see #WEEK_OF_MONTH
     */
    public final static @IntVal(8) int DAY_OF_WEEK_IN_MONTH = 8;
     ...
     * @see #HOUR
     */
    public final static @IntVal(9) int AM_PM = 9;
     ...
     * @see #HOUR_OF_DAY
     */
    public final static @IntVal(10) int HOUR = 10;
     ...
     * @see #HOUR
     */
    public final static @IntVal(11) int HOUR_OF_DAY = 11;
     ...
     */
    public final static @IntVal(12) int MINUTE = 12;
     ...
     */
    public final static @IntVal(13) int SECOND = 13;
     ...
     */
    public final static @IntVal(14) int MILLISECOND = 14;
     ...
     */
    public final static @IntVal(15) int ZONE_OFFSET = 15;
     ...
     */
    public final static @IntVal(16) int DST_OFFSET = 16;

    /**
     * The number of distinct fields recognized by <code>get</code> and <code>set</code>.
     * Field numbers range from <code>0..FIELD_COUNT-1</code>.
     */
    public final static @IntVal(17) int FIELD_COUNT = 17;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Sunday.
     */
    public final static @IntVal(1) int SUNDAY = 1;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Monday.
     */
    public final static @IntVal(2) int MONDAY = 2;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Tuesday.
     */
    public final static @IntVal(3) int TUESDAY = 3;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Wednesday.
     */
    public final static @IntVal(4) int WEDNESDAY = 4;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Thursday.
     */
    public final static @IntVal(5) int THURSDAY = 5;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Friday.
     */
    public final static @IntVal(6) int FRIDAY = 6;

    /**
     * Value of the {@link #DAY_OF_WEEK} field indicating
     * Saturday.
     */
    public final static @IntVal(7) int SATURDAY = 7;

    /**
     * Value of the {@link #MONTH} field indicating the
     * first month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(0) int JANUARY = 0;

    /**
     * Value of the {@link #MONTH} field indicating the
     * second month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(1) int FEBRUARY = 1;

    /**
     * Value of the {@link #MONTH} field indicating the
     * third month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(2) int MARCH = 2;

    /**
     * Value of the {@link #MONTH} field indicating the
     * fourth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(3) int APRIL = 3;

    /**
     * Value of the {@link #MONTH} field indicating the
     * fifth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(4) int MAY = 4;

    /**
     * Value of the {@link #MONTH} field indicating the
     * sixth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(5) int JUNE = 5;

    /**
     * Value of the {@link #MONTH} field indicating the
     * seventh month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(6) int JULY = 6;

    /**
     * Value of the {@link #MONTH} field indicating the
     * eighth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(7) int AUGUST = 7;

    /**
     * Value of the {@link #MONTH} field indicating the
     * ninth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(8) int SEPTEMBER = 8;

    /**
     * Value of the {@link #MONTH} field indicating the
     * tenth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(9) int OCTOBER = 9;

    /**
     * Value of the {@link #MONTH} field indicating the
     * eleventh month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(10) int NOVEMBER = 10;

    /**
     * Value of the {@link #MONTH} field indicating the
     * twelfth month of the year in the Gregorian and Julian calendars.
     */
    public final static @IntVal(11) int DECEMBER = 11;
     ...
     */
    public final static @IntVal(12) int UNDECIMBER = 12;

    /**
     * Value of the {@link #AM_PM} field indicating the
     * period of the day from midnight to just before noon.
     */
    public final static @IntVal(0) int AM = 0;

    /**
     * Value of the {@link #AM_PM} field indicating the
     * period of the day from noon to just before midnight.
     */
    public final static @IntVal(1) int PM = 1;
