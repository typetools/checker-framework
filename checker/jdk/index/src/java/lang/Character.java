...
class Character implements java.io.Serializable, Comparable<Character> {
    ...
    * Strong bidirectional character type "AL" in the Unicode specification.
     ...
     * @since  1.5
     */
    public static int codePointAt(CharSequence seq, @NonNegative /*!IndexFor("#1")*/ int index) {
     ...
     * @since  1.5
     */
    public static @NonNegative int codePointCount(CharSequence seq, @NonNegative /*!IndexOrHigh("#1")*/ int beginIndex, @NonNegative /*!IndexOrHigh("#1")*/ int endIndex) {
     ...
     * @since 1.5
     */
    public static int offsetByCodePoints(CharSequence seq, @NonNegative /*!IndexOrHigh("#1")*/ int index,
                                         int codePointOffset) {
        int length = seq.length();
