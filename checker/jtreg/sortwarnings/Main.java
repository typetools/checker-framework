 ...
 * The first compilation below tests that the errors are ordered by line/column number.  The second line tests that the errors at the same line/column are sorted in order of checker; hence, -Anomsgtext is not passed so that -AshowSuppressWarningKeys has an effect.
 *
