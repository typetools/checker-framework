...
\item[\code{@\refclass{checker/igj/quals}{Immutable}}]
...
\item[\code{@\refclass{checker/igj/quals}{I}}]
...
explicitly marked with \code{@\refclass{checker/igj/quals}{Assignable}} are
...
\item Templating over Immutability: The annotation \code{@\refclass{checker/igj/quals}{I}(\emph{id})} is used to template
...
\code{@\refclass{checker/igj/quals}{I}} is a template annotation over IGJ Immutability annotations. It acts
similarly to type variables in Java's generic types, and the name
\code{@\refclass{checker/igj/quals}{I}} mimics the standard \code{<I>} type variable name used in code
written in the original IGJ dialect.  The annotation value string is used
to distinguish between multiple instances of \code{@\refclass{checker/igj/quals}{I}} --- in the
...
A class declaration annotated with \code{@\refclass{checker/igj/quals}{I}} can then be
used with any IGJ Immutability annotation.  The actual immutability that
\code{@\refclass{checker/igj/quals}{I}} is resolved to dictates the immutability type for all the non-static
appearances of \code{@\refclass{checker/igj/quals}{I}} with the same value as the class declaration.
...
In the last example, \code{@\refclass{checker/igj/quals}{I}} was resolved to \code{@\refclass{checker/igj/quals}{Mutable}} for the instance file.
...
in immutability, otherwise \code{@\refclass{checker/igj/quals}{I}} is resolved to \code{@\refclass{checker/igj/quals}{ReadOnly}}:

\begin{Verbatim}
  static @I Point getMidpoint(@I Point p1, @I Point p2) { ... }
\end{Verbatim}

The \code{@\refclass{checker/igj/quals}{I}} annotation value distinguishes between \code{@\refclass{checker/igj/quals}{I}}
