...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-1.8.9/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-1.8.9
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-1.8.9\
...
The \code{-source 6 -target 6} compiler argument is optional, if you use Java 6 in
ordinary compilation when not performing pluggable type-checking (see
Section~\refwithpage{annotations-in-java7-class-files}).
...
If you fork the compilation task, \href{http://www.gradle.org/}{Gradle}
...
\href{https://github.com/reprogrammer/cascade/wiki/Installation}{Cascade}~\cite{VakilianPEJ2014}
