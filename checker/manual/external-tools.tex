...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-2.0.0/checker/bin} to your path, \emph{before} any other
...
If you use the
\href{http://developer.android.com/tools/building/plugin-for-gradle.html}{Android plugin for Gradle},
then you can run a checker by following the instructions below.
