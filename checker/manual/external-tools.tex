...
\begin{enumerate}
\item Add the checker framework libraries to your project's library. To do so, 
...
and click "OK" to add.
\end{enumerate}
The selected checker should be run on the project either on a save (if Compile on Save is enabled), or when the project is built, and annotations will appear in the editor. 
