...
%   export CLASSPATH=$JSR308/checker-framework/checkers/dist/checker.jar:${CLASSPATH}
...
\begin{Verbatim}
  ...
  java -jar C:%CHECKERS%\dist\checker.jar -version
\end{Verbatim}
...
\begin{Verbatim}
  ...
  <presetdef name="jsr308.javac">
    <javac fork="yes" executable="${checkers}/bin/${cfJavac}" >
...
\code{compile.options.fork.executable = "\$CHECKERS/bin/javac"}
...
allprojects {
  tasks.withType(JavaCompile).all { JavaCompile compile ->
    ...
    options.fork = true
    options.forkOptions.executable = "$CHECKERS/bin/javac"
  }
}
\end{Verbatim}
