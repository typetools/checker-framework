...
\item Android pluging for Gradle (Section~\ref{android-gradle})
...
If you use \href{http://developer.android.com/tools/building/plugin-for-gradle.html}{Android plugin for Gradle},
then you can run a checker by following the instructions below.
...
if (typecheck) {
    gradle.projectsEvaluated {
        ...
        compile.options.compilerArgs = [
            ...
            compile.options.compilerArgs += ['-source', '7', '-target', '7']
            options.bootClasspath = "${configurations.checkerFrameworkJavac.asPath}:"
