...
\begin{itemize}
  \item
    Option 1:
    Add directory
    \code{.../checker-framework-1.9.0/checker/bin} to your path, \emph{before} any other
...
\begin{Verbatim}
  export CHECKERFRAMEWORK=${HOME}/checker-framework-1.9.0
...
\begin{Verbatim}
  ...
  # Windows
  set CHECKERFRAMEWORK = C:\Program Files\checker-framework-1.9.0\
...
\subsection{Eclipse plug-in for the Checker Framework\label{eclipse-plug-in}}
