...
\item \code{[too.many.int.values] The maximum number of integer arguments permitted is 10.}

  Similar to above, but with \<@IntVal> annotations.

\item \code{[too.narrow.int.range] The smallest interval of integer range permitted is 10.}

  Vice versa.

\item \code{[from.greater.than.to] The integer range specified is abnormal.}
