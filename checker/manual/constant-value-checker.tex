...
\refqualclass{common/value/qual}{IntVal} for integral types and
...
\item \code{[too.many.int.values] The maximum number of integer arguments permitted is 10. Remove the annotation. Treating result as @IntRange.}
