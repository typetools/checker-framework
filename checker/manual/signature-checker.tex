...
\item[\refqualclass{checker/signature/qual}{FullyQualifiedName}]
  A \emph{fully qualified name} (\href{https://docs.oracle.com/javase/specs/jls/se7/html/jls-6.html#jls-6.7}{JLS \S
    6.7}), such as
  \<package.Outer.Inner>, is used in Java code and in messages to
  the user.

\item[\refqualclass{checker/signature/qual}{BinaryName}]
  A \emph{binary name} (\href{https://docs.oracle.com/javase/specs/jls/se7/html/jls-13.html#jls-13.1}{JLS \S 13.1}), such as
...
\item[\refqualclass{checker/signature/qual}{FieldDescriptor}]
  A \emph{field descriptor} (\href{https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3.2}{JVMS \S 4.3.2}), such as
  ...
  arrays, and uses internal form (\href{https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.2.1}{JVMS \S 4.2}) for class names.
...
\begin{sloppypar}
  ...
  format like the \href{https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3.2}{FieldDescriptor field descriptor}, but using
...
\item[\refqualclass{checker/signature/qual}{MethodDescriptor}]
  A \emph{method descriptor} (\href{https://docs.oracle.com/javase/specs/jvms/se7/html/jvms-4.html#jvms-4.3.3}{JVMS \S
