...
\item[\refqualclass{checker/signature/quals}{FullyQualifiedName}]
...
\item[\refqualclass{checker/signature/quals}{BinaryName}]
...
\item[\refqualclass{checker/signature/quals}{FieldDescriptor}]
...
\item[\refqualclass{checker/signature/quals}{ClassGetName}]
\begin{sloppypar}
  ...
  format like the \ahref{\jvmsfielddescriptorurl}{FieldDescriptor field descriptor}, but using
  ``\<.>''~where the field descriptor uses ``\</>''.
\end{sloppypar}

\item[\refqualclass{checker/signature/quals}{SourceName}]
...
\item[\refqualclass{checker/signature/quals}{MethodDescriptor}]
