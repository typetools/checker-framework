...
\item \<-AuseDefaultsForUncheckedCode>
  Enables/disables unchecked code defualts.  Takes an argument ``source,bytecode''. 
  ``-source,-bytecode'' is the default setting.
  ``bytecode'' specifies
  whether the checker should use unchecked code defaults for unannotated
  bytecode; see
  ...
  default annotations are used in sourcecode and suppress all type-checking warnings; see
