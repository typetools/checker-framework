...
\item Use the provided \code{@\refclass{checker/fenum/quals}{Fenum}} annotation, which takes a
...
\item
If your code uses the \code{@\refclass{checker/fenum/quals}{Fenum}} annotation, you do
