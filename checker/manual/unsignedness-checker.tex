...
\begin{itemize}
    ...
    operand.
    \item   
    Signed right shift ( \begin{Verbatim}>>\end{Verbatim} ) with an \code{@Unsigned} left operand.
    \item   
    Unsigned right shift ( \begin{Verbatim}>>>\end{Verbatim} ) with a \code{@Signed} left operand.
    \item   
