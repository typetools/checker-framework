...
annotations, e.g., literals are implicitly considered \refqualclass{checker/nullness/quals}{NonNull}) via
the \refqualclass{checker/quals}{ImplicitFor} meta-annotation, and other features such as
...
It serves the same purpose as the \refqualclass{checker/quals}{TypeQualifiers}
