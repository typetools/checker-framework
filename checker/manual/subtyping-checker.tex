...
\item
\code{-Aquals}: This option specifies a list of the fully-qualified class names
...
\item
\code{-AqualDirs}: this option specifies a colon-no-space-separated list of
...
% LocalWords:  TODO ImplicitFor Aquals sourcepath java NonNull
