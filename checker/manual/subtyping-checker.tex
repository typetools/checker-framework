...
annotations, e.g., literals are implicitly considered \code{@\refclass{checker/nullness/quals}{NonNull}}) via
the \code{@\refclass{checker/quals}{ImplicitFor}} meta-annotation, and other features such as
...
It serves the same purpose as the \code{@\refclass{checker/quals}{TypeQualifiers}}
