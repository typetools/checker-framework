...
\item
Set Up Checker Framework (replace [mychecker] with the name of your checker)
\begin{enumerate}
\item Add a folder \<\$>JSR308/checker-framework/checker/jdk/[mychecker]


\item In  \<\$>JSR308/checker-framework/checker/jdk/[mychecker] add a symbolic link to   \newline
\<\$>JSR308/checker-framework/checker/jdk/MakeFile (like the ones in lock and nullness)


\item Add(in 2 places) [mychecker] to \<\$>JSR308/checker-framework/checker/jdk/MakeFile

Line: ''CHECKER\<\_>DIRS = nullness lock'' etc \newline
	Becomes: ''CHECKER\<\_>DIRS = nullness lock [mychecker]'' etc \newline


Line: ANNOTATED\<\_>CLASSES = \ \newline
	\<\$>(patsubst nullness/build/\<\%>.class,annotated/\<\%>.class, \ \newline
      \<\$>(patsubst lock/build/\<\%>.class,annotated/\<\%>.class, \ \newline
          \<\$>(ANNOTATED\<\_>CLASSES\<\_>BY\<\_>DIR))) \newline \newline
	Becomes:ANNOTATED\<\_>CLASSES = \ \newline
	\<\$>(patsubst nullness/build/\<\%>.class,annotated/\<\%>.class, \ \newline
     \<\$>(patsubst lock/build/\<\%>.class,annotated/\<\%>.class, \ \newline
...
Add your Annotated Files \newline
	As you add annotations to the jdk copy annotated files into the folder \<\$>JSR308/checker-framework/checker/jdk/[mychecker]/src
