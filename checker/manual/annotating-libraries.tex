...
%   (versions 5.2 and 6.0 pre-release),
...
\item
  ...
  does not handle nested classes declarations.  To work around this, it permits a
...
\item
  ...
  \begin{Verbatim}
   ...
   \end{Verbatim}
\item
   Annotations on types that are inner classes must written before the package on the
   fully annotated type or before the inner class name. For example,
...
%%  LocalWords:  TypeSystem2 TypeSystem3
