...
These sections illustrate stub classes via the example of creating a \code{@\refclass{checker/interning/quals}{Interned}}-annotated
...
\item
  Annotations can only use string or boolean literals; other literals are not 
  yet supported.
\end{itemize}
...
\code{java -jar \$CHECKERS/dist/checker.jar} both use the appropriate jdk6.jar or jdk7.jar
