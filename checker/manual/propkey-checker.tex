...
The annotation \code{@\refclass{checker/propkey/quals}{PropertyKey}}
...
\begin{enumerate}
\item \code{@\refclass{checker/i18n/quals}{Localized}}: indicates that the qualified
\code{String} is a message that has been localized and/or formatted with
respect to the used locale.

\item \code{@\refclass{checker/i18n/quals}{LocalizableKey}}: indicates that the
...
\code{@\refclass{checker/compilermsgs/quals}{CompilerMessageKey}}.
