...
\item[\code{@\refclass{checker/javari/qual}{ReadOnly}}]
...
\item[\code{@\refclass{checker/javari/qual}{Mutable}}]
  indicates a mutable type.
  
\item[\code{@\refclass{checker/javari/qual}{Assignable}}]
...
\item[\code{@\refclass{checker/javari/qual}{QReadOnly}}]
...
\item[\code{@\refclass{checker/javari/qual}{PolyRead}}]
  ...
  \code{@\refclass{checker/javari/qual}{PolyRead}} Javadoc for more details.

\item[\code{@\refclass{checker/javari/qual}{ThisMutable}}]
...
marked with \code{@\refclass{checker/javari/qual}{Assignable}} are reassigned, or
