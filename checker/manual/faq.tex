...
situation, the callee has flexibility to do anything to do anything that is
convenient.
...
It is possible to annotate exceptions, and any type-checker built on the
...
% LocalWords:  toolset AbstractCollection ConcurrentHashMap NullnessUtils
...
%%  LocalWords:  featureful RetentionPolicy
