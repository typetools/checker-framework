...
\begin{enumerate}
\item
Annotate the field type as \code{@\refclass{checker/nullness/quals}{MonotonicNonNull}}.
\item
Annotate the method that sets the field as \code{@\refclass{checker/nullness/quals}{EnsuresNonNull}("\emph{myFieldName}")}.
...
\code{@\refclass{checker/nullness/quals}{RequiresNonNull}("\emph{myFieldName}")}.
