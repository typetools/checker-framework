\htmlhr
\chapter{Internationalization Format String Checker (I18n Format String Checker)\label{i18n-format-checker}}
...
\section{Conversion categories\label{i18n-format-conversion-catgeories}}
...
\section{What the Internationalization Format String Checker checks\label{i18n-format-checks}}
...
\begin{itemize}
  ...
  format patterns without loading them from a property file.
    ...
    \code{javac -processor org.checkerframework.checker.i18nformatter.I18nFormatterChecker}
  \code{MyFile.java}
\end{itemize}


\section{Testing whether a string has an i18n format type\label{i18n-format-testing}}
...
%%  LocalWords:  I18n i18n java MessageFormat 6cm I18nFormat I18nFormatFor
%%  LocalWords:  arg I18nInvalid I18nUnknownFormat I18nFormatBottom 8cm '
