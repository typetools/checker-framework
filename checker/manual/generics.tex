...
type to be \emph{covariant} in the type parameter.  Use the \<@\refclass{checker/nullness/quals}{Covariant}> annotation to indicate
this.
...
\<@\refclass{checker/quals}{PolymorphicQualifier}>.  For example,
\<@\refclass{checker/nullness/quals}{PolyNull}> is a polymorphic type
