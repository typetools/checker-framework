...
it incurs a
%% Note: The 50% performance penalty was measured in February 2015 by
...
\sunjavadoc{java/lang/Comparable.html\#compareTo-Object-}{Comparable.compareTo()}
is:
...
% Hevea doesn't find the \newstyle comamnd.  Why?
% \newstyle{.xsmalltabular}{font-size:smaller;}
% then later use: \begin{divstyle}{xsmalltabular}
