...
The SPARTA toolset provides an information-flow type-checker that is
...
The paper 
\ahref{\url{http://homes.cs.washington.edu/~mernst/pubs/infoflow-ccs2014.pdf}}{``Collaborative
