...
\textbf{Tips:}  Before you start coding, first write the user manual (see
Section~\ref{documenting-a checker}), which explains the type system, what
it guarantees, how to use it, etc.  This will help you flesh out your goals
and the concepts, which are easier to understand and change in text than in
an imprementation.  Once you have settled on type rules, you may also want
to choose some case studies and play computer to ensure that they give
the expected results.  During manual checking, ask yourself what reasoning
you applied, what information you needed, and whether your written-down
...
by calling the
\refmethod{framework/util/defaults}{QualifierDefaults}{addCheckedCodeDefault}{-javax.lang.model.element.AnnotationMirror-org.checkerframework.framework.qual.TypeUseLocation-}
...
% LocalWords:  TypeHierarchy GraphQualifierHierarchy ReadOnly Foo qual
...
%%  LocalWords:  IGJAnnotatedTypeFactory CheckerFrameworkTest
