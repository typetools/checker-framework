...
\newcommand{\refqualclass}[2]{\ahref{api/org/checkerframework/#1/#2.html}{\<@#2>}}
...
\newcommand{\sunjavadocanno}[2]{\ahref{http://types.cs.washington.edu/checker-framework/jdk-api/jdk/#1}{\<@#2>}}
