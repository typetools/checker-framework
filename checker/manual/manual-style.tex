...
\newcommand{\sunjavadoc}[2]{\href{http://types.cs.washington.edu/checker-framework/jdk-api/jdk/#1}{\<#2>}}
% Like \sunjavadoc, but for annotations and prepends "@".
\newcommand{\sunjavadocanno}[2]{\href{http://types.cs.washington.edu/checker-framework/jdk-api/jdk/#1}{\<@#2>}}
