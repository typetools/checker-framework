...
\newcommand{\refclass}[2]{\ahref{api/org/checkerframework/#1/#2.html}{\<#2>}}

% Reference to Checker Framework Javadoc for a qualified class
% (not a method, etc.). 
% This function outputs an @ and then relies on \refclass for the
% actual formatting.
\newcommand{\refqualclass}[2]{\code{@}\refclass{#1}{#2}}
...
% In the HTML version, it's a link to the Javadoc.
\newcommand{\refmethod}[4]{\ahref{api/org/checkerframework/#1/#2.html\##3#4}{\<#2.#3>}}
