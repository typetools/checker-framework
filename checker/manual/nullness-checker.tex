...
\code{@\refclass{checker/nullness/quals}{NonNull}} and 
\code{@\refclass{checker/nullness/quals}{Nullable}}.
\code{@\refclass{checker/nullness/quals}{NonNull}} is rarely written, because it is
...
\item
  When an expression of non-\code{@\refclass{checker/nullness/quals}{NonNull}} type
...
\item
  When an expression of \code{@\refclass{checker/nullness/quals}{NonNull}} type
  ...
  As a special case of an of \code{@\refclass{checker/nullness/quals}{NonNull}}
  type becoming null, the checker also warns whenever a field of
  \code{@\refclass{checker/nullness/quals}{NonNull}} type is not initialized in a
...
\item
  ...
  including \code{@\refclass{checker/nullness/quals}{Nullable}} types and primitive
  ...
  that fields of \code{@\refclass{checker/nullness/quals}{NonNull}} type are
...
\item[\code{@\refclass{checker/nullness/quals}{Nullable}}]
...
\item[\code{@\refclass{checker/nullness/quals}{NonNull}}]
...
\item[\code{@\refclass{checker/nullness/quals}{PolyNull}}]
  indicates qualifier polymorphism.  For a description of
  \<@\refclass{checker/nullness/quals}{PolyNull}>, see
  Section~\ref{qualifier-polymorphism}.

\item[\code{@\refclass{checker/nullness/quals}{MonotonicNonNull}}]
  ...
  \code{@\refclass{checker/nullness/quals}{Nullable}}, but when the variable is
  assigned, its type is treated as
  \code{@\refclass{checker/nullness/quals}{NonNull}}.
...
\item[\code{@\refclass{checker/nullness/quals}{RequiresNonNull}}]
...
\item[\code{@\refclass{checker/nullness/quals}{EnsuresNonNull}}]
\item[\code{@\refclass{checker/nullness/quals}{EnsuresNonNullIf}}]
...
\begin{description}
\item[\code{@\refclass{checker/initialization/quals}{Initialized}}]
\item[\code{@\refclass{checker/initialization/quals}{UnknownInitialization}}]
\item[\code{@\refclass{checker/initialization/quals}{UnderInitialization}}]
\end{description}
...
\begin{description}
\item[\code{@\refclass{checker/nullness/quals}{Raw}}]
\item[\code{@\refclass{checker/nullness/quals}{NonRaw}}]
\item[\code{@\refclass{checker/nullness/quals}{PolyRaw}}]
\end{description}
...
% \begin{itemize}
% \item
%   \code{@\refclass{checker/nullness/quals}{Nullable}}:  Unannotated types are regarded as possibly-null, or
...
%   declaration.
% \item
%   \code{@\refclass{checker/nullness/quals}{NonNull}}:  Unannotated types are treated as non-null.
...
%   \code{@\refclass{checker/nullness/quals}{NonNull}}, \emph{except} that the
%   unannotated raw type of a local variable is treated as
%   \code{@\refclass{checker/nullness/quals}{Nullable}}.  (Any generic arguments to a
%   local variable still default to
%   \code{@\refclass{checker/nullness/quals}{NonNull}}.)  This is the standard
...
\code{@\refclass{checker/nullness/quals}{EnsuresNonNullIf}} method annotations.
...
\code{@\refclass{checker/nullness/quals}{EnsuresNonNullIf}}.
...
\item
  Inference of \code{@\refclass{checker/nullness/quals}{Nullable}}:
  %
...
\item
  Inference of \code{@\refclass{checker/nullness/quals}{NonNull}}:
  %
...
%% \item
%%   Use the \code{@\refclass{checker/nullness/quals}{AssertParametersNonNull}}
...
To try the Nullness Checker on a source file that uses the \code{@\refclass{checker/nullness/quals}{NonNull}} qualifier,
...
%
% You can view the annotated source code, which contains \code{@\refclass{checker/nullness/quals}{NonNull}} annotations, in
% the
% %BEGIN LATEX
% \begin{smaller}
% %END LATEX
...
Your goal is to add \code{@\refclass{checker/nullness/quals}{Nullable}} annotations
...
\item
  ...
  \code{@\refclass{checker/nullness/quals}{Nullable}} or a
  \code{@\refclass{checker/nullness/quals}{MonotonicNonNull}} annotation.  If the field
...
\item
    ...
    such as \code{@\refclass{checker/nullness/quals}{RequiresNonNull}} (see Section~\ref{nullness-method-annotations}.
\end{itemize}
...
\newcommand{\linktoNonNull}{\code{\refclass{checker/nullness/quals}{NonNull}}}
\newcommand{\linktoNullable}{\code{\refclass{checker/nullness/quals}{Nullable}}}
...
\noindent
When a field \<f> is declared with a \code{@\refclass{checker/nullness/quals}{NonNull}}
...
\item[\code{@\refclass{checker/initialization/quals}{UnknownInitialization}}]
  ...
  \code{@\refclass{checker/nullness/quals}{NonNull}} may be null because the field
...
\item[\code{@\refclass{checker/initialization/quals}{UnderInitialization}}]
  ...
  \code{@\refclass{checker/initialization/quals}{UnderInitialization}} type until
...
\code{@\refclass{checker/nullness/quals}{MonotonicNonNull}}:  when read, they are
treated as being \code{@\refclass{checker/nullness/quals}{Nullable}}, but when
...
\code{this} starts out with \code{@\refclass{checker/initialization/quals}{UnderInitialization}} type.
As soon as all of the \code{@\refclass{checker/nullness/quals}{NonNull}} fields
...
\code{@\refclass{checker/nullness/quals}{EnsuresNonNull}(\{"field1", "field2"\})}
...
When you write \code{@\refclass{checker/initialization/quals}{UnderInitialization}(OtherClass.class) MyClass x;}, that
...
\code{@\refclass{checker/initialization/quals}{UnderInitialization}(\emph{C})}, rather than
treated as simply 
\code{@\refclass{checker/initialization/quals}{Initialized}}.
...
\begin{itemize}
\item
  Declare the field as \code{@\refclass{checker/nullness/quals}{Nullable}}.  Recall
  that if you did not write an annotation, the field defaults to
  \code{@\refclass{checker/nullness/quals}{NonNull}}.
\item
  Declare the field as \code{@\refclass{checker/nullness/quals}{MonotonicNonNull}}.
  This is appropriate if the field starts out as \<null> but is later set
  to a non-null value.  You may then wish to use the
  \code{@\refclass{checker/nullness/quals}{EnsuresNonNull}} annotation to indicate
  which methods set the field, and the
  \code{@\refclass{checker/nullness/quals}{RequiresNonNull}} annotation to indicate
...
\code{@\refclass{checker/initialization/quals}{Initialized}}.  If
...
\code{@\refclass{checker/nullness/quals}{EnsuresNonNull}} as well; see
...
\code{@\refclass{checker/nullness/quals}{RequiresNonNull}},
\code{@\refclass{checker/nullness/quals}{EnsuresNonNull}}, and
\code{@\refclass{checker/nullness/quals}{EnsuresNonNullIf}} method annotations;
...
\code{@\refclass{checker/initialization/quals}{Initialized}},
\code{@\refclass{checker/initialization/quals}{UnknownInitialization}}, and
\code{@\refclass{checker/initialization/quals}{UnderInitialization}}.
The other uses the two annotations
\code{@\refclass{checker/nullness/quals}{Raw}} (which corresponds to \code{@UnknownInitialization}) and
\code{@\refclass{checker/nullness/quals}{NonRaw}} (which corresponds to \code{@Initialized}).
...
field is declared with a \code{@\refclass{checker/nullness/quals}{NonNull}} type.
However, this guarantee does not hold for a partially-initialized object.

The Nullness Checker uses the \code{@\refclass{checker/nullness/quals}{Raw}} annotation to indicate that an object
...
\item[\code{@\refclass{checker/nullness/quals}{Raw}}]
  ...
  \code{this} has \code{@\refclass{checker/nullness/quals}{Raw}} type until all
...
Within the constructor,
\code{this} starts out with \code{@\refclass{checker/nullness/quals}{Raw}} type.
As soon as all of the \code{@\refclass{checker/nullness/quals}{NonNull}} fields
...
% annotated with \code{@\refclass{checker/nullness/quals}{Raw}}.  Similar
...
When you write \code{@\refclass{checker/nullness/quals}{Raw} MyClass x;}, that
...
When you write \code{@\refclass{checker/nullness/quals}{NonRaw}(Foo.class) MyClass
...
\code{@\refclass{checker/nullness/quals}{NonRaw}(\emph{typeofthis})}, rather than
treated as simply 
\code{@\refclass{checker/nullness/quals}{NonRaw}}.
...
The \code{@\refclass{checker/nullness/quals}{Raw}}
annotation has nothing to do with the raw types of Java Generics.


\section{Map Key Checker\label{map-key-checker}}

The Map Key Checker uses the \code{@\refclass{checker/nullness/quals}{KeyFor}}
...
The \code{@\refclass{checker/nullness/quals}{KeyFor}} annotation states the latter
property.
