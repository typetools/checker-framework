...
\begin{Verbatim}
    ...
    void myMethod() {
      // The programmer knows that this particular call to getObject never returns
      // null, perhaps based on the arguments or the state of other objects.
      @SuppressWarnings("nullness")
...
\begin{Verbatim}
  ...
  // (it would be better to write an assert statement and @AssumeAssertion instead):
