...
\begin{Verbatim}
package org.checkerframework.checker.nullness.quals does not exist
\end{Verbatim}
...
either \code{\$CHECKERFRAMEWORK/checker/bin/javac} or \code{"java -jar \$CHECKERFRAMEWORK/checker/dist/checker.jar"}.
...
libraries appear, for example, at \code{checker/jdk/nullness/src/} for the
Nullness Checker.
...
\myurl{http://types.cs.washington.edu/checker-framework/current/changelog-checkerframework.txt}.
...
%  LocalWords:  FileNotFoundException MyQualifier ImplicitFor A2 A3
