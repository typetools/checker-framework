...
\subsection{Unexpected compilation output when running javac without a
  pluggable type-checker\label{common-problems-running-javac}}
...
Framework.  The following command installs them for Ubuntu 14.04:
...
though note that the \<.travis.yml> files already exist.
...
%  LocalWords:  StaticNestedClass StaticNested ConfusingAnnotation pre IGJ
%%  LocalWords:  CHECKERFRAMEWORK currentOutgoing isCompleted ElementType
%%  LocalWords:  EnsuresNonNull devel javacutil stubparser rsvg Regex OIGJ
