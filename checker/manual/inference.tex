...
supply to javac the command-line option \code{-AperformWholeProgramInference}, then the
...
When performing inference for a program considering a pluggable type system's
