...
Whole-program inference never refines a type to the bottom type of a type
...
\paragraph{Poor whole-program inference results due to non-representative uses}
