...
Signature inference never refines a type to the bottom type of a type hierarchy.
If you want the signature inference to ignore other annotations, you can simply
add the meta-annotation \<@IgnoreInSignatureInference> to each of them.
