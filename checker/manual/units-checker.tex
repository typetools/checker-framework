...
\begin{description}
\item[\code{@\refclass{checker/units/quals}{Area}}]

\item[\code{@\refclass{checker/units/quals}{Current}}]

\item[\code{@\refclass{checker/units/quals}{Length}}]

\item[\code{@\refclass{checker/units/quals}{Luminance}}]

\item[\code{@\refclass{checker/units/quals}{Mass}}]

\item[\code{@\refclass{checker/units/quals}{Speed}}]

\item[\code{@\refclass{checker/units/quals}{Substance}}]

\item[\code{@\refclass{checker/units/quals}{Temperature}}]

\item[\code{@\refclass{checker/units/quals}{Time}}]
\end{description}
...
\item For \code{@Area}:
  the derived units
  square millimeters \code{@\refclass{checker/units/quals}{mm2}},
  square meters \code{@\refclass{checker/units/quals}{m2}}, and
  square kilometers \code{@\refclass{checker/units/quals}{km2}}

\item For \code{@Current}:
  Ampere \code{@\refclass{checker/units/quals}{A}}

\item For \code{@Length}:
  Meters \code{@\refclass{checker/units/quals}{m}}
  and the derived units
  millimeters \code{@\refclass{checker/units/quals}{mm}} and
  kilometers \code{@\refclass{checker/units/quals}{km}}

\item For \code{@Luminance}:
  Candela \code{@\refclass{checker/units/quals}{cd}}

\item For \code{@Mass}:
  kilograms \code{@\refclass{checker/units/quals}{kg}}
  and the derived unit
  grams \code{@\refclass{checker/units/quals}{g}}

\item For \code{@Speed}:
  meters per second \code{@\refclass{checker/units/quals}{mPERs}} and
  kilometers per hour \code{@\refclass{checker/units/quals}{kmPERh}}

\item For \code{@Substance}:
  Mole \code{@\refclass{checker/units/quals}{mol}}

\item For \code{@Temperature}:
  Kelvin \code{@\refclass{checker/units/quals}{K}}
  and the derived unit
  Celsius \code{@\refclass{checker/units/quals}{C}}

\item For \code{@Time}:
  seconds \code{@\refclass{checker/units/quals}{s}}
  and the derived units
  minutes \code{@\refclass{checker/units/quals}{min}} and
  hours \code{@\refclass{checker/units/quals}{h}}
\end{enumerate}


You may specify SI unit prefixes, using enumeration \code{\refclass{checker/units/quals}{Prefix}}.
The basic SI units
