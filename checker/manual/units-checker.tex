...
\begin{description}
\item[\refqualclass{checker/units/quals}{Area}]

\item[\refqualclass{checker/units/quals}{Current}]

\item[\refqualclass{checker/units/quals}{Length}]

\item[\refqualclass{checker/units/quals}{Luminance}]

\item[\refqualclass{checker/units/quals}{Mass}]

\item[\refqualclass{checker/units/quals}{Speed}]

\item[\refqualclass{checker/units/quals}{Substance}]

\item[\refqualclass{checker/units/quals}{Temperature}]

\item[\refqualclass{checker/units/quals}{Time}]
\end{description}
...
\item For \code{@Area}:
  the derived units
  square millimeters \refqualclass{checker/units/quals}{mm2},
  square meters \refqualclass{checker/units/quals}{m2}, and
  square kilometers \refqualclass{checker/units/quals}{km2}

\item For \code{@Current}:
  Ampere \refqualclass{checker/units/quals}{A}

\item For \code{@Length}:
  Meters \refqualclass{checker/units/quals}{m}
  and the derived units
  millimeters \refqualclass{checker/units/quals}{mm} and
  kilometers \refqualclass{checker/units/quals}{km}

\item For \code{@Luminance}:
  Candela \refqualclass{checker/units/quals}{cd}

\item For \code{@Mass}:
  kilograms \refqualclass{checker/units/quals}{kg}
  and the derived unit
  grams \refqualclass{checker/units/quals}{g}

\item For \code{@Speed}:
  meters per second \refqualclass{checker/units/quals}{mPERs} and
  kilometers per hour \refqualclass{checker/units/quals}{kmPERh}

\item For \code{@Substance}:
  Mole \refqualclass{checker/units/quals}{mol}

\item For \code{@Temperature}:
  Kelvin \refqualclass{checker/units/quals}{K}
  and the derived unit
  Celsius \refqualclass{checker/units/quals}{C}

\item For \code{@Time}:
  seconds \refqualclass{checker/units/quals}{s}
  and the derived units
  minutes \refqualclass{checker/units/quals}{min} and
  hours \refqualclass{checker/units/quals}{h}
\end{enumerate}
