...
\begin{itemize}
\item
  \code{@\refclass{checker/tainting/quals}{Untainted}} indicates
  a type that includes only untainted, trusted values.
\item
  \code{@\refclass{checker/tainting/quals}{Tainted}} indicates
  a type that may include only tainted, untrusted values.
  \code{@Tainted} is a supertype of \code{@Untainted}.
\item
  \code{@\refclass{checker/tainting/quals}{PolyTainted}} is a qualifier that is
