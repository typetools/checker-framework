...
\begin{itemize}
\item
  \refqualclass{checker/tainting/quals}{Untainted} indicates
  a type that includes only untainted, trusted values.
\item
  \refqualclass{checker/tainting/quals}{Tainted} indicates
  a type that may include only tainted, untrusted values.
  \code{@Tainted} is a supertype of \code{@Untainted}.
\item
  \refqualclass{checker/tainting/quals}{PolyTainted} is a qualifier that is
