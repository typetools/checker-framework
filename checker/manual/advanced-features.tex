...
try-with-resources construct, variables in for statements, etc.)
...
\item \refqualclass{checker/nullness/qual}{AssertNonNullIfNonNull}
\end{itemize}
...
%  LocalWords:  formatter ocals nstanceof plicit ounds
