...
\section{Whole-program type inference using .jaif files\label{jaif-inference}}
...
This folder contains annotated files for the target project passed as argument.

Example of usage for the Constant Value Checker (Section~\ref{constant-value-checker}):
\begin{Verbatim}
...
Instead of using this script, you are also able to generate .jaif files that
contain inferred types during the type-checking process. To do that, supply
the \code{-auseJaifInference} command-line option to javac.
