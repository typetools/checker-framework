...
the \<-AsafeDefaultsForUnannotatedBytecode>
command-line option will no longer exist.)
...
% TODO: document
% the \refqualclass{framework/qual}{DefaultForUncheckedCode}
% and \refqualclass{framework/qual}{DefaultQualifierInHierarchyForUncheckedCode}
