...
\item
  Use \code{@\refclass{framework/qual}{Unqualified}}, which the framework
...
The end-user programmer specifies a default qualifier by writing the \code{@\refclass{framework/qual}{DefaultQualifier}}
annotation on a package, class, method, or variable declaration.  The
argument to \<@\refclass{framework/qual}{DefaultQualifier}> is the \code{String}
...
\<@\refclass{framework/qual}{DefaultQualifier}> annotations at a single location,
use
\<@\refclass{framework/qual}{DefaultQualifiers}> instead.  For example:
...
\code{@\refclass{checker/nullness/qual}{NonNull}}.  That means that when a user
...
\<\code{@\refclass{checker/nullness/qual}{Nullable}}> is the top qualifier in the
...
\code{@\refclass{framework/qual}{DefaultQualifier}} annotation; see
...
The checker treats a variable or expression as \code{@\refclass{checker/nullness/qual}{NonNull}}
\begin{itemize}
\item
...
treated as a \code{@\refclass{checker/nullness/qual}{NonNull}} one.  The inference never treats a variable as
a supertype of its declared type (e.g., an expression of \code{@\refclass{checker/nullness/qual}{NonNull}}
...
The \code{@\refclass{dataflow/qual}{TerminatesExecution}} annotation
...
\code{@\refclass{checker/nullness/qual}{EnsuresNonNull}}.
...
Usually, you only need to use \code{@\refclass{dataflow/qual}{SideEffectFree}}.


\begin{description}

\item[\code{@\refclass{dataflow/qual}{SideEffectFree}}]
  indicates that the method has no (visible) side effects.

\item[\code{@\refclass{dataflow/qual}{Deterministic}}]
  indicates that if the method is called multiple times with the same
  arguments, then it returns the same result.

\item[\code{@\refclass{dataflow/qual}{Pure}}]
...
\noindent
(where \code{@\refclass{dataflow/qual}{Pure}} means both
\code{@\refclass{dataflow/qual}{SideEffectFree}} and
\code{@\refclass{dataflow/qual}{Deterministic}}).  Every overriding
...
\begin{itemize}
%\item \code{@\refclass{checker/nullness/qual}{KeyFor}}
\item \code{@\refclass{framework/qual}{RequiresQualifier}}
\item \code{@\refclass{framework/qual}{EnsuresQualifier}}
\item \code{@\refclass{framework/qual}{EnsuresQualifierIf}}
\item \code{@\refclass{checker/nullness/qual}{RequiresNonNull}}
\item \code{@\refclass{checker/nullness/qual}{EnsuresNonNull}}
\item \code{@\refclass{checker/nullness/qual}{EnsuresNonNullIf}}
\item \code{@\refclass{checker/nullness/qual}{EnsuresNonNullIf}}
\end{itemize}
...
%  \code{@\refclass{checker/nullness/qual}{KeyFor}}.  Write the variable name.  For
%  example: \<myLocalVar>.
\item
...
the \code{@\refclass{framework/qual}{Unused}} annotation
...
% \code{@\refclass{framework/qual}{Dependent}} annotation.
...
% hierarchies.
% 
% When the \code{@\refclass{framework/qual}{Unused}} annotation is sufficient, you
% should use it instead of \code{@Dependent}.
% 
% Here is a restatement of the example of Section~\ref{unused-fields}, using
% \code{@\refclass{framework/qual}{Dependent}}:
% 
% \begin{Verbatim}
% @interface Mammal { }
% @interface Marsupial { }
