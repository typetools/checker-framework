...
\item
  ...
  interface, or from two interfaces.  The inheritance mechanism would need
  to compute the greatest lower bound in the type system of all annotations
  on supertypes, or an error would be thrown if no such annotations existed.
