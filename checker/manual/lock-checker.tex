...
\item[\code{@\refclass{checker/lock/quals}{GuardedBy}}]
...
\item[\code{@\refclass{checker/lock/quals}{Holding}}]
...
\code{@\refclass{checker/lock/quals}{Holding}}, and it generalizes the 
\code{@\refclass{checker/lock/quals}{GuardedBy}} annotation into a type qualifier
