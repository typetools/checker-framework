...
\item[\refqualclass{checker/lock/qual}{GuardedByInaccessible}]
  ...
  \code{@GuardedByInaccessible}.  In particular, if it is written on a
...
\item[\code{@GuardSatisfied}]
  ...
  \<@GuardedByInaccessible> is not assignable to \<@GuardSatisfied>,
...
% LocalWords:  invokeinterface threadsafety Clang's GuardedByInaccessible
