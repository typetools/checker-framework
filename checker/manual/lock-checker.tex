...
$\Rightarrow$
\begin{tabular}{l}
 ~org.checkerframework.checker.lock.qual.GuardedBy (Fields)~ \\
 ~org.checkerframework.checker.lock.qual.Holding (Methods)~
\end{tabular}
\end{tabular}
\end{center}
%BEGIN LATEX
...
annotations on fields or as declaration annotations on methods.
The Checker Framework interprets them according to the right
