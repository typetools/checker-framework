...
\item[\code{@GuardSatisfied}]
  ...
  Given a method with a formal parameter with primary type annotation \<@GuardSatisfied(index)>,
  ...
  primary annotation \<@GuardSatisfied(index)>, the Lock Checker ensures that for all \<@GuardSatisfied> annotations
  ...
  \<@GuardSatisfied> may not be used on formal parameters, receivers or return types
  of a method annotated with @MayReleaseLocks
\end{description}
