...
\item[\code{@\refclass{checker/interning/quals}{Interned}}]
  indicates a type that includes only interned values (no non-interned
  values).

\item[\<@\refclass{checker/interning/quals}{PolyInterned}>]
  indicates qualifier polymorphism.  For a description of
  \<@\refclass{checker/interning/quals}{PolyInterned}>, see
  Section~\ref{qualifier-polymorphism}.

\item[\<@\refclass{checker/interning/quals}{UsesObjectEquals}>]
...
In order to perform checking, you must annotate your code with the \code{@\refclass{checker/interning/quals}{Interned}}
...
\code{@\refclass{checker/interning/quals}{Interned}} unless they are annotated as such, as in
...
Objects of an \code{@\refclass{checker/interning/quals}{Interned}} type may be safely compared using the ``\code{==}''
operator.
...
\item
  ...
  has an operand of non-\code{@\refclass{checker/interning/quals}{Interned}} type.

\item
  When a non-\code{@\refclass{checker/interning/quals}{Interned}} type is used where an \code{@\refclass{checker/interning/quals}{Interned}} type
  is expected.
...
To try the Interning Checker on a source file that uses the \code{@\refclass{checker/interning/quals}{Interned}} qualifier,
...
\code{@\refclass{checker/interning/quals}{Interned}}.
...
\code{@\refclass{checker/interning/quals}{Interned}}.  From directory \code{java},
