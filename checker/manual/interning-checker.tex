...
(\href{https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.5}{JLS
  \S3.10.5}), and the
...
(\href{https://docs.oracle.com/javase/specs/jls/se7/html/jls-5.html#jls-5.1.7}{JLS \S5.1.7}).
...
value, depending on the run-time argument (\href{https://docs.oracle.com/javase/specs/jls/se7/html/jls-5.html#jls-5.1.7}{JLS
