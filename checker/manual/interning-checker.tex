...
\urldef{\jlsboxingurl}{\url}{https://docs.oracle.com/javase/specs/jls/se7/html/jls-5.html#jls-5.1.7}
...
(\ahref{\url{https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.5}}{JLS
  \S3.10.5}), and the
