...
\subsection{Annotations in Java 6 or 7 \code{.class} files\label{java7-class-files}}
...
\subsection{Class-file compatibility with Java 6 or 7\label{java7-classfiles}}
...
To ensure that your program can run on a Java 6 or 7 JVM, you have two options:
...
Eventually, when backward compatibility with Java 6 or 7 is not important, the
