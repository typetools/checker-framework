...
JVM\@.  Sections~\ref{java5-class-files} and~\ref{nullness-java7} discuss this situation.
...
\refqualclass{checker/nullness/compatqual}{MonotonicNullType}, and
...
\refqualclass{checker/nullness/compatqual}{MonotonicNullDecl}, and
