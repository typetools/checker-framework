...
approach is that it produces classfiles that contain no trace of
your type annotations.  This means that you need to compile your entire
application every time you do pluggable type-checking, rather than just
compiling a subset of the files.

Another downside of this approach is that pluggable type-checking is a
...
Suppose you wish to run the Nullness Checker using Java~7
