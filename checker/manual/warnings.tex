...
``\<*Type>'' compatiblity annotations in coments.  For example, the Nullness Checker
...
\item
Use ``\<*Decl>'' compatiblity annotations.  For example, the Nullness Checker
declares these declaration annotations:
