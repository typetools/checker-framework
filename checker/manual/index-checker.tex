...
\item[\refqualclass{checker/upperbound/qual}{UpperBoundUnknown}]
  ...
  This type is the top type. Variables of this type are
  unsafe for use as array indices.
\item[\refqualclass{checker/upperbound/qual}{LessThanLength}(String[] names)]
...
\item[\refqualclass{checker/upperbound/qual}{EqualToLength}(String[] names)]
  The parameter, names, stores a list of array names. A variable with this type
  has value equal to the length of each array listed in names.
\item[\refqualclass{checker/upperbound/qual}{LessThanOrEqualToLength}(String[] names)]
  The parameter, names, stores a list of array names. A variable with this type
