...
\begin{description}
\item[\refqualclass{checker/index/qual}{IndexFor}{String[] names}]
  ...
  Checker's \refqualclass{checker/upperbound/qual}{LTLengthOf}{String[] names}.
 \item[\refqualclass{checker/index/qual}{IndexOrHigh}{String[] names}]
  ...
  \refqualclass{checker/lowerbound/qual}{NonNegative} and the Upper Bound
  Checker's
  \refqualclass{checker/upperbound/qual}{LTEqLengthOf}{String[] names}.
\end{description}
