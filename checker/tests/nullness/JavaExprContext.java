...
public class JavaExprContext {
  ...
  public class nonstaticTestClass {
    ...
    public void buildGraph1(@KeyFor("graphField1.adjList") String hero) {
      ...
      graphField1.addEdge2(hero, graphField1); // Calling a static method from an instance object. Ensuring this doesn't confuse the FlowExpression parsing.
    ...
    public void buildGraph3(staticGraphClass myGraph, @KeyFor("#1.adjList") String hero) {
      ...
      myGraph.addEdge2(hero, myGraph); // Calling a static method from an instance object. Ensuring this doesn't confuse the FlowExpression parsing.
  ...
  public static class staticTestClass {
    ...
    public void buildGraph3(@KeyFor("graphField2.adjList") String hero) {
      ...
      graphField2.addEdge(hero);
      graphField2.addEdge2(hero, graphField2); // Calling a static method from an instance object. Ensuring this doesn't confuse the FlowExpression parsing.
    ...
    public static void buildGraph10(nonstaticGraphClass myGraph, @KeyFor("#1.adjList") String hero) {
      myGraph.addEdge(hero);
      myGraph.addEdge2(hero);
    }
  }
