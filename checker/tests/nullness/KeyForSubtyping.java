...
public class KeyForSubtyping {
    ...
    public void testSubtypeAssignments(String not_a_key,
    ...
    public void testDataFlow(String not_yet_a_key,
                             @KeyFor("this.mapA") String a,
                             @KeyFor("this.mapB") String b,
                             @KeyFor({"this.mapA","this.mapB"}) String ab) {
    ...
    public void testSetOrdering(@KeyFor({"this.mapC","this.mapA"}) String ac,
    ...
    public void testDataflowTransitivity(@KeyFor({"this.mapA"}) String a,
                                         @KeyFor({"this.mapA","this.mapB"}) String ab,
                                         @KeyFor({"this.mapA","this.mapB","this.mapC"}) String abc) {
        ab = abc;
        // At this point, dataflow should have refined the type of ab to @KeyFor({"this.mapA","this.mapB","this.mapC"})
        a = ab;
