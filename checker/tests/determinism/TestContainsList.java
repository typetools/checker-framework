...
public class TestContainsList {
    ...
    void TestList1(@Det ArrayList<@Det Integer> myDetList, @NonDet ArrayList<@NonDet Integer> rand) {
        @Det boolean ret;
        // :: error: (assignment.type.incompatible)
        ret = myDetList.contains(rand);
    }
    ...
    void TestList4(@NonDet Integer elem){
        @NonDet ArrayList<@NonDet Integer> arrL = new
                @NonDet ArrayList<@NonDet Integer>(elem);
    }
