...
class ListSupport {
    ...
    void subList(List<Integer> list, @LessThanLength("list") int index, @LessThanOrEqualToLength("list") int endIndex) {
    ...
    void remove(List<Integer> list, @LessThanLength("list") int index, @LessThanOrEqualToLength("list") int endIndex) {
        int i = index;
        int j = endIndex;
        list.remove(0);
    ...
    void clear(List<Integer> list, @LessThanLength("list") int index, @LessThanOrEqualToLength("list") int endIndex) {
        int i = index;
        int j = endIndex;
        list.clear();
    ...
    void add(List<Integer> list, @LessThanOrEqualToLength("list") int index, @LessThanOrEqualToLength("arr") int arrIndex) {
        int i = index;
        int arri = arrIndex;
