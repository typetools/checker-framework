...
public class RegexUtilTest {
    void fullyQualifiedRegexUtil(String s) {
        if (org.checkerframework.checker.experimental.regex_qual.RegexUtil.isRegex(s, 2)) {
            @Regex(2) String s2 = s;
        }
        @Regex(2) String s2 = org.checkerframework.checker.experimental.regex_qual.RegexUtil.asRegex(s, 2);
    }
    ...
    void fullyQualifiedRegexUtilNoParamsArg(String s) {
        if (org.checkerframework.checker.experimental.regex_qual.RegexUtil.isRegex(s)) {
            @Regex String s2 = s;
            @Regex(0) String s3 = s;
        }
        @Regex String s2 = org.checkerframework.checker.experimental.regex_qual.RegexUtil.asRegex(s);
        @Regex(0) String s3 = org.checkerframework.checker.experimental.regex_qual.RegexUtil.asRegex(s);
    }
