...
class ChapterExamples {
  ...
  void myMethod8(){
    ...
    boolean b2 = compare(p1, p2); // An error is issued indicating that p2 might be dereferenced without "lock" being held. The method call need not be modified, since @GuardedBy({}) <: @GuardedByTop and @GuardedBy("lock") <: @GuardedByTop, but the lock must be acquired prior to the method call.
    //:: error: (contracts.precondition.not.satisfied.field)
...
@LockingFree
boolean compare(@GuardedByTop Object a, @GuardedByTop Object b){ return true; }
...
void myMethod6(){
 ...
 void helper1(@GuardedBy("ChapterExamples.myLock") Object a) {
  ...
  @LockingFree
  void helper3(@GuardedByTop Object c) {
  ...
  void myMethod2(@GuardedBy("ChapterExamples.myLock") Object e) {
    ...
    synchronized (ChapterExamples.myLock) {
      helper2(e);
      helper3(e); // OK, since @GuardedByTop is a supertype of @GuardedBy
