...
record RecordPurityGeneric<A, B>(A a, B b)
{
  ...
  public static String checkNullnessOfFields(RecordPurityGeneric<@Nullable String, @Nullable String> r)
  {
    // :: error: (dereference.of.nullable)
    return r.a.toString() + " " + r.b.toString();
  }

  public static String checkNullnessOfAccessors(RecordPurityGeneric<@Nullable String, @Nullable String> r)
  {
    // :: error: (dereference.of.nullable)
    return r.a().toString() + " " + r.b().toString();
  }
  ...
  public static String checkPurityOfDefaultAccessor(RecordPurityGeneric<@Nullable String, @Nullable String> r)
  {
    if (r.a() == null || r.b() == null)
      return "";
    else
