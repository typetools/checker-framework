...
class CheckerFrameworkBuilder {
     ...
     *
     * <p>The new code added in this block ensures that the object construction checker handles
     * clients of the copied code correctly.
     */
    public static void testOldCalledMethodsGood(
                    @org.checkerframework.checker.objectconstruction.qual.CalledMethods({"y", "z"}) CheckerFrameworkBuilderBuilder pb) {
        pb.build();
    }

    public static void testOldCalledMethodsBad(
                    @org.checkerframework.checker.objectconstruction.qual.CalledMethods({"y"}) CheckerFrameworkBuilderBuilder pb) {
