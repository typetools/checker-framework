// A `@SideEffectsOnly` expression that is not stable is rejected at a lambda that implements the
// annotated method, just as it is at the method's declaration.  Otherwise nothing in the lambda's
// body could ever be recognized as the expression, and every modification would be reported.

import java.util.ArrayList;
import java.util.List;
import org.checkerframework.dataflow.qual.SideEffectsOnly;

public class LambdaUnstableSideEffectsOnly {
