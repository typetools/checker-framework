...
public class AnnotationUtils {
    ...
    /**
     * Comparisons between different AnnotationMirror's names are done very frequently, and since
     * all AnnotationMirrors generated by CF always start with "org.checkerframework", we usually
     * end up having to go very far into the strings only to realize that they are different.
     *
     * <p>This helper function go backwards instead so that we can reduce the number of comparisons
     * if the strings are different.
     *
     * @param s1 First string
     * @param s1 Second string
     * @return whether s1 is equal to s2
     */
    private static boolean stringEqualsInReversedOrder(String s1, String s2) {
     ...
     */
    public static String annotationName(AnnotationMirror annotation) {
    ...
    public static boolean areSameByName(
        ...
        return stringEqualsInReversedOrder(annotationName(a1), annotationName(a2));
    }
    ...
    public static boolean areSameByName(AnnotationMirror am, String aname) {
        return stringEqualsInReversedOrder(aname, annotationName(am));
    }
