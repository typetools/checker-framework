...
public final class ElementUtils {
   ...
   *
   * <p>This method returns false for every member of a record that was read from bytecode, because
   * it relies on javac flags that are not stored in class files.
   *
