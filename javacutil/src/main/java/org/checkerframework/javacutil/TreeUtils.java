...
public final class TreeUtils {
  ...
  /** The value of Flags.GENERATED_MEMBER, or 0 if the JDK does not contain that field. */
  private static long Flags_GENERATED_MEMBER;

  /** The value of Flags.RECORD, or 0 if the JDK does not contain that field. */
  private static long Flags_RECORD;
  ...
  static {
    try {
      ...
      @SuppressWarnings("nullness") // getLong accepts null for static fields
      long recordValue = recordField.getLong(null);
      Flags_RECORD = recordValue;
   ...
   * the record's header field list, or an automatically generated canonical constructor.
   *
   * @param member the {@link Tree} for a node that is a member of a record
