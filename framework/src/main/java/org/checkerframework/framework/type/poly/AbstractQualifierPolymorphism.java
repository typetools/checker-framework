...
public abstract class AbstractQualifierPolymorphism implements QualifierPolymorphism {
    ...
    /**
     * <<<<<<< HEAD A Helper class that tries to resolve the polymorhpic qualifiers with the most
     * restricted qualifier. The mapping is from the polymorhpic qualifier to the substitution for
     * that ======= A Helper class that tries to resolve the polymorphic qualifiers with the most
     * restricted qualifier. The mapping is from the polymorphic qualifier to the substitution for
     * that >>>>>>> 41fe25f9dafb9d924bee2ecfe22ecc8ac056bfdc qualifier, which is a set of
     * qualifiers. For most polymorphic qualifiers this will be a singleton set. For the @PolyAll
