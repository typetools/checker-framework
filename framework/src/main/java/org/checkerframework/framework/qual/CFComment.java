...
/**
 * This annotation is to be used to add comments related to Checker-Framework. This annotation can
 * be used on packages, classes, interfaces and any elements inside these.
 *
 * <p>Each comment should first start with the type-system to which comment is related to followed
 * by ':' and then actual comment. Provide single string if comment is for only one type-system and
 * multiple string for separate type-system.
 *
