...
public class AliasingTransfer extends CFTransfer {
    ...
    public TransferResult<CFValue, CFStore> visitAssignment(
        ...
        JavaExpression rhsExpr = JavaExpressions.internalReprOf(factory, rhs);
    ...
    protected void processPostconditions(
        ...
        for (int i = 0; i < args.size(); i++) {
            ...
            if (!paramType.hasAnnotation(NonLeaked.class)
                ...
                store.clearValue(JavaExpressions.internalReprOf(factory, arg));
            }
        }
        ...
        if (receiverType != null
            ...
            store.clearValue(JavaExpressions.internalReprOf(factory, receiver));
        }
    }
