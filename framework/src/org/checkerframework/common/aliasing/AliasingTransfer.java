 ...
 *
 * <p>1.The RHS is a fresh expression.
 *
 * <p>2.The LHS is a {@literal @}NonLeaked formal parameter and the RHS is an argument in a method
 * call or constructor invocation.
 *
 * <p>3.The LHS is a {@literal @}LeakedToResult formal parameter, the RHS is an argument in a method
 * call or constructor invocation, and the method's return value is discarded.
 */
