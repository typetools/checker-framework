...
public interface TestConfiguration {
     ...
     * The lines are of the form: fileName:lineNumber: diagnostKind: (messageKey)
     *
     * <p>e.g., MethodInvocation.java:17: error: (method.invocation.invalid)
     *
     * <p>If getDiagnosticFiles does NOT return an empty list, then the only diagnostics expected by
     ...
     * getOptions returns a {@code Map(optionName -> optionArgumentIfAny)}. If an option does not
     * take an argument, pass null as the value.
     *
     * <p>E.g., {@code Map( "-AprintAllQualifiers" -> null "-classpath" -> "myDir1:myDir2" ) }
     *
    ...
    /**
     * @return the map returned getOptions but flattened into a list. The entries will be added as
     *     followed: List(key1, value1, key2, value2, ..., keyN, valueN) If a value is NULL then it
