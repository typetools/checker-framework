 ...
 * Options and the values are the arguments to those options if they exists: e.g., {@code Map(
 * "-AprintAllQualifiers" -> null "-classpath" -> "myDir1:myDir2" ) }
 *
 * <p>This class is mainly used by TestConfigurationBuilder to make working with existing options
