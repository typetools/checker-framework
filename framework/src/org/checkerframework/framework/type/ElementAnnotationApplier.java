...
public class ElementAnnotationApplier {
     ...
     *
     * <p>1) Annotations found on elements may represent those in source code or bytecode; these are
     * added to the element by the compiler.
     *
     * <p>2) The annotations may also represent those that were inferred or defaulted by the Checker
     ...
     *
     * <p>Note: This is not the ONLY place that annotations are explicitly added to types. See
     * {@link org.checkerframework.framework.type.TypeFromTree}.
     *
