...
public class TypeVariableSubstitutor {
    ...
    protected class Visitor extends AnnotatedTypeCopier {
        ...
        public AnnotatedTypeMirror visitArray(
            ...
            // AnnotatedTypeMirror)
            // may change the underlying Java type of components without updating the underlying
            // Java
            // type of the parent type.  We use the underlying type for various purposes (including
            // equals/hashcode)
            // so this can lead to unpredictable behavior.  Currently, we update the underlying type
            // when
        ...
        public AnnotatedTypeMirror visitTypeVariable(
            ...
            if (visitingExecutableTypeParam) {
                ...
                // AnnotatedExecutable.typeVarTypes
                // field is of type AnnotatedTypeVariable and not AnnotatedTypeMirror.
                // When substituting, all component types that contain a use of the executable's
                // type parameters
                // will be substituted.  The executable's type parameters will have their bounds
                // substituted
