 ...
 *
 * <ul>
 *   <li>add the jsr308-langtools javac.jar to the runtime bootclasspath of the process that runs
 *       the Checker Framework. This specifies which classes are used to run javac
 *   <li>add jdk7.jar or jdk8.jar to the compile time bootclasspath of the javac argument list
 *       passed to javac
 ...
 * special version of javac, and javac is passed a -processor command-line argument that mentions a
 * Checker Framework checker. There are 5 relevant classpaths: The classpath and bootclasspath when
 * running java, and the classpath, bootclasspath, and processorpath used by javac. The latter three
...
public class CheckerMain {
    ...
    /**
     * Remove all -Xbootclasspath/p: or -J-Xbootclasspath/p: arguments from args and add them to the
     * returned list
     *
     * @param args the arguments to extract from
    ...
    /**
     * Remove the -cp and -classpath options and their arguments from args. Return the last
     * argument. If no -cp or -classpath arguments were present then return the CLASSPATH
     * environment variable followed by the current directory.
     *
