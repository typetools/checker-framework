 ...
 * inference.
 *
 * <p>There are subclasses to represent two cases: a) The target was inferred to be an
 * AnnotatedTypeMirror b) The target was inferred to be equal to another target
 */
