...
/**
 * Registers a {@code @SubQual} default for {@link TypeUseLocation#RETURN} on every class named
 * {@code ElementDefault}, through {@code QualifierDefaults.addElementDefault}.
 *
  ...
  public void setRoot(@Nullable CompilationUnitTree root) {
    ...
    for (Tree typeDecl : root.getTypeDecls()) {
      if (typeDecl.getKind() == Tree.Kind.CLASS) {
        ...
        if (classElt != null && classElt.getSimpleName().contentEquals("ElementDefault")) {
