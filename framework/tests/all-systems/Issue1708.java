...
@SuppressWarnings({"unchecked", "ainfertest", "value"}) // Don't issue warnings during ainfer tests, because more than one round of inference is required for the value checker
