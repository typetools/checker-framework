...
public class GLBTest<@ClassVal({"A", "B"}) T extends Object> {
  // This code is intended to cover the more complex branches for the GLB calculation.
  ...
  // This code does not test correctness. Because no expression is given the GLB as a type,
