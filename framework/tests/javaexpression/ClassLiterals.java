...
public class ClassLiterals {
  ...
  void method(
    ...
    @FlowExp("java.lang.String.class") Object l3 = p3;
    // :: error: (assignment)
    @FlowExp("String.class") Object l4 = p3;
    // :: error: (assignment)
    @FlowExp("java.lang.String.class") Object l5 = p1;
    // :: error: (assignment)
    @FlowExp("java.lang.String.class") Object l6 = p2;
  }
