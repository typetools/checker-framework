...
class TypeRefinement {
     ...
     * type must have been @MaybeAliased) except in the following cases: 1.The RHS is a fresh
     * expression. 2.The LHS is a @NonLeaked formal parameter and the RHS is an argument in a method
     * call or constructor invocation. 3.The LHS is a @LeakedToResult formal parameter, the RHS is
     * an argument in a method call or constructor invocation, and the method's return value is
     * discarded.
     */
