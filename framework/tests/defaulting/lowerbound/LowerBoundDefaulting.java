...
public class LowerBoundDefaulting {
    ...
    public <IMP1 extends String> void implicitsTypeVar() {
        ...
        @LbTop
        MyArrayList<@LbTop ? extends @LbTop String> itLowerBoundIncompatible =
                // :: error: (assignment.type.incompatible)
                new MyArrayList<IMP1>();

        // :: error: (type.argument.type.incompatible)
        @LbTop
        MyArrayList<@LbExplicit ? extends @LbTop String> itLowerBoundStillIncompatible =
                // :: error: (assignment.type.incompatible)
                new MyArrayList<IMP1>();

        @LbTop
        MyArrayList<@LbImplicit ? extends @LbTop String> itLowerBoundCompatible =
                new MyArrayList<IMP1>();
    }
    ...
    public void implicitsWildcard(MyArrayList<?> myArrayList) {
        ...
        @LbTop
        MyArrayList<@LbExplicit ? extends @LbTop String> iwLowerBoundCompatible = myArrayList;

        @LbTop
        MyArrayList<@LbImplicit ? extends @LbTop String> iwLowerBoundStillCompatible = myArrayList;
    }
    ...
    public void implicitExtendBoundedWildcard(MyArrayList<? extends String> iebList) {
        ...
        // :: error: (assignment.type.incompatible) :: error: (type.argument.type.incompatible)
        @LbTop
        MyArrayList<@LbExplicit ? extends @LbTop String> iebLowerBoundStillIncompatible = iebList;
    ...
    public void explicitLowerBoundedWildcard(MyArrayList<? super String> elbList) {
        ...
        // :: error: (type.argument.type.incompatible)
        @LbTop
        MyArrayList<@LbTop ? super @LbExplicit String> iebLowerBoundStillIncompatible = elbList;
