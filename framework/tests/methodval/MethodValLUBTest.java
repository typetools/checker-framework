...
@MethodVal(className = "c2", methodName="m2", params=1) Object c2m21 = null;
    ...
    void lubSameType() {
        ...
        @MethodVal(className = "c1", methodName="m1", params=0)
        Object lub = unknown;
    }
    ...
    @MethodVal(className = "c1", methodName="m1", params=1) Object c1m11 = null;
        ...
        void setsLub(){
            ...
            @MethodVal(className ={"class2","class","class","class2"},
        ...
        void inferedlubTest() throws Exception{
            ...
            @MethodVal(className={"MethodValInferenceTest","MethodValInferenceTest"},
                    methodName={"getA","getB"}, params={0,0})
            Method lub = m;
        }
