 ...
 * @author pbsf
 */
public class JaifRelaxedInferenceTest extends CheckerFrameworkTest {

    public JaifRelaxedInferenceTest(File testFile) {
    ...
    public static String [] getTestDirs() {
        return new String[]{"jaif-inference/relaxed-non-annotated"};
    }
